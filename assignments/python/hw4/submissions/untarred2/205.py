...
def subsets(lst, n):
    ...
    if n == 0:
        ...
        return  [[lst[0]] + subset for subset in subsets(lst[1:], n-1)] + subsets(lst[1:], n)
...
def filter_subsets(word, score, possible_subsets):
    ...
    """
    "*** YOUR CODE HERE ***"
    return [item for item in possible_subsets if compatible(make_word_from_list(item), score, get_list(word))]
