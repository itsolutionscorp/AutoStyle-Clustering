...
def subsets(lst, n):
    ...
    if lst == []:
        return []                                        
    return[[lst[0]] + elem for elem in subsets(lst[1:], n-1)] + subsets(lst[1:], n)
...
def filter_subsets(word, score, possible_subsets):
    ...
    """
    "*** YOUR CODE HERE ***"
    return [elem for elem in possible_subsets if compatible(word, score, make_word_from_list(elem))]
