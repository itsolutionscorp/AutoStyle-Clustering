...
# Implementation of the Word ADT using Lists
...
# Implementation of the Word ADT using Functions
...
def subsets(lst, n):
    ...
    if n > len(lst):
        ...
        return subsets(list_copy, n) + [x + [last_element] for x in subsets(list_copy, n - 1)]
