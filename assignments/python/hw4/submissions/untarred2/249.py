...
def make_word_master(goal_word):
    ...
    def word_master(guess):
        temp1=get_string(goal_word)
        temp2=get_string(guess)
        if temp1==temp2:
            return win_message
...
def compatible(guess, score, letter_list):
    ...
    """
    "*** YOUR CODE HERE ***"
    return make_word_master(letter_list)(guess)==score
...
#     if indicator:
#         return present+[letters[0]]+make_deductions(possible_subsets,letters[1:])
#     else:
#         return not_present+[letters[0]]+make_deductions(possible_subsets,letters[1:])
