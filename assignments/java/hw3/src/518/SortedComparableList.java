...
public class SortedComparableList {
    ...
    public void extend(SortedComparableList that) {
        ...
        //   Comparable a = this.head;
        //   this.head = that.head;
        //   this.tail = this.extend(that.tail);
        // } else {
        //   this.tail = this.tail.extend(that);
        // }
    ...
    public static SortedComparableList sublist(SortedComparableList L, int start, int len) {
      ...
      //     return null;
      //   } else if (len == 1) {
      //     return new SortedComparableList(L.head, null);
      //   } else {
    ...
    public void squish() {
      ...
      //   this = this.tail;
      // } else {
      //   this = new SortedComparableList(this.head, this.tail.squish());
      // }
      if (tail != null) {
    ...
    public void twin() {
      ...
      // } else {
      //   this.tail = new SortedComparableList(this.head, this.tail.twin());
      // }
      SortedComparableList prev = this;
      while (prev != null) {
