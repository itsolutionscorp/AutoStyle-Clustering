...
public class SortedComparableList {
    ...
    public SortedComparableList(){
        this(0, null);
        // this will call the constructor with the arguments head0 and tail0
    }
    ...
    public static SortedComparableList sublist(SortedComparableList L, int start, int len) {
        /* haven't checked for edge case */
        if (len == 0) {
            return null;
        } else if (start > 0) {
            return SortedComparableList.sublist(L.tail, start - 1, len);
        }
    ...
    public void squish() {
        ...
        while (temp.tail != null) {
            if (temp.head.equals(temp.tail.head)) {
