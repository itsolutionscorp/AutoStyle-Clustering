...
public class SortedComparableList {
    ...
    public void insert(Comparable c) {
		if(c == null)	return;
			...
			while(c.compareTo(copy.head) > 0 && copy.tail != null)	{
				copy = copy.tail;
			}
    ...
    public static SortedComparableList sublist(SortedComparableList L, int start, int len) {
		...
		else return new SortedComparableList(L.head, sublist(L.tail, start, len-1));
    }
    ...
    public void squish() {
		...
		while(copy.tail != null)	{
			if(copy.head.equals(copy.tail.head))	{
