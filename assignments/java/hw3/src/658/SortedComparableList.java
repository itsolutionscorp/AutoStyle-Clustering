...
public class SortedComparableList {
    ...
    public void insert(Comparable c) {
        // REPLACE THIS LINE WITH YOUR SOLUTION
      //if (c.compareTo(null) == 0) return;
      if (c.compareTo(head) <= 0) {
        SortedComparableList t = new SortedComparableList(head, tail);
        tail = t;
        head = c;
      } else if (tail == null) {
    ...
    public static SortedComparableList subTail(SortedComparableList L, int start) {
        if ((L == null) || (L.get(start) == null)) return null;
        return new SortedComparableList(L.get(start), subTail(L, start + 1));
        //return null; // REPLACE THIS LINE WITH YOUR SOLUTION
    }
    ...
    public static SortedComparableList sublist(SortedComparableList L, int start, int len) {
        ...
        return new SortedComparableList(L.get(start), sublist(L, start + 1, len - 1));
        //return null; // REPLACE THIS LINE WITH YOUR SOLUTION
    }
    ...
    public static void expungeTail(SortedComparableList L, int len) {
        if (L == null) return;
        if (len == 0) L.tail = null;
        else expungeTail(L.tail, len - 1);
        // REPLACE THIS LINE WITH YOUR SOLUTION
    }
