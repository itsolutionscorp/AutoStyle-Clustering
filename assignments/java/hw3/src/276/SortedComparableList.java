...
public class SortedComparableList {
    ...
    public void insert(Comparable c) {
      SortedComparableList iter = this;
       while ((iter.tail != null) && (c.compareTo(iter.tail.head) >= 0)) {
          iter = iter.tail;
       }
      iter.tail = new SortedComparableList(c, iter.tail);
    }
    ...
    public static SortedComparableList sublist(SortedComparableList L, int start, int len) {
       SortedComparableList K = subTail(L, start);
       SortedComparableList V = new SortedComparableList(K.head, null);
       len -= 1;
       while (len != 0) {
        len -= 1;
        K = K.tail;
     ...
     **/
    public void squish() {
      SortedComparableList k = this;
        while (k.tail != null) {
          while ((k.tail != null) && (k.head == k.tail.head)) {
            k.tail = k.tail.tail;
          }
         if (k.tail != null)
         k = k.tail;
