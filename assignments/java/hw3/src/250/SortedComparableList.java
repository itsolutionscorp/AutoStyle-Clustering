...
public class SortedComparableList {
    ...
    public void insert(Comparable c) {
        ...
        if (c.compareTo(head) < 0) {
            ...
            while ((t.tail != null) && (c.compareTo(t.tail.head) > 0)) {
                t = t.tail;
          }
          t.tail = new SortedComparableList(c, t.tail);
        }
    }
    ...
    public void extend(SortedComparableList that) {
        SortedComparableList t = this;
        while (t.tail != null && that.tail != null) {
            if (that.head.compareTo(t.head) < 0) {
                t.tail = new SortedComparableList(that.head, t.tail);
                that = that.tail;
            }
            t = t.tail;
        }
    ...
    public void squish() {
        ...
        SortedComparableList t = tail;
        while (t != null) {
            if (t.head.compareTo(prev.head) == 0) {
                prev.tail = t.tail;
                t = t.tail;
            } else {
                prev = prev.tail;
    ...
    public void twin() {
        ...
        while (t != null) {
            ...
            t = t.tail.tail; // This skips over the insertion that was just made.
        }
    }
