...
public class SortedComparableList {
    ...
    public SortedComparableList(){
        ...
        // head = 0;
        // tail = null;
        this(0, null);  // Note this calls a constructor;
    }
    ...
    // why can't I assign this to that?
     ...
     **/
    public void squish() {
        // REPLACE THIS LINE WITH YOUR SOLUTIONif (tail != null) {
    ...
    //     }
    //     else if (this.tail.head.compareTo(this.head) == 0){
