...
public class SortedComparableList {
    ...
    public void insert(Comparable c) {
        ...
        int flag = 0;
        while (flag != 1) {
            if (pointer.tail != null && pointer.tail.head.compareTo(c) >= 0) {
    ...
    /** Adds every item in THAT to this list. */   // <-- INSERT all elements of that into list.
    ...
    public static SortedComparableList subTail(SortedComparableList L, int start) {
        ...
        SortedComparableList finalList = new SortedComparableList(pointer.head, null);
        pointer = pointer.tail;
        while (pointer != null) {
          finalList.insert(pointer.head);
          pointer = pointer.tail;
        }
        return finalList;
    }
    ...
    public void squish() {
        ...
        while (pointer.tail != null) {
          Comparable current = pointer.head;
          Comparable next = pointer.tail.head;
    ...
    public void twin() {
        if (this.tail == null) {
          SortedComparableList L = new SortedComparableList(this.head, null);
          this.tail = L;
        }
        SortedComparableList pointer = this;
        while (pointer != null) {
