...
public class SortedComparableList {
    ...
    public static SortedComparableList sublist(SortedComparableList L, int start, int len) {
        ...
        SortedComparableList returnList = new SortedComparableList(pointer.head, null);
        SortedComparableList previous = returnList;
        len -= 1;
        pointer = pointer.tail;
        while (len > 0 && pointer != null) {
            SortedComparableList newList = new SortedComparableList(pointer.head, null);
            previous.tail = newList;
    ...
    public static void expungeTail(SortedComparableList L, int len) {
        ...
        //Might generate an off by one error, b/c of pointer.tail vs. pointer
        pointer.tail = null;
    }
    ...
    public void twin() {
        SortedComparableList pointer = this;
        while (pointer != null) {
            SortedComparableList newList = new SortedComparableList(pointer.head, pointer.tail);
            pointer.tail = newList;
