...
public class SortedComparableList {
    ...
    public static SortedComparableList sublist(SortedComparableList L, int start, int len) {
        ...
        int i = 1;
        while (temp.tail != null && i != len) {
          result.insert(temp.tail.head);
          temp = temp.tail;
          i++;
        }
        return result;
    ...
    public void twin() {
      ...
      while (curr.tail != null) {
        curr.tail = new SortedComparableList(dup, curr.tail);
        curr = curr.tail.tail;
        dup = curr.head;
      }
      curr.tail = new SortedComparableList(dup, null);
