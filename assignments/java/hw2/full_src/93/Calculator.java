...
public class Calculator {
    ...
    public int add(int x, int y) {        
        int carryingBits = y, result = x, oldCarrying;         
        while (carryingBits != 0) {
            oldCarrying = carryingBits;
            carryingBits = result & oldCarrying;
            result = result ^ oldCarrying;
            carryingBits = carryingBits << 1;            
        }
        return result;
    }
