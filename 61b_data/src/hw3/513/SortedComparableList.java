...
public class SortedComparableList {
    ...
    public static SortedComparableList subTail(SortedComparableList L, int start) {
        ...
        if (L != null) {
          SortedComparableList lToRet = new SortedComparableList(L.head,null);
          L = L.tail;
        while (L!= null){
          lToRet.insert(L.head);
          L=L.tail;
    ...
    public static SortedComparableList sublist(SortedComparableList L, int start, int len) {
        ...
        SortedComparableList fullList = subTail(L, start); // REPLACE THIS LINE WITH YOUR SOLUTION
        SortedComparableList temp = fullList;
