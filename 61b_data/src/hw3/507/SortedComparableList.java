...
public class SortedComparableList {
    ...
    public void insert(Comparable c) {
      if (c != null) {
        if (c.compareTo(head) > 0) {
          ...
          while (orig.tail != null && c.compareTo(orig.tail.head) > 0) {
            orig = orig.tail;
          }
          orig.tail = new SortedComparableList(c, orig.tail);
        }
        else {
    ...
    public void extend(SortedComparableList that) {
      ...
      //   this.insert(that.i);
      // }
      SortedComparableList willp = that;
      while (willp != null) {
        insert(willp.head);
        willp = willp.tail;
      }
