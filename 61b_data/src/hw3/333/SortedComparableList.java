...
public class SortedComparableList {
    ...
    public void insert(Comparable c) {
        // REPLACE THIS LINE WITH YOUR SOLUTION
      /* If c is null, then dont do anything. */
      if (c != null) {
        ...
        /* c should go after the head. */
        else {
          /* Change copyHead to the next head. */
    ...
    public static SortedComparableList sublist(SortedComparableList L, int start, int len) {
      ...
      SortedComparableList curr = subTail(L, start);
      SortedComparableList changeTail = curr;
      while (len > 1 && changeTail != null) {
        changeTail = changeTail.tail;
        len -= 1;
      }
      if (changeTail != null) {
        changeTail.tail = null;
      }
      return curr; 
      // if (len == 0) {
      //       //base case
