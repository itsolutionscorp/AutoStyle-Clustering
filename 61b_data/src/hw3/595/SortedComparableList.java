...
public class SortedComparableList {
    ...
    public void insert(Comparable c) {
      if (c != null) {
        if (c.compareTo(head) < 0) {
          ...
          SortedComparableList alpha = this;
          while ((alpha.tail != null) && (c.compareTo(alpha.tail.head) > 0)) {
            alpha = alpha.tail;
          }
          alpha.tail = new SortedComparableList(c, alpha.tail);
      }
    ...
    public void extend(SortedComparableList that) {
      SortedComparableList alpha = that;
      while (alpha != null) {
        this.insert(alpha.head);
        alpha = alpha.tail;
      }
    }
    ...
    public static SortedComparableList sublist(SortedComparableList L, int start, int len) {
      // SortedComparableList alpha = subTail(L, start);
      // SortedComparableList other = new SortedComparableList();
      // SortedComparableList returned_list = other;
      // while ((len > 0) || (alpha != null)) {
      //   other.head = alpha.head;
      //   other.tail = new SortedComparableList();
      //   other = other.tail;
      //   alpha = alpha.tail;
      //   len -= 1;
      // }
      // return returned_list;
      SortedComparableList alpha = L;
      if (L == null){
        return L;
      } else if (len == 0) {
        return null;
        ...
        SortedComparableList a = new SortedComparableList(L.head, sublist(L.tail, 0, len -1));
        return a;
      }
    }
     ...
     **/
    public void twin() {
      SortedComparableList first = this;
      while (first!= null){
        first.tail = new SortedComparableList(first.head, first.tail);
