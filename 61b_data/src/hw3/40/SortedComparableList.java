...
public class SortedComparableList {
    ...
    public void insert(Comparable c) {
        ...
        while (copy.tail != null && c.compareTo(copy.tail.head) > 0) copy = copy.tail;
    ...
    public void extend(SortedComparableList that) {
        SortedComparableList copy = this;
        while (copy.tail != null) copy = copy.tail;
        copy.tail = that;
    }
    ...
    public void squish() {
        SortedComparableList copy = this;
        SortedComparableList rest = tail;
        while (rest != null)
        {
          if (copy.head.compareTo(rest.head) == 0) copy.tail = rest.tail;
          else copy = copy.tail;
          rest = rest.tail;
        }
    }
