...
public class SortedComparableList {
    ...
    public void insert(Comparable c) {
      if(c == null)
        return;
      // Handle edge case of inserting to the front.
    ...
    private Comparable get(SortedComparableList s, int i) {
      if(s == null)
        return null;
      else if(i == 0) {
        return s.head;
      }
      return get(s.tail, i - 1);
    }
    ...
    public static SortedComparableList sublist(SortedComparableList L, int start, int len) {
      ...
      temp = new SortedComparableList(L.head, L.tail);
      SortedComparableList temp1 = temp;
      while(len > 1 && temp1.tail != null) {
        temp1 = temp1.tail;
        len--;
      }
      temp1.tail = null;
    ...
    private static SortedComparableList getList(SortedComparableList L, int len) {
      if(L == null)
        return L;
      if(len == 0)
        return L;
      return getList(L.tail, len-1);
    }
    /**
    ...
    public void squish() {
      SortedComparableList cur = this;
      while(cur.tail != null) {
        if(cur.tail.head.compareTo((Comparable)cur.head) == 0) {
