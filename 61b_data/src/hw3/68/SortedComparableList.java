...
public class SortedComparableList {
    ...
    public static SortedComparableList subTail(SortedComparableList L, int start) {
      ...
      for (int x = start; x > 0 && pointer.tail != null; x-=1) {
        pointer = pointer.tail;
      }
      return pointer;
    }
    ...
    public static SortedComparableList sublist(SortedComparableList L, int start, int len) {
      ...
      SortedComparableList sub = new SortedComparableList(pointer.head, null);
      SortedComparableList pointer2 = sub;
      while (len > 0) {
        pointer = pointer.tail;
        pointer2.tail = new SortedComparableList(pointer.head, null);
    ...
    public static void expungeTail(SortedComparableList L, int len) {
      SortedComparableList a = subTail(L, len);
      a.tail = null;
    }
