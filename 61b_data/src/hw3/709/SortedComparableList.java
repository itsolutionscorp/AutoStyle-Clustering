...
public class SortedComparableList {
     ...
     **/
    public void squish() {
        SortedComparableList loc = this;
        while (loc != null && loc.tail != null) {
            if (loc.head.compareTo(loc.tail.head) == 0) {
                loc.tail = loc.tail.tail;
            } else {
                loc = loc.tail;
            }
        }
    ...
    public void twin() {
        SortedComparableList loc = this;
        while (loc != null) {
            loc.tail = new SortedComparableList(loc.head, loc.tail);
            loc = loc.tail.tail;
        }
    }
