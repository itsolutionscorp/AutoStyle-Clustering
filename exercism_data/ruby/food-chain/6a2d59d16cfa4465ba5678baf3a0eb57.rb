class Song
  attr_reader :current_verse

  def intialize
    fail :NotImplementedError, 'Subclass and override verse_format method'
  end

  def max_verse
    fail :NotImplementedError, 'Override this method. Return the largest verse'
  end
