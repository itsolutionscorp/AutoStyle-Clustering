class Fixnum
  def to_roman
    roman_units     = RomanUnit.new(self).convert
    roman_tens      = RomanTens.new(self).convert
    roman_hundreds  = RomanHundreds.new(self).convert
    roman_thousands = RomanThousands.new(self).convert
