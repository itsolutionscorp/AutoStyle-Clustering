...
begin
  ...
  class TeenagerTest < MiniTest::Unit::TestCase
    ...
    def test_shouting
      assert_equal 'Woah, chill out!', teenager.cool('WATCH OUT!')
    end

    def test_asking_a_question
      assert_equal 'Sure.', teenager.sure('Does this cryogenic chamber make me look fat?')
    end
    ...
    def test_shouting_numbers
      assert_equal 'Woah, chill out!', teenager.cool('1, 2, 3 GO!')
    end

    def test_shouting_with_special_characters
      assert_equal 'Woah, chill out!', teenager.cool('ZOMG THE %^*@#$(*^ ZOMBIES ARE COMING!!11!!1!')
    end

    def test_shouting_with_no_exclamation_mark
      assert_equal 'Woah, chill out!', teenager.cool('I HATE YOU')
    end
    ...
    def test_silence
      assert_equal 'Fine. Be that way.', teenager.fine('')
    end

    def test_more_silence
      assert_equal 'Fine. Be that way.', teenager.fine(nil)
    end
  end
