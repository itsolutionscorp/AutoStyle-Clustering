...
# 4 but not 100. We then test if it is divisible by 400,
# since if it's divisible by 400, it's also divisible by
# 4. In both cases, it is true. Otherwise it is false.
