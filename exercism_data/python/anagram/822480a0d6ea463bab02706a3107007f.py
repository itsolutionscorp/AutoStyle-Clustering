...
def detect_anagrams(word,anagram_candidates):
    ...
    # Check the input for None values or invalid types
    if word is not None and isinstance(word, basestring) and \
            anagram_candidates is not None and isinstance(anagram_candidates,list):
