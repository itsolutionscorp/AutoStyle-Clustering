class Beer(object):
    ...
    def verse(self, n):
        ...
        # modulo over 100 to be able to handle negative values for n
        # in case folks want to keep repeating the song when they're done!
        beer = self.Lyric.BEER.format(quantity=self._get_quantity(n % 100))
