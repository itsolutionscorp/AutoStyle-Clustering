...
class Garden():
    ...
    def plants(self, name):
        plant_list = self.garden[0][self.students.index(name)*2:self.students.index(name)*2+2]
        plant_list += self.garden[1][self.students.index(name)*2:self.students.index(name)*2+2]
