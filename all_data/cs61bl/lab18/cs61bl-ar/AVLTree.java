public class AVLTree {
	...
	private class NonEmptyTreeNode extends TreeNode {
		...
		public void insertHelper(int item){
			if(item >= myItem && !myRight.isEmpty()){
				myRight.insertHelper(item);
			}else if(item < myItem && !myLeft.isEmpty()){
        ...
        public void LeftRotate(){
        	if(!myParent.isEmpty()){
	        	NonEmptyTreeNode currParent = (NonEmptyTreeNode) myParent;
	        	if(currParent.myLeft.equals(this)){
	        	currParent.myLeft = myRight;
	        	}else{
	        		currParent.myRight = myRight;
	        	}
        	}
        	NonEmptyTreeNode curr = (NonEmptyTreeNode) myRight;
        	NonEmptyTreeNode temp =  new NonEmptyTreeNode(this.myItem);
        	temp.myLeft = this.myLeft;
        	this.myItem = curr.myItem;
        	this.myRight = curr.myRight;
        	temp.myRight = curr.myLeft;
        	this.myLeft = temp;
        ...
        public void RightRotate(){
        	if(!myParent.isEmpty()){
        		NonEmptyTreeNode currParent = (NonEmptyTreeNode) myParent;
        		if(currParent.myRight.equals(this)){
        			currParent.myRight = myLeft;
        		}else{
        			currParent.myLeft = myLeft;
        		}	
        	}
        	
        	NonEmptyTreeNode curr = (NonEmptyTreeNode) myLeft;
        	NonEmptyTreeNode temp =  new NonEmptyTreeNode(this.myItem);
        	temp.myRight = this.myRight;
        	this.myItem = curr.myItem;
        	this.myLeft = curr.myLeft;
        	temp.myLeft = curr.myRight;
        	this.myRight = temp;
        }
		@Override
		public boolean isAlmostBalanced() {
