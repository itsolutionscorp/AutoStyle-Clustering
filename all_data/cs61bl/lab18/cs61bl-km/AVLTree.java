...
public class AVLTree {
	...
	private abstract class TreeNode {
		...
		public abstract void checkAndBalance();
	...
	/*	if (this.myParent == null) {
		...
		myParent.checkAndBalance();
		}
		
		public void rotateRight() {
			TreeNode parentb4 = parent();
			if (parentb4 != null && parentb4.right().equals(this)) {
				parentb4.setRight(myLeft);
				TreeNode currLeft = myLeft;
				currLeft.setParent(parentb4);
				this.setParent(currLeft);
				TreeNode LeftRight = currLeft.right();
				this.setLeft(LeftRight);
				LeftRight.setParent(this);
				this.setParent(currLeft);
				
			}
			else if (parentb4 != null && parentb4.left().equals(this)) {
				parentb4.setLeft(myLeft);
				TreeNode currLeft = myLeft;
				currLeft.setParent(parentb4);
				this.setParent(currLeft);
				TreeNode LeftRight = currLeft.right();
		...
		public void rotateLeft() {
			...
			if (parentb4 != null && parentb4.right() == this) {
				parentb4.setRight(myRight);
				TreeNode currRight = myRight;
				currRight.setParent(parentb4);
				this.setParent(currRight);
				TreeNode rightLeft = currRight.left();
				this.setRight(rightLeft);
				rightLeft.setParent(this);
				this.setParent(currRight);
			}
			else if (parentb4 != null && parentb4.left() == this) {
				parentb4.setLeft(myRight);
				TreeNode currRight = myRight;
				currRight.setParent(parentb4);
				this.setParent(currRight);
				TreeNode rightLeft = currRight.left();
