public class AVLTree {
	...
	private class NonEmptyTreeNode extends TreeNode {
		...
		public void rotateLeft() {
			TreeNode leftHolder = left();
			TreeNode rightHolder = right();
			myRight = rightHolder.right();
			rightHolder.right().setParent(this);
			myLeft = new NonEmptyTreeNode(myItem, this);
			myItem = rightHolder.item();
			myLeft.setRight(rightHolder.left());
			rightHolder.left().setParent(myLeft);
			myLeft.setLeft(leftHolder);
			leftHolder.setParent(myLeft);
		}
		...
		public void rotateRight() {
			TreeNode leftHolder = left();
			TreeNode rightHolder = right();
			myLeft = leftHolder.left();
			leftHolder.left().setParent(this);
			myRight = new NonEmptyTreeNode(myItem, this);
			myItem = leftHolder.item();
			myRight.setLeft(leftHolder.right());
			leftHolder.right().setParent(myRight);
			myRight.setRight(rightHolder);
			rightHolder.setParent(myRight);
		}
