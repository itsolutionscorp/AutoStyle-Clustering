...
public class AVLTree {
	...
	private abstract class TreeNode {
		...
		public abstract TreeNode add(TreeNode t, TreeNode parent, int item);
	...
	private class NonEmptyTreeNode extends TreeNode {
		...
		public void insert(int item) {
			// TODO Your code here!
			if (!contains(item)) {
				myRoot = add(myRoot, theEmptyTreeNode, item);
			}
		}
		...
		public TreeNode rotateRight(TreeNode t) {
				...
				temp.right().setParent(t);
				t.setLeft(temp.right());
				temp.setRight(t);
				t.setParent(temp);
				return temp;
		}
		...
		public TreeNode rotateLeft(TreeNode t) {
				...
				temp.left().setParent(t);
				t.setRight(temp.left());
				temp.setLeft(t);
				t.setParent(temp);
				return temp;
		}
		...
		@Override
		public TreeNode add(TreeNode t, TreeNode parent, int item) {
		    if (t.isEmpty()) {
		    	return new NonEmptyTreeNode(item, parent);
		    }
		    else if (item < t.item()) {
		        t.setLeft(add(t.left(), t, item));
		    } else {
		        t.setRight(add(t.right(), t, item));
		    }
		...
		private TreeNode rotationHelper(TreeNode t) {
...
//
		...
		// Should cause a rotation to occur.
		t2.insert(6);
		System.out.println(t2.contains(1));
		System.out.println(t2.contains(2));
		System.out.println(t2.contains(3));
		System.out.println(t2.contains(4));
		System.out.println(t2.contains(5));
		System.out.println(t2.contains(6));
		System.out.println(t2.contains(7));
		System.out.println(t2);
		System.out.println(t2.isAlmostBalanced());
		
		// Check double rotation
		...
		System.out.println(t3);
		t3.insert(22);
		System.out.println(t3); //rotation
		t3.insert(4);
		System.out.println(t3);
		t3.insert(14);
		System.out.println(t3);
