...
public class AVLTree {
	...
	private abstract class TreeNode {
		 ...
		 */
		public abstract void setItem(int t);
		@Override
		public String toString() {
...
//			System.out.println(isAlmostBalanced());
//			System.out.println(balanceFactor());
//			

			while(!isAlmostBalanced()){
		...
		public void rotateLeft(){
			...
			if(parent().isEmpty()){
				right().setParent(theEmptyTreeNode);
							
			}else{
				if(!(parent().left().isEmpty()) && this.equals(parent().left())){
...
//			System.out.println(this);
			...
			if(!(parent().left().isEmpty()) && this.equals(parent().left())){
				...
				if(parent().isEmpty()){
					...
					setParent(theEmptyTreeNode);
				}else{
					TreeNode Temp3 = parent().parent();
					parent().setParent(this);
					setParent(Temp3);
				}
				...
				if(parent().isEmpty()){
					...
					parent().setParent(this);
					setParent(Temp3);
//					if(Temp3.left().equals(obj))
				}
			}
			
			/////
//			int PmyItem = item();
//			TreeNode PmyLeft = left();
//			TreeNode PmyRight = right();
//			TreeNode PmyParent = parent();
////			TreeNode temp1 = parent();
//			this.myItem = parent().item();
//
//			this.myLeft = parent().left();
//			this.myRight = parent().right();
//			this.myParent = parent().parent();
//			parent
//			TreeNode temp1 = this;
//			temp1 = parent();
//			System.out.println(this);
//			System.out.println(this);
		...
		public void rotateRight(){
			...
			if(parent().isEmpty()){
				left().setParent(theEmptyTreeNode);
			}else{
				if(!(parent().right().isEmpty()) && this.equals(parent().right())){
