public class AVLTree {
	...
	private class NonEmptyTreeNode extends TreeNode {
		...
		private void rotateRight() {
			...
			TreeNode thisNode = new NonEmptyTreeNode(item(), this);
			thisNode.setRight(right());
			right().setParent(thisNode);
			thisNode.setLeft(leftRightNode);
			leftRightNode.setParent(thisNode);
			
			setItem(leftNode.item());
			setRight(thisNode);
			setLeft(leftNode.left());
			leftNode.left().setParent(this);
		}
		...
		private void rotateLeft() {
			...
			left().setParent(thisNode);
			thisNode.setRight(rightLeftNode);
			rightLeftNode.setParent(thisNode);

			setItem(rightNode.item());
			setLeft(thisNode);
			setRight(rightNode.right());
			rightNode.right().setParent(this);
		}
