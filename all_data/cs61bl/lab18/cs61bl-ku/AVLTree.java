...
public class AVLTree {
	...
	private class NonEmptyTreeNode extends TreeNode {
		...
		public void rotateRight() { //rotate with left
			TreeNode left = this.myLeft;
			this.parent().setLeft(left);
			left.setParent(this.myParent);
			setParent(this.myLeft);
			setLeft(left.right());
			left.setRight(this);
		}
		
		public void rotateLeft() { //rotate with right child
			TreeNode right = this.myRight;
			this.parent().setRight(right);
			right.setParent(this.myParent);
			setParent(this.myRight);
			setRight(right.left());
			right.setLeft(this);
		}
