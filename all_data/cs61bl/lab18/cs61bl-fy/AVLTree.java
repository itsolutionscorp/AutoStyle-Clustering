...
public class AVLTree {
	...
	private class NonEmptyTreeNode extends TreeNode {
		...
		public void insert(int item) {
			...
			if (item > myItem) {
				if (this.myRight.isEmpty()) {
					this.myRight = new NonEmptyTreeNode(item, this);
					return;
				} else {
			...
			if (item < myItem) {
				if (this.myLeft.isEmpty()) {
					this.myLeft = new NonEmptyTreeNode(item, this);
					return;
				} else {
		...
		public void rotateRight() {
			...
			if (IsRoot) {
				this.myLeft.setParent(this.myParent);
				this.myParent = this.myLeft;
				this.myLeft = this.myParent.right();
				this.myParent.setRight(this);
				myRoot = this.myParent;
			} else {
				this.myRight = this.myParent;
				this.myRight.setLeft(myLeft.right());
				if (this.myRight.parent().isEmpty()) {
					myRoot = this;
				}
		...
		public void rotateLeft() {
			...
			if (IsRoot) {
				this.myRight.setParent(this.myParent);
				this.myParent = this.myRight;
				this.myRight = this.myParent.left();
				this.myParent.setLeft(this);
				myRoot = this.myParent;
			} else {
				this.myLeft = this.myParent;
				this.myLeft.setRight(myRight.left());
				if (this.myLeft.parent().isEmpty()) {
					myRoot = this;
				}
