public class AVLTree {
	...
	private class NonEmptyTreeNode extends TreeNode {
		...
		public void balance() {
			if (!isAlmostBalanced() && balanceFactor() < 0) {
			...
			else if (!isAlmostBalanced() && balanceFactor() > 0) {
	...
	public static void main(String[] args) {
		...
		System.out.println(t7.isAlmostBalanced());
	}
	//ORIGINAL
}