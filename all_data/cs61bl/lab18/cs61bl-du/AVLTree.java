...
public class AVLTree {
	...
	private class NonEmptyTreeNode extends TreeNode {
		...
		public void rotateLeft() {
			if (myLeft instanceof NonEmptyTreeNode) {
				NonEmptyTreeNode temp = (NonEmptyTreeNode) myLeft;
				myLeft = myRight;
				myRight = temp;
			}
		}
		...
		public void rotateRight() {
			if (myRight instanceof NonEmptyTreeNode) {
				NonEmptyTreeNode temp = (NonEmptyTreeNode) myRight;
				myRight = temp.myLeft;
				temp.myLeft = this;
			}
		}
