	...
	private class NonEmptyTreeNode extends TreeNode {
		...
		public void insert(int item) {
			...
			if (! this.isAlmostBalanced()){
				//rotate that stuff
				if (this.myLeft.height() > this.myRight.height()){
					this.rotateLeft();
				} else {
					this.rotateRight();
				}
		...
		public void rotateLeft(){
			//set this.item to this.myleft.item, which changes root of tree to this.myleft
			//set this.left to this.myleft.myleft
			int thisStartItem = this.item();
			TreeNode thisStartLeft = this.myLeft;
			TreeNode thisStartRight = this.myRight;
			this.myItem = this.myLeft.item();
			this.myLeft = this.myLeft.left();
			this.myLeft.setParent(this);
			this.myRight = new NonEmptyTreeNode(thisStartItem, this);
			this.myRight.setRight(thisStartRight);
			this.myRight.setLeft(thisStartLeft.right());
			this.myRight.left().setParent(this.myRight);
		...
		public void rotateRight(){
			...
			TreeNode thisStartLeft = this.myLeft;
			TreeNode thisStartRight = this.myRight;
			this.myItem = this.myRight.item();
			this.myRight = this.myRight.right();
			this.myRight.setParent(this);
			this.myLeft = new NonEmptyTreeNode(thisStartItem, this);
			this.myLeft.setLeft(thisStartLeft);
			this.myLeft.setRight(thisStartRight.left());
			this.myLeft.right().setParent(this.myLeft);
		}
