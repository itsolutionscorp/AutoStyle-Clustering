...
public class AVLTree {
	...
	private class NonEmptyTreeNode extends TreeNode {
		...
		public void rotateRight() {
			...
			TreeNode tempLeft = myLeft;
			myLeft.setRight(myRoot);
			myLeft.setParent(theEmptyTreeNode);
			myRoot.setLeft(temp);
			myRoot.setParent(tempLeft);
			myRoot = tempLeft;
		}
		
		public void rotateLeft() {
			TreeNode temp = myRight.left();
			TreeNode tempRight = myRight;
			myRight.setLeft(myRoot);
			myRight.setParent(theEmptyTreeNode);
			myRoot.setRight(temp);
			myRoot.setParent(tempRight);
			myRoot = tempRight;
		}
