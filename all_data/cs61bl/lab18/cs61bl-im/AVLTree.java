...
public class AVLTree {
	...
	private class NonEmptyTreeNode extends TreeNode {
		...
		private void rotateLeft() {
			...
			TreeNode rightLeft = myRight.left();
			TreeNode rightRight = myRight.right();
			int item = myItem;
			myItem = myRight.item();
			myLeft = new NonEmptyTreeNode(item, this);
			myLeft.setLeft(left);
			myLeft.setRight(rightLeft);
			myRight = rightRight;
		...
		private void rotateRight() {
			...
			TreeNode leftLeft = myLeft.left();
			TreeNode leftRight = myLeft.right();
			int item = myItem;
			myItem = myLeft.item();
			myRight = new NonEmptyTreeNode(item, this);
			myRight.setLeft(leftRight);
