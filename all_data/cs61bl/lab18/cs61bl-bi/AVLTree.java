...
public class AVLTree {
	...
	private class NonEmptyTreeNode extends TreeNode {
		...
		public void insertHelper(TreeNode t, int item) {
			if ( t.right().isEmpty() && item > t.item()) {
				t.setRight(new NonEmptyTreeNode(item));
			} else if (t.left().isEmpty() && item < t.item()) {
				t.setLeft(new NonEmptyTreeNode(item));
			} else if (item < t.item()) {
				insertHelper(t.left(), item);
			} else  {
				insertHelper(t.right(), item);
			}
		}
		...
		public void rotateRight() {
			TreeNode head = myRight;
			TreeNode LeftOfHead = head.left();
			head.setLeft(this);
			this.setRight(LeftOfHead);
			myRoot = head;
		...
		public void rotateLeft() {
			...
			TreeNode head = myLeft;
			head.toString();
			TreeNode RightOfHead = head.right();
			this.setLeft(RightOfHead);
			head.setRight(this);
			myRoot = head;
		}
