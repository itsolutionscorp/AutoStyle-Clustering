...
public class AVLTree {
	...
	private abstract class TreeNode {
		...
		public abstract void balance(TreeNode t);
	...
	private class NonEmptyTreeNode extends TreeNode {
		...
		public void balance(TreeNode t) {
			...
			if (!t.isAlmostBalanced()) {
				if (t.right().balanceFactor() == -1) {
					t.right().rotateLeft();
				} else if (t.left().balanceFactor() == 1) {
					t.left().rotateRight();
				} else if (t.right().balanceFactor() == 1 && !t.parent().parent().isEmpty()) {
					TreeNode temp = t.right();
					temp.rotateLeft();
					temp.rotateRight();
				} else if (t.left().balanceFactor() == -1 && !t.parent().parent().isEmpty()) {
		...
		public void rotateLeft() {
			...
			tempParent.setParent(this);
			tempParent.setRight(tempLeft);
			this.setLeft(tempParent);
		}
