...
public class AVLTree {
	...
	private class NonEmptyTreeNode extends TreeNode {
		...
		@Override
		public void insert(int item) {
			if(this.myLeft.equals(theEmptyTreeNode) && this.myRight.equals(theEmptyTreeNode)){
				if(item > this.myItem){
					this.myRight = new NonEmptyTreeNode(item);
					this.myRight.setParent(this);
					return;
				} else{
					this.myLeft = new NonEmptyTreeNode(item);
					this.myLeft.setParent(this);
					return;
				}
			} else if (this.myRight.equals(theEmptyTreeNode) &&  item > this.myItem){
				this.setRight(new NonEmptyTreeNode(item));
				return;
			} else if (this.myLeft.equals(theEmptyTreeNode) &&  item < this.myItem){
		...
		public void rotateLeft(){
			TreeNode pastParent = this.parent();
			TreeNode pastRight = this.right();
			TreeNode pastRL = this.myRight.left();
			pastParent.setParent(pastParent);
			this.setParent(pastRight);
			pastRight.setLeft(this);
			this.setRight(pastRL);
			myRoot = pastRight;
		}
		...
		public void rotateRight(){
			TreeNode pastParent = this.parent();
			TreeNode pastLeft = this.right();
			TreeNode pastLR = this.myLeft.right();
			pastParent.setLeft(pastLeft);
			pastLeft.setParent(pastParent);
			this.setParent(pastLeft);
			pastLeft.setRight(this);
			this.setLeft(pastLR);
			myRoot = pastLeft;
		}
