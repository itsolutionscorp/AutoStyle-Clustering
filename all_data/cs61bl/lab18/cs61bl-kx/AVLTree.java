...
//////////////////////////////////////////////////////////////////////////////////////////
	...
	private class NonEmptyTreeNode extends TreeNode {
		...
		public void insert(int item) {
			...
			myRoot= insertHelper(item, myRoot);
			}
		}
		
		public TreeNode insertHelper(int item, TreeNode n){
			if( n.isEmpty()){
				n= new NonEmptyTreeNode(item);
				return n;
				
			}
			if (item < n.item()){
				n.setLeft(insertHelper(item, n.left()));
				...
				n.setRight(insertHelper(item, n.right()) );
				if( n.balanceFactor() == -2){
		...
		private TreeNode doubleRotateLeft(TreeNode n){
			n.setLeft(rotateRight(n.left()));
			return rotateLeft(n);
		}
		
		private TreeNode doubleRotateRight(TreeNode n){
			n.setRight(rotateLeft(n.right()));
		...
		public int balanceFactor2(TreeNode left, TreeNode right) {
			return left.height() - right.height();
		}
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	public static void main(String[] args) {
		...
		System.out.println("initiated:" + t1);
		t1.insert(2);
		System.out.println("2 added: " + t1);
		
		t1.insert(3);
		System.out.println("3 added" + t1);
