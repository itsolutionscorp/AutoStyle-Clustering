public class AVLTree {
	...
	public void insert(int item) {
		myRoot.insert(item);
		myRoot = myRoot.balance();
		myRoot.setParent(theEmptyTreeNode);
	}
	...
	private abstract class TreeNode {
		 ...
		 * Balances this tree.
		 */
		public abstract TreeNode balance();
