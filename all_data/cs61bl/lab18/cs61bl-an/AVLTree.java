...
public class AVLTree {
	...
	private abstract class TreeNode {
		 ...
		 * @return 
		 */
		public abstract TreeNode insert(int item);
		 ...
		 */
		public abstract TreeNode balance(TreeNode t);
	...
	private class NonEmptyTreeNode extends TreeNode {
		...
		public TreeNode insert(int item) {
			// TODO Your code here!
			if (myLeft == theEmptyTreeNode && item < myItem) {
				setLeft(new NonEmptyTreeNode(item, this));
				return this;
			} else if (myRight == theEmptyTreeNode && item > myItem) {
