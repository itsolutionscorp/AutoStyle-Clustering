...
public class ArrayBST {
    ...
    private boolean contains(int index, int value) {
    	...
    	int valueAtIndex =getNode(index).value();
    	if (valueAtIndex == value) {
    		return true;
    	} else if (valueAtIndex < value) {
    		return contains(getRightOf(index), value);
    	} else {
    		return contains(getLeftOf(index), value);
    	}
    }
