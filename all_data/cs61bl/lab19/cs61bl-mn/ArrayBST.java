...
public class ArrayBST {
    ...
    private boolean contains(int value) {
        ...
        while (curIndex < contents.size()) {
            if (value == contents.get(curIndex).value()) {
                return true;
            } else if (value < contents.get(curIndex).value()) {
                curIndex = getLeftOf(curIndex);
            } else {
                curIndex = getRightOf(curIndex);
            }
        }
        return false;
