...
public class ArrayBST {
	...
	public boolean contains(int value){
		return containsHelper(value, 1);
	}
	private boolean containsHelper(int value, int index){
		if(getNode(index) == null) return false;
		else if(getNode(index).value() == value) return true;
		else if(containsHelper(value, getLeftOf(index))) return true;
		else if (containsHelper(value, getRightOf(index))) return true;
		return false;
	}
    ...
    public static void main(String[] args) {
		...
		System.out.println("BST should contain 9, 8, 7, 6, 11, 10. Print true or false if it contains these,"
				+ "		respectively.");
		System.out.println(bst.contains(9) + " " + bst.contains(8) + " " + bst.contains(7) + " " + bst.contains(6) + " "
				+ bst.contains(11) + " " + bst.contains(10));
    }
