...
public class ArrayBST {
	...
	public boolean containsHelper(int value, int index) {
		...
		if(this.getNode(index).value() == value) {
			return true;
		}
		else if(this.getNode(index).value() > value) {
			return containsHelper(value, this.getLeftOf(index));
		}
		else {
			return containsHelper(value,this.getRightOf(index));
		}
	}
