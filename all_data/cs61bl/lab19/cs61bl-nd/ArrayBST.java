...
public class ArrayBST {
	...
	public boolean contains (int value){
		return nodeContains(value, 1);
		}

	public boolean nodeContains(int value, int index){
		if (getNode(index) == null){
			return false;
		}
		if (getNode(index).value() == value){
			...
			return nodeContains(value, getRightOf(index)) || nodeContains(value, getLeftOf(index));
		}
	}
