...
public class ArrayBST {
	...
	public boolean contains(int value, int pos) {
		if (getNode(pos) == null) {
			return false;
		}
		if (getNode(pos).myValue == value) {
			return true;
		}
		if (getNode(getLeftOf(pos)) != null) {
			if (contains(value, getLeftOf(pos))) {
				return true;
			}
		}
		if (getNode(getRightOf(pos)) != null) {
			if (contains(value, getRightOf(pos))){
				return true;
			}
		}
		return false;
