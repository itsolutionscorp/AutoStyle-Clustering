...
public class ArrayBST {
	...
	public boolean contains (int value) {
			if(this.getNode(1).myValue == value){
				return true;
			} else {
	...
	public boolean containsHelper(int value, int count){
		if(this.getNode(count).myValue == value){
			return true;
		} else if(this.getNode(getLeftOf(count)) != null){
			return containsHelper(value, getLeftOf(count));
		} else if (this.getNode(getRightOf(count)) != null){
			return containsHelper(value, getRightOf(count));
		} else {
		return false;
		}
	}
