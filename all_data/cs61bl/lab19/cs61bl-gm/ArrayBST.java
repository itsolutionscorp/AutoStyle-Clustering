...
public class ArrayBST {
	...
	private boolean containsHelper(int value, int pos) {
		Node checkNode = getNode(pos);
		if (checkNode == null) {
			return false;
		}
		if (value == checkNode.myValue) {
			return true;
		} return containsHelper(value, getLeftOf(pos)) || containsHelper(value, getRightOf(pos));
	}
