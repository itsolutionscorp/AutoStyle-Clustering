...
public class ArrayBST {
    ...
    public boolean containsHelper (int start, int value) {
    	if (start < contents.size()) {
    		return (contents.get(start)!= null && contents.get(start).myValue == value) || containsHelper(getLeftOf(start), value) || containsHelper(getRightOf(start), value);
    	}
    	return false;
    }
