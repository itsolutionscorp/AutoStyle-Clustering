...
public class ArrayBST {
	...
	private boolean contains(int i, int value) {
		Node root = getNode(i);
		if (root == null) {
			return false;
			...
			int leftIndex = getLeftOf(i);
			return contains(leftIndex, value);
		} else {
			int rightIndex = getRightOf(i);
			return contains(rightIndex, value);
		}
	}
