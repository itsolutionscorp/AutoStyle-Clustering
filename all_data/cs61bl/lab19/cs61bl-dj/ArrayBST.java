...
public class ArrayBST {
	...
	public boolean contains(int value) {
		if (getNode(1).myValue == value) {
			return true;
		} else if (value < getNode(1).myValue) {
			return containsHelper(getNode(getLeftOf(1)), value);
		} else {
			return containsHelper(getNode(getRightOf(1)), value);
		}
	}

	public boolean containsHelper(Node t, int value) {
		if (t == null) {
			return false;
		}
		if (t.myValue == value) {
			return true;
		} else if (value < t.myValue) {
			return containsHelper(getNode(getLeftOf(contents.indexOf(t))),
					value);
		} else {
			return containsHelper(getNode(getRightOf(contents.indexOf(t))),
					value);
		}
	}
