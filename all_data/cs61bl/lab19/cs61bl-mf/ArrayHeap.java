...
public class ArrayHeap<T> {
	...
	public void insert(T item, double priority) {
		...
		while (getNode(getParentOf(targetIndex)) != null && min(getParentOf(targetIndex), targetIndex) == targetIndex) {
	...
	public void changePriority(T item, double priority) {
		for (int targetIndex = 1; targetIndex < contents.size(); targetIndex++) {
