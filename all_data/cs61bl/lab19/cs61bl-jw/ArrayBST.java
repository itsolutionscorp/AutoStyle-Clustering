...
public class ArrayBST {
	...
	private void insertInSubtree(int subTreeRootIndex, int value) {
		...
		if (subTreeRoot.value() == value) {
			System.out.println("duplicated Node are not allowed");
			return ;
		}
	...
	public boolean contains (int subTreeRootIndex, int value) {
		if(value > contents.size() +1 ){		
			return false;
		}
		
		Node root = this.getNode(subTreeRootIndex);
		if(root == null ){
			return false;
		}
		if (root.value() == value) {
			...
			return contains(this.getLeftOf(subTreeRootIndex),value);
		}else{
			 return contains(this.getRightOf(subTreeRootIndex),value);		
		}
...
//        bst.insert(14);
		...
		System.out.println(" contains 10 Should be True   : " +  bst.contains(1,10));
		System.out.println(" contains 9 Should be True   : " + bst.contains(1,9));
		System.out.println(" contains 11 Should be True   : " +  bst.contains(1, 11));
		System.out.println(" contains 6 Should be True   : " + bst.contains(1,6));
		System.out.println(" contains 100 Should be fasle  : " + bst.contains(1,100));
		System.out.println(" contains 8 Should be True   : " +  bst.contains(1,8));
		System.out.println(" contains 7 Should be True   : " +  bst.contains(1,7));
