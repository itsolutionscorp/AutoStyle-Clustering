...
public class ArrayBST {
	...
	public boolean contains(int value){
		...
		while(getNode(n) != null){
			if (getNode(n).value() == value)
				return true;
			else if (value < getNode(n).value())
				n = 2*n;
			else 
				n = 2*n + 1;
		}
    ...
    public static void main(String[] args) {
		...
		System.out.println(bst.contains(11)); // true
		System.out.println(bst.contains(12)); //false
		System.out.println(bst.contains(2)); //false
		System.out.println(bst.contains(9)); //true
