...
public class ArrayHeap<T> {
	...
	private void bubbleUp(int index) {
        while (getNode(getParentOf(index)) != null && min(getParentOf(index), index) == index) {
	...
	private void bubbleDown(int index) {
        while (getNode(getLeftOf(index)) != null) {
            ...
            if (rightChild != null && min(getLeftOf(index), getRightOf(index)) == getRightOf(index)) {
                minIndex = getRightOf(index);
            } 
