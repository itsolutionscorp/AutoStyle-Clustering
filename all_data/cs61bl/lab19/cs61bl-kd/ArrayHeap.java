...
public class ArrayHeap<T> {
	...
	private void bubbleDown(int index) {
		...
		int minL = min(index, getLeftOf(index));
		int minR = min(index, getRightOf(index));
		int mintot = min(getLeftOf(index), getRightOf(index));
		if (index == minL && index == minR) {
			return;
		}
		else {
			swap(index, mintot);
