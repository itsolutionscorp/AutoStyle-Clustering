...
public class ArrayBST {
	...
	private boolean containsHelper(int index, int value){
		...
		if (l!=0 && getNode(l).value() == value){
			return true;
		}
		if (r!=0&&getNode(r).value() == value){
			return true;
		}
		if (l==0&&r==0){
			return false;
		...
		if (l==0){
			return containsHelper(r, value);
		} else if (r==0){
			return containsHelper(l, value);
		}
		return (containsHelper(r, value)|| containsHelper(l, value));
