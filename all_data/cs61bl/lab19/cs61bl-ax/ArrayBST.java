...
public class ArrayBST {
	...
	/**
	 * Returns whether the ArrayBST contains this value.
	 */
	...
	public boolean containsHelper (int value, int index) {
		if (getNode(index) == null) {
			...
			return true;
		} else if (value < getNode(index).myValue) {
			return containsHelper(value, getLeftOf(index));
		} else {
			return containsHelper(value, getRightOf(index));
		}
	}
    ...
    public static void main(String[] args) {
		...
		System.out.println("bst contains 10 is " + bst.contains(10));	// true
		System.out.println("bst contains 4 is " + bst.contains(4));	// false
		System.out.println("bst contains 6 is " + bst.contains(6));	// true
		System.out.println("bst contains 15 is " + bst.contains(15)); // false
