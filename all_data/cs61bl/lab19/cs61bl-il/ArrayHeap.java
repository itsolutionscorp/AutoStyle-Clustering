...
public class ArrayHeap<T> {
	...
	public Node removeMin() {
		...
		Node rtn = contents.remove(contents.size() - 1);
		bubbleDown(1);
		return rtn;
	}
	...
	private void bubbleUp(int index) {
		// TODO Complete this method!
		while (index > 0 && (min(getParentOf(index),index) == index)) {
...
//		while (!sorted) {
//			for (int i = 1; i < heap.contents.size() - 2; i++) {
//				if (heap.min(i, i+1) == i+1) {
//					heap.swap( i, i+1);
//				}
//				System.out.println(heap.contents.toString());
//			}
...
//		 int index = heap.contents.size()/2;
//		 while (index > 0){
