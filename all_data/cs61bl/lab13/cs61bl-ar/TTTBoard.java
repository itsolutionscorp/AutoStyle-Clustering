...
public class TTTBoard {
    ...
    public int hashCode() {
//        String result = ""; //String implementation
//        for (int i = 0;i<3; i ++){
//        	for (int j = 0; j< 3; j ++){
//        		result += myBoard[i][j];
//        	}
...
//        return result.hashCode();
      ...
      String result = "";  //base 3 numeral implementation
      for (int i = 0;i<3; i ++){
      	for (int j = 0; j< 3; j ++){
      		result += myBoard[i][j];
      	}
      ...
      for(int i = 0; i < result.length(); i ++){
    	  int currentInt = 0;
    	  if (result.charAt(8-i) == 'X'){
    		  currentInt = 1;
    	  }else if (result.charAt(8-i) == 'O'){
    		  currentInt = 2;
    	  }else{
    		  currentInt = 0;
    	  }
    	  hashCode += currentInt * Math.pow(3, i);
      }
      return hashCode;
