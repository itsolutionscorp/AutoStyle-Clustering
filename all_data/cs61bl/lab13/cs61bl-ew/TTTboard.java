...
//    		for( int c2 = 0; c2 < myBoard.length; c2++ ){
//    			sassy += myBoard[c][c2];
//    		}
//    	} 
////    	System.out.println(sassy.hashCode());
//        return sassy.hashCode();
//    }
    ...
    public int hashCode(){
    	...
    	for(int c = 0; c < myBoard.length; c++){
    		for(int c2 = 0; c2< myBoard.length; c2++){
    			if(myBoard[c][c2] == 'X'){
    				sausy += 1 *Math.pow(10, x);
    			}else if(myBoard[c][c2] == 'O'){
    				sausy+= 2*Math.pow(10, x);
    			}else{
    				sausy+= 0*Math.pow(10, x);
    			}
    			x++;
    		}
    		
    	}
    	System.out.println(sausy);
    	return sausy;
