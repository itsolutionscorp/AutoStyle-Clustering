...
public class TTTboard {
    ...
    public int hashCode() {
        ...
        // String myBoardStr = myBoard.toString();
        // int myBoardHash = myBoardStr.hashCode();
        // return myBoardHash;

        // nine-digit base 3 numeral
        int val = cell(2, 2) + 3*(cell(2, 1) + 3*(cell(2, 0) + 
               3*(cell(1, 2) + 3*(cell(1, 1) + 3*(cell(1, 0) + 
               3*(cell(0, 2) + 3*(cell(0, 1) + 3*(cell(0, 0))))))))); 
        return val;
    }
        ...
        switch (row) {
            ...
            case 1:
                switch (col) {
                    ...
                    case 1: return allMatch (3, 4, 5) || allMatch (1, 4, 7) || allMatch (0, 4, 8) || allMatch (2, 4, 6);
