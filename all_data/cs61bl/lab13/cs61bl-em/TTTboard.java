...
public class TTTboard {
    ...
    public int hashCode() {
    	...
    	return intArr[2][2] + 3*(intArr[2][1] + 3*(intArr[2][0] + 3*(intArr[1][2] + 3*(intArr[1][1] + 3*(intArr[1][0] + 3*(intArr[0][2] + 3*(intArr[0][1] + 3*(intArr[0][0])))))))); 	
    }
    ...
    public static void main (String[] args) {
        ...
        */ 
        ...
        //System.out.println("O X X XO ".hashCode());
        //int hashNum = 0 + 3*(2 + 3*(1 + 3*(0 + 3*(1 + 3*(0 + 3*(1 + 3*(0 + 3*(2))))))));
