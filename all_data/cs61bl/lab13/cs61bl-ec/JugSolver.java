...
public class JugSolver {
	...
	private HashSet<JugContents> h = new HashSet<JugContents>();
	...
	public JugContents pour (JugContents current, int from, int to) {
		...
		// System.out.println("amtToCanGet " + amtToCanGet);
		int amtFromCanSupply = current.jugs[from];
		//System.out.println("amtFromCanSupply " + amtFromCanSupply);
		int amtPoured = min (amtToCanGet, amtFromCanSupply);
		// System.out.println("amtPoured " + amtPoured);
