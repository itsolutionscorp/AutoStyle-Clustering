...
public class TTTboard {
    ...
    public int hashCode() {
    	// Method 1: convert the board to a String and
    	// then use the String hashCode function
        String stringCode = this.stringCode();
    	return stringCode.hashCode();
        
        // Method 2: interpret the Tic-tac-toe board as a
        // nine-digit base 3 numeral and return the
        // corresponding integer as the hash value
//    	int myCode = 0;
//    	int count = 9;
