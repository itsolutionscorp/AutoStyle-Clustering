...
public class TTTboard {
    ...
    private int convertToString(Object temp){
		...
		throw new IllegalArgumentException("ASDFGH");
		
    }
    private int convertToNumber(String temp){
    	int size  = temp.length();
    	int counter = 0;
    	int total = 0;
    	for (int i = size; i > 0; i--){
    		total += Math.pow(3, counter) * temp.charAt(i - 1); 
    		counter++;
    	}
		return total;
...
//        	for (int j = 0; j < 2; j++){
//        		if (i == 0){
//        			one += convertToString(myBoard[i][j]); 
//        		}
//        		if (i == 1){
//        			two += convertToString(myBoard[i][j]);
//        		}
//        		if (i == 2){
//        			three += convertToString(myBoard[i][j]);
//        		}
//        				
//        	}
//    	}
//    	return convertToNumber(one+two+three);
//    }
//  
