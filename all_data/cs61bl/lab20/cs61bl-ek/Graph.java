...
public class Graph implements Iterable<Integer>{
    ...
    public void addEdge(int v1, int v2, Object edgeInfo) {
        if (v1 < myVertexCount && v1 >= 0 && v2 < myVertexCount && v2 >= 0) {
        	...
        	throw new IllegalArgumentException("Parameters v1 and v2 must both be less than "+myVertexCount+" and greater than or equal to 0.");
        }
    }
    ...
    public boolean isAdjacent(int from, int to) {
    	if (from < myVertexCount && from >= 0 && to < myVertexCount && to >= 0) {
        	...
        	throw new IllegalArgumentException("Parameters from and to must both be less than "+myVertexCount+" and greater than or equal to 0.");
        }
        //return false;
    }
    ...
    public List neighbors(int vertex) {
    	if (vertex < myVertexCount && vertex >= 0) {
    		...
    		throw new IllegalArgumentException("Parameter vertex must be less than "+myVertexCount+" and greater than or equal to 0.");
    	}
        //return null;
    }
