...
//    	ArrayList<Integer> path = visitAll(startVertex, stopVertex);
//    	ArrayList<Integer> reversePath = visitAll(startVertex, stopVertex);
...
//    		if (visitAll(path.get(k)).contains(stopVertex)){
//    			toreturn.add(path.get(k));
//    		}
//    		if (path.get(k).equals(stopVertex)) {
//    			return toreturn;
//    		}
//    	}
//        return new ArrayList<Integer>();
