...
public class Graph implements Iterable<Integer>{
    ...
    private class DFSIterator implements Iterator<Integer> {
        ...
        public Integer next() {
            //your code here
            if (!hasNext ()) {
            	throw new IllegalArgumentException ("There is no more vertices.");
            }
            Integer rn = fringe.pop();
            Iterator<Edge> dIter = myAdjLists[rn.intValue()].iterator();
            while (dIter.hasNext()) {
            	Edge a = dIter.next();
    ...
    public boolean pathExists(int startVertex, int stopVertex) {
        // your code here
    	for (Integer visit: visitAll(startVertex)) {
    		if (visit == stopVertex) {
    			return true;
    		}
    	}
        ...
        if (!pathExists(startVertex, stopVertex)) {
        	...
        	while (iter.hasNext()) {
    			...
    			if (vertex == stopVertex) {
        			...
        			for (Integer visit: visitAll(vertex)) {
        			if (visit == stopVertex) {
            			break;
        			}
        			if (!path.contains(visit) && !visited.contains(visit)) {
        				path.add(visit);
        				visited.add(visit);
        				}
        			}
    ...
    private class TopologicalIterator implements Iterator<Integer> {
        ...
        public Integer next() {
        	...
        	current = fringe.pop();
        	for (Edge a : (myAdjLists[current])) {
        		currentInDegree[a.to()]--;
        	}
        	visited.add(current);
        	for (int i = 0; i < myAdjLists.length; i++) {
    ...
    public static void main(String[] args) {
        ...
        System.out.println();
        System.out.println(g3.pathExists(0, 2));
        System.out.println(g3.pathExists(0, 3));
        System.out.println(g3.pathExists(1, 4));
        System.out.println(g3.pathExists(2, 6));
        System.out.println(g3.pathExists(0, 0));
        System.out.println(g3.pathExists(0, 10));
        ...
        System.out.println(g4.pathExists(1, 2));
        System.out.println(g4.pathExists(2, 0));
        System.out.println(g4.pathExists(2, 3));
        System.out.println(g4.pathExists(4, 2));
