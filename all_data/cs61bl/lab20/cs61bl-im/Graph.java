...
public class Graph implements Iterable<Integer>{
    ...
    private class DFSIterator implements Iterator<Integer> {
        ...
        public Integer next() {
            ...
            visited.add(temp);
            for (Integer neighbor: (ArrayList<Integer>) neighbors(temp)) {
    ...
    public boolean pathExists(int startVertex, int stopVertex) {
        ...
        for (Integer vertex: visitAll(startVertex)) {
    ...
    public ArrayList<Integer> path(int startVertex, int stopVertex) {
        ...
        Integer temp2 = temp.pop();
        toReturn.push(temp2);
        while (!temp.isEmpty()) {
        	temp2 = temp.pop();
        	if (isAdjacent(temp2, toReturn.peek())) {
        		toReturn.push(temp2);
        	}
        }
        while (!toReturn.isEmpty()) {
        	result.add(toReturn.pop());
        }
