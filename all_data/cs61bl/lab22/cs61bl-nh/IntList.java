public class IntList {
    ...
    private ListNode insert(ListNode p, ListNode head) {
        ...
        if(head != null){
            if(p.myItem <= head.myItem)
                ...
                return new ListNode(head.myItem, null, insert(p, head.myNext));
    ...
    public IntList quicksort() {
        ...
        // Assume first element is the divider.
            ...
            ListNode head1 = myHead.myNext;
            while(head1 != null){
                if(head1.myItem >= divider)
                    largeElements.addToEnd(head1.myItem);
                else if(head1.myItem < divider)
                    smallElements.addToEnd(head1.myItem);
                head1 = head1.myNext;
    ...
    public IntList mergeSort() {
        ...
        while(i < mySize/2){
            oneHalf.addToFront(myHead.myItem);
            myHead = myHead.myNext;
            i++;
        }while(i < mySize){
            otherHalf.addToFront(myHead.myItem);
            myHead = myHead.myNext;
            i++;
    ...
    public static void main(String[] args) {
        ...
        //System.out.println(values.myHead);
