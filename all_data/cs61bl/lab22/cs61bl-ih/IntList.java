public class IntList {
	...
	public IntList quicksort() {
		...
		IntList toBeReturned = new IntList();
		toBeReturned.append(smallElements.quicksort());
		toBeReturned.addToEnd(divider);
		toBeReturned.append(largeElements.quicksort());
		return toBeReturned;
	}
