public class IntList {
	...
	public IntList quicksort() {
		...
		IntList middle = new IntList();
		middle.addToEnd(divider);
		while (thing != null) {
			if (thing.myItem < divider) {
				smallElements.addToEnd(thing.myItem);
			} else {
				largeElements.addToEnd(thing.myItem);
			}
			thing = thing.myNext;
		}
		IntList sortedSmall = smallElements.quicksort();
		IntList sortedLarge = largeElements.quicksort();
		sortedSmall.append(middle);
	...
	public IntList mergeSort() {
		...
		IntList sortedfirst=oneHalf.mergeSort();
		IntList sortedlast=otherHalf.mergeSort();
		return merge(sortedfirst.myHead, sortedlast.myHead);
	}
