public class IntList {
	...
	public IntList quicksort() {
		...
		for (ListNode current = myHead.myNext; current != null; current = current.myNext){
		...
		IntList rtnValue = new IntList();
		rtnValue.append(smallElements.quicksort());
		rtnValue.addToEnd(divider);
		rtnValue.append(largeElements.quicksort());
		return rtnValue;
	}
