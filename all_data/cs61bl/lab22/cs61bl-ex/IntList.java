public class IntList {
	...
	private ListNode insert(ListNode p, ListNode head) {
		...
		ListNode ln = new ListNode(p.myItem);
		if (head == null) {
			head = ln;
			head.myNext = null;
			head.myPrev = null;
		...
		for (ListNode l = head; l != null; l = l.myNext) {
			if (p.myItem <= l.myItem && l.myPrev == null) {
				ln.myNext = l;
				ln.myPrev = l.myPrev;
				return ln;
			}
			if (p.myItem >= l.myItem && l.myNext == null) {
				ln.myPrev = l;
				ln.myNext = l.myNext;
				l.myNext = ln;
				return head;
			}
			if (p.myItem <= l.myItem && p.myItem >= l.myPrev.myItem) {
				ln.myNext = l;
				ln.myPrev = l.myPrev;
				l.myPrev = ln;
				return head;
			}
			if (p.myItem >= l.myItem && p.myItem <= l.myNext.myItem) {
				ln.myPrev = l;
				ln.myNext = l.myNext;
				l.myNext = ln;
				return head;
