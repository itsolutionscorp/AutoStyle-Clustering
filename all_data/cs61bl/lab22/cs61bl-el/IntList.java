public class IntList {
	...
	private ListNode insert(ListNode p, ListNode head) {
		...
		if (toInsert.myItem >= pointer.myItem && pointer.myNext == null) {
			pointer.myNext = toInsert;
			toInsert.myPrev = pointer;
			return pointer;
		}

		while (pointer.myNext != null) {
			if (pointer.myNext.myItem > toInsert.myItem) {
				break;
			}
		...
		ListNode temp = pointer.myNext;
		pointer.myNext = toInsert;
		toInsert.myPrev = pointer;
		toInsert.myNext = temp;
		temp.myPrev = toInsert;
		return head;
	}
	...
	public IntList quicksort() {
		...
		ListNode pointer = myHead.myNext;
		// TODO your code here!
	...
	public IntList mergeSort() {
		...
		// Another way to write it - slightly different:
