...
//				for (ListNode m=n; m!=head && m.myItem<m.myPrev.myItem;m=m.myPrev){
//					int temp=m.myPrev.myItem;
//					m.myPrev.myItem=m.myItem;
//					m.myItem=temp;
//				}
//			}
//		}
...
//	}
	...
	private ListNode insert(ListNode p, ListNode head) {
		if (head==null){
			...
			for (ListNode n = p; n!=myHead && n.myItem<n.myPrev.myItem; n=n.myPrev){
