public class IntList {
	...
	private ListNode insert(ListNode p, ListNode head) {
		...
		if (head == null || head.myItem >= p.myItem) {	
		...
		while (curr != null && curr.myItem < p.myItem) {
		...
		if (curr == null) {
			...
			temp.myPrev = curr.myPrev;
			curr.myPrev.myNext =temp;
...
//		ListNode newln = new ListNode(p.myItem);
//		if(head == null){
//			head = newln;
//			return newln; 
//		}
//		if (newln.myItem >= head.myItem){
//			ListNode firstInsert = head;
//			newln.myNext = firstInsert; 
//			firstInsert.myPrev = newln;
//			head = newln; 
//			return head;
//		}
//		ListNode toInsert;
//		boolean sorted = false;
//		for (toInsert = head; toInsert!=null;){
//			if (toInsert.myItem < newln.myItem){
//				sorted = true;
//				break;
//			} else {
//				toInsert = toInsert.myNext;
//			}
//		}
//		if (sorted == false){
...
//		
	...
	public IntList quicksort() {
		...
		// TODO your code here!
		ListNode rest = myHead.myNext;
		
		
		for (ListNode p = rest; p != null; p = p.myNext) {
			if (p.myItem < divider) {
		...
		IntList beg = smallElements.quicksort();
		beg.addToEnd(divider);
		IntList end = largeElements.quicksort();
		beg.append(end);
	...
	public IntList mergeSort() {
		...
		ListNode ln = myHead;
		while (ln != null){
			oneHalf.addToEnd(ln.myItem);
			ln = ln.myNext;
			if(ln != null){
				otherHalf.addToEnd(ln.myItem);
				ln = ln.myNext;
			}
		}
