public class IntList {
	...
	public IntList mergeSort() {
		...
		oneHalf.myTail = otherHalf.myHead.myPrev;
		oneHalf.mySize = mySize / 2;
		otherHalf.mySize = mySize - i;
		oneHalf.myTail.myNext = null;
		otherHalf.myHead.myPrev = null;
		otherHalf = otherHalf.mergeSort();
		oneHalf = oneHalf.mergeSort();
		return merge(otherHalf.myHead, oneHalf.myHead);
	}
