public class IntList {
	...
	private ListNode insert(ListNode p, ListNode head) {
		...
		ListNode n= new ListNode(p.myItem);
		if( head != null){
			if(head.myItem > p.myItem){
				...
				if(head.myPrev != null){
					head.myPrev.myNext = n;
					n.myPrev = head.myPrev;
				}
				else{
					n.myPrev = null;
				}
				...
				ListNode curr = head.myNext;
				while (curr != null){
					if(curr.equals(p)){
						return head;
					}
					if (curr.myItem > p.myItem){
						p.myPrev.myNext = p.myNext;
						if(p.myNext != null)
							p.myNext.myPrev = p.myPrev;
						n.myNext = curr;
						n.myPrev = curr.myPrev;
						curr.myPrev.myNext = n;
						curr.myPrev = n;	
						return head;
					}
					else{
