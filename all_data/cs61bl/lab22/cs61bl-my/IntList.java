public class IntList {
	...
	private ListNode insert(ListNode p, ListNode head) {
		...
		if (head.myItem > p.myItem) {
			...
			while (head.myItem < p.myItem && head.myNext != null) {
				head = head.myNext;
			}
			if (head.myNext == null && p.myItem > head.myItem) {
				p.myPrev = head;
				head.myNext = p;
			} else {
	...
	public IntList quicksort() {
		...
		for (int i = 1; i < mySize; i ++){
			myHead = myHead.myNext;
			if (myHead.myItem < divider) smallElements.addToEnd(myHead.myItem);
			else largeElements.addToEnd(myHead.myItem);
		}
		smallElements = smallElements.quicksort();
		largeElements = largeElements.quicksort();
//		ListNode holder = smallElements.myHead;
//		for (int i = 0; i < smallElements.mySize; i ++) {
//			System.out.print(holder.myItem);
//			System.out.print(" ");
//			holder = holder.myNext;
//		}
//		holder = largeElements.myHead;
//		System.out.println("");
//		for (int i = 0; i < largeElements.mySize; i ++) {
//			System.out.print(holder.myItem);
//			System.out.print(" ");
//			holder = holder.myNext;
//		}
//		System.out.println("Middle:" + middleElement.myHead.myItem);
//		System.out.println("");
//		System.out.println("@@@@@@@@@@@@");
