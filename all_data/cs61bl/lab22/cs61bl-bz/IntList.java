public class IntList {
	...
	private ListNode insert(ListNode p, ListNode head) {
		...
		if (head==null){
			...
			for (ListNode a = head; a != null; a = a.myNext) {
				if (a.myPrev == null && num < a.myItem){
					head = new ListNode (num,null,a);
					a.myPrev = head;
					break;
				} else if (a.myNext==null&& num > a.myItem){
					a.myNext = new ListNode (num,a,null);
					break;
				}else if (a.myItem<num&& a.myNext.myItem>=num){
					ListNode d = new ListNode (num, a, a.myNext);
					a.myNext = d;
					a.myNext.myPrev = d;
					break;
				}
	...
	public IntList quicksort() {
		...
		for (ListNode temp2 = list2.myHead; temp2 != null; temp2 = temp2.myNext) {
			list1.addToEnd(temp2.myItem);
		}
		return list1;
