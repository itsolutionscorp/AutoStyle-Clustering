public class IntList {
	...
	private ListNode insert(ListNode p, ListNode head) {
		...
		while(temp != null) {
			if(p.myItem < head.myItem){
				...
				toInsert.myPrev = null;
				head.myPrev = toInsert;
				head = toInsert;
				temp = temp.myNext;
				break;
			}else if(toInsert.myItem < temp.myItem){
				ListNode previous = temp.myPrev;
				temp.myPrev = toInsert;
				previous.myNext = toInsert;
				toInsert.myPrev = previous;
				toInsert.myNext = temp;
				break;
			} else if(temp.myNext == null){
	...
	public IntList quicksort() {
		...
		} else if(largeElements.isEmpty()){
			largeElements.isEmpty();
		}
