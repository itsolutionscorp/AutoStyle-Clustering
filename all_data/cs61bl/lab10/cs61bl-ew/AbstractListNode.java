...
abstract public class AbstractListNode {
	...
	abstract void setNext(AbstractListNode list);
	...
	public Comparable smallest() {
  	  if (isEmpty()) {
  	    throw new NoSuchElementException("non existanat");
  	  }
...
class NonemptyListNode extends AbstractListNode {
    ...
    public AbstractListNode appendInPlace(AbstractListNode list2){
    	this.myNext = this.next().appendInPlace(list2);
    	return this;
    }
}
...
class EmptyListNode extends AbstractListNode {
    ...
    public void setNext(AbstractListNode list){
    	throw new IllegalArgumentException("nothing to be next");
    }
}
