...
public class AmoebaFamily implements Iterable<AmoebaFamily.Amoeba>{
	...
	public static void main(String[] args) {
		...
		family.addChild("Hilary", "Schredder");
		//family.makeNamesLowercase();
		//family.replaceName("auntie", "Schredder");
		//System.out.println(family.myRoot.myChildren.get(1));
		//family.printFlat();
	...
	public static class Amoeba {
        ...
        public void print(int indent){
        	System.out.println(helperPrint(indent) + myName);
        	for (Amoeba a: myChildren){
        		a.print(indent + 1);
        		//System.out.println("hello");
        	}
        }
        public String helperPrint(int indentLevel){
        	int counter = indentLevel*4;
        	String rtnValue = "";
        	while (counter > 0){
        		rtnValue += " ";
        		counter--;
        ...
        public String longestName(){
        	...
        	for (Amoeba a : myChildren){
        		if (maxName.length() < a.longestName().length()){
        ...
        private int height() {
            if (myChildren.isEmpty()) {
                ...
                int bestSoFar = 1;
                for (Amoeba a : myChildren) {
                	int childHeight = 1 + a.height();
                	if (childHeight > bestSoFar){
                		bestSoFar = childHeight;
                	}
                }
                return bestSoFar;
            }
