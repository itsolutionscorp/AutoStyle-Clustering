...
public class BinaryTree {
    ...
    public void fillSampleTreeBalaced3(){
		myRoot=new TreeNode("a", 
						new TreeNode("b", new TreeNode("d", new TreeNode("e"), new TreeNode("f")),new TreeNode("d", new TreeNode("e"), new TreeNode("f")) ),
						new TreeNode("c",
								new TreeNode("d", new TreeNode("e"), new TreeNode("f")),new TreeNode("d", new TreeNode("e"), new TreeNode("f"))));
}
