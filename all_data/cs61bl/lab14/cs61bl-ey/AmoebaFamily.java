...
public class AmoebaFamily implements Iterable<AmoebaFamily.Amoeba> {
	...
	public void makeNamesLowercase() {
		if (myRoot != null) {
			...
			myRoot.makeNamesLowercaseHelper();
		}
	}
	...
	public void replaceName(String currentName, String newName) {
		if (myRoot != null)
			myRoot.replaceNameHelper(currentName, newName);
	}
	...
	public static void main(String[] args) {
		...
		family.replaceName("Marge", "haiiiiiiiiiii");
		family.addChild("Lisa", "coolio");
	...
	public static class Amoeba {
		...
		private void helperPrint(int n) {
			String tab = " ";
			for (Amoeba a : myChildren) {
				for (int j = 0; j < n; j++) {
		...
		private void replaceNameHelper(String currentName, String newName) {
			for (Amoeba a : myChildren) {
		...
		private void makeNamesLowercaseHelper() {
			for (Amoeba a : myChildren) {
				a.myName = a.myName.toLowerCase();
				a.makeNamesLowercaseHelper();
			}
		}

		private void printFlatHelper() {
			for (Amoeba a : myChildren) {
				System.out.println(a.myName);
				a.printFlatHelper();
			}
