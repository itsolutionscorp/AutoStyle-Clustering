...
public class AmoebaFamily implements Iterable<AmoebaFamily.Amoeba>{
	...
	public static void main(String[] args) {
		...
		family.addChild("auntie", "me");
		family.addChild("me", "Mike");
		family.addChild("Mike", "Mike2");
		family.addChild("Mike2", "Mike3");
		family.addChild("Mike3", "Mike4");
		family.addChild("Mike4", "Mike5");
		...
		family.addChild("Marge", "Hilaryfdsafdas");
		family.addChild("Bill", "Bill2");
		family.makeNamesLowercase();
		family.replaceName("amos mccoy", "dog");
	...
	public static class Amoeba {
        ...
        public String longestName() {
            ...
            int maxLengthSeen = maxName.length();
            for (Amoeba a : myChildren) {
        ...
        public void printHelper(String spaces) {
        	if (myName != null) {
        		System.out.println(spaces + myName);
        		for (Amoeba a: myChildren) {
        			a.printHelper(spaces + "    ");
        		}
        	}
        }
    	...
    	private int height() {
    	    if (myChildren.isEmpty()) {
	        	...
	        	int tempBest = 1;
    	        for (Amoeba a : myChildren) {
    	            tempBest = Math.max(a.height(), tempBest);
    	        }
    	        return 1 + tempBest;
    	    }
    	}
