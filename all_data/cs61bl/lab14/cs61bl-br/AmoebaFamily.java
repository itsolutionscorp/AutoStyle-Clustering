...
public class AmoebaFamily implements Iterable<AmoebaFamily.Amoeba>{
	...
	public static void main(String[] args) {
		...
		family.print();
		System.out.println();
		System.out.println("This is how big our family is! " + family.size());
		System.out.println("The longest name is: " + family.longestName() + ", with a size of: " + family.longestNameLength());
		System.out.println("The height of our family is: " + family.height());
	}
	...
	public static class Amoeba {
        ...
        public void prettyPrint(int spaces) {
        	...
        	System.out.println(pre + myName);
        	for (Amoeba a: myChildren) {
        		a.prettyPrint(spaces + 1);
        	}
        }
        ...
        public String longestName() {
        	...
        	for(Amoeba a : myChildren) {
        		String babyName = a.longestName();
        		if(maxSeen.length()<babyName.length()) {
        			maxSeen = babyName;
        		}
        	}
        	return maxSeen;
        ...
        private int height() {
        	int height = 1;
            for (Amoeba a : myChildren) {
                height = Math.max(1+ a.height(), height);
            }
            return height;
        }
    }
