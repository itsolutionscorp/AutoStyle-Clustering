...
public class Graph implements Iterable<Integer>{
    ...
    public int inDegree(int vertex) {
        ...
        for (int i = 0; i < myAdjLists.length; i++) {
        	if (i != vertex && isAdjacent(i, vertex)) {
        		count++;
        	}
        } return count;
    }
    ...
    private class DFSIterator implements Iterator<Integer> {
        ...
        public Integer next() {
        	...
        	if (!visited.contains(current)) {
            	visited.add(current);
            	List<Edge> neighborlist = neighbors(current);
    ...
    public ArrayList<Integer> shortestPath (int startVertex, int endVertex){
    	...
    	double[] lengths = new double[myVertexCount];
		fringe.insert(startVertex, 0);
		lengths[startVertex] = 0;
		...
		while (fringe.peek() != null) {
	    	Integer current = fringe.peek().item();
	    	Double priority = fringe.removeMin().priority(); 
	    	settled.add(current);
	    	List<Edge> neighbors = neighbors(current);
	    	for (Edge e : neighbors) {
	    		if (!settled.contains(e.to())) {
	    			fringe.insert(e.to(), (double)e.myEdgeInfo);
	    			double alt = (double)e.myEdgeInfo + priority;
		    		if (alt < lengths[e.to()]) {
		    			fringe.changePriority(e.to(), alt);
		    			lengths[e.to()] = alt;
    ...
    public static void main(String[] args) {
        ...
        System.out.println();
        System.out.println();
        System.out.println("Path exists: " + g3.pathExists(6, 5)); // false
        System.out.println("Path exists: " + g3.pathExists(6, 0)); // true
        ...
        System.out.println();
        System.out.println();
        System.out.println("Path exists: " + g4.pathExists(0, 4)); // false
        System.out.println("Path exists: " + g3.pathExists(0, 0)); // true
