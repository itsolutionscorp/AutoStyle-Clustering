...
public class ArrayHeap<T> {
	...
	/**
	 * Change the node in this heap with the given item to have the given
	 * priority and given predecessor item only if the given priority is 
	 * less than the existing priority.
	 */
	public void changePredAndPriority(T item, Object n, double priority) {
		Iterator<Node> iter = contents.iterator();
		int counter = 0;
		while(iter.hasNext()) {
			Node current = iter.next();
	...
	public class Node {
		...
		public void setPredecessor(Object n) {
			myPredecessor = n;
		}
