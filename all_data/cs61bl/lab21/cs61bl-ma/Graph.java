...
public class Graph implements Iterable<Integer>{
    ...
    public ArrayList<Integer> shortestPath (int startVertex, int endVertex){
        ...
        while (!fringe.isEmpty()) {
        	double runningTotal = fringe.peek().priority();
        	int smallest = fringe.removeMin().item();
        	if (smallest == endVertex) {
        		break;
        	}
        	for (Edge e : myAdjLists[smallest]) {
        		if (fringe.contains(e.myTo)) {
    				preds.put(e.myTo, e.myFrom);
        			int temp = (Integer) e.info();
        			if (temp + runningTotal < fringe.findNode(e.myTo).priority()) {
        				fringe.changePriority(e.myTo, temp+runningTotal);
        			}
        		}
        	}
        }
    ...
    public static void main(String[] args) {
       /* ArrayList<Integer> result;
        ...
        g3.addEdge(5, 3, 40);
        g3.addEdge(6, 0, 20); 
        ArrayList<Integer> path = g3.shortestPath(0, 7);
