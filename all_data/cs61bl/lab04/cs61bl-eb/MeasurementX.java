...
public class MeasurementX {
	...
	public boolean equals(MeasurementX m) { //this method is never accessed/used b/c argument must be called Object obj in order to be used (not Measurement) 
		// contains calls equals(Object obj) -- which is just arbitrary design 
		System.out.println("\tMeasurement equals called with Measurement argument");
		return this.toString().equals(m.toString()); // calls toString - cannot remove toString method
		// equals has a default toString method - default toString returns memory location  
	}
