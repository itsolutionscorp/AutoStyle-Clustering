public class Line3 {
    ...
    void printLength() {
        double length;
        length = Math.sqrt ( Math.pow((coords[0]-coords[2]), 2) + Math.pow((coords[1]-coords[3]), 2) ) ;
    ...
    public static void main(String[] args) {
        ...
        Line3 testline = new Line3();
        testline.coords = new int[4];
        testline.coords[0] = 5;
        testline.coords[1] = 10;
        testline.coords[2] = 45;
        testline.coords[3] = 40;
