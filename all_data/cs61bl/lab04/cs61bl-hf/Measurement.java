public class Measurement {
	...
	public Measurement plus(Measurement m2) {
		if (m2.inches + this.inches >= 12) {
			this.inches = this.inches + m2.inches - 12;
			this.feet = this.feet + m2.feet + 1;
		} else {
	...
	public Measurement minus(Measurement m2) {
		if (this.inches < m2.inches ) {
			this.inches = 12 + this.inches - m2.inches;
			this.feet = this.feet - m2.feet - 1;
		} else {
			this.feet = this.feet - m2.feet;
			this.inches = this.inches - m2.inches;
	...
	public Measurement multiple(int multipleAmount) {
		if (this.inches*multipleAmount >= 12) {
			this.feet = this.feet*multipleAmount + this.inches*multipleAmount/12;
			this.inches = this.inches*multipleAmount % 12;
			
		} else {
			this.inches = this.inches*multipleAmount;
			this.feet = this.feet*multipleAmount;
		}
		return new Measurement(this.feet, this.inches); // provided to allow the file to compile
	}
	...
	public String toString() {
		return Integer.toString(this.feet) + "'"+Integer.toString(this.inches) + '"';
	}
