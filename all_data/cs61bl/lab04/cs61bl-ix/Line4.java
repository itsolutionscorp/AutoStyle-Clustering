...
public class Line4 {
    ...
    Point[] points;
    //(this.coords[2]-this.coords[0])*(this.coords[2]-this.coords[0]))+
    //	((this.coords[3]-this.coords[1])*(this.coords[3]-this.coords[1])
    void printLength() {
        double length;
        length = Math.sqrt ( (this.points[1].x-this.points[0].x)*(this.points[1].x-this.points[0].x) + 
        		(this.points[1].y-this.points[0].y)*(this.points[1].y-this.points[0].y) );
