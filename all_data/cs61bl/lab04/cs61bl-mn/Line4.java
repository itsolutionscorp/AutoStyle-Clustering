...
public class Line4 {
    ...
    void printLength() {
        double length;
        length = Math.sqrt ((points[0].getX()-points[1].getX())*(points[0].getX()-points[1].getX())+(points[0].getY()-points[1].getY())*(points[0].getY()-points[1].getY()) ) ;
    ...
    public static void main(String[] args) {
		...
		myLine.points[0].setLocation(5, 10);
		myLine.points[1].setLocation(45,40);
		myLine.printLength();
		myLine.printAngle();
        /*
