public class Measurement {
	...
	public Measurement plus(Measurement m2) {
		int newFeet = m2.getFeet() + this.getFeet();
		int newInches = m2.getInches() + this.getInches();
		if (newInches >= 12) {
			newFeet++;
	...
	public Measurement minus(Measurement m2) {
		int newFeet = this.getFeet() - m2.getFeet();
		int newInches = this.getInches() - m2.getInches();
		if (newInches < 0) {
			newFeet--;
			newInches = newInches + 12;
		}
	...
	public Measurement multiple(int multipleAmount) {
		Measurement newMeasure = new Measurement(this.getFeet(), this.getInches());
		while (multipleAmount > 1) {
			newMeasure = newMeasure.plus(this);
			multipleAmount--;
		}
