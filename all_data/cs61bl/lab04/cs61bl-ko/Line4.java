...
public class Line4 {
    ...
    void printLength() {
        double length;
        length = Math.sqrt ((points[1].x - points[0].x)*(points[1].x - points[0].x) 
    ...
    public static void main(String[] args) {
        ...
        line.points[0] = new Point();
        line.points[1] = new Point();
        line.points[0].setLocation(5, 10);
        line.points[1].setLocation(45 ,40);
        line.printLength();
        line.printAngle();
    }
