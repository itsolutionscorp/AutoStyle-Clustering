public class Measurement {
	...
	public Measurement plus(Measurement m2) {
		...
		f = Math.floorDiv((b+d), 12);
		g = (b+d) % 12;
		
		return new Measurement(f,g); // provided to allow the file to compile
	}
	...
	public Measurement multiple(int multipleAmount) {
		...
		d = Math.floorDiv(c, 12);
		f = c % 12;
		
		return new Measurement(d,f); // provided to allow the file to compile
	}
