public class Line3 {
    ...
    public static void main(String[] args) {
		...
		/*
		 * Here you should set coords to contain a reference to a new line
		 * object. Initialize coords's x1 and y1 (elements 0 and 1 of coords) to
		 * the point (5, 10), and initialize coords's x2 and y2 (elements 2 and
