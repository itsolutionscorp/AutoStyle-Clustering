public class Measurement {
	...
	public Measurement plus(Measurement m2) {
		int x = (this.getFeet() * 12);
		int y = x + this.getInches();
		int a = (m2.getFeet() * 12);
		int b = a + m2.getInches();
		int z = y + b;
		return new Measurement(z/12, z%12); // provided to allow the file to compile
	}
