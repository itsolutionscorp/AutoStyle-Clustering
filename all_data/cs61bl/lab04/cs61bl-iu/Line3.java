public class Line3 {
    ...
    void printLength() {
        double length;
        length = Math.sqrt ((this.coords[2] - this.coords[0]) * (this.coords[2] - this.coords[0]) + (this.coords[3] - this.coords[1]) * (this.coords[3] - this.coords[1]));
        System.out.println ("Line length is " + length);
    }
    
    void printAngle() {
        double angleInDegrees = Math.atan2 ( this.coords[3] - this.coords[1] , this.coords[2] - this.coords[0] ) * 180.0 / Math.PI;
