public class Measurement {
	...
	public Measurement plus(Measurement m2) {
		int m3feet = this.myfeet + m2.myfeet;
		int m3inches = this.myinches + m2.myinches;
		Measurement m3 = new Measurement(m3feet, m3inches);
	...
	public Measurement multiple(int multipleAmount) {
		int m3feet = this.myfeet*multipleAmount;
		int m3inches = this.myinches*multipleAmount;
		Measurement m3 = new Measurement(m3feet, m3inches);
		return m3; // provided to allow the file to compile
	}
