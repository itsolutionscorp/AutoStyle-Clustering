...
/*public String toString() {
    ...
    public void delete(int deletePos) {
    	...
    	if (deletePos < 0 || deletePos >= size()) {
    		...
    		DListNode a = myHead;
    		if (deletePos <= size() - deletePos) {
    			for (int b = deletePos; b > 0; b--) {
    				a = a.myNext;
    			}
    		} else {
    			for (int b = deletePos; b < size(); b++) {
   					a = a.myPrev;
   				}
    		}
    			a.myPrev.myNext = a.myNext;
    			a.myNext.myPrev = a.myPrev;
    			if (myHead.myPrev.myNext != myHead.myNext.myPrev) {
