...
public class Sequence implements Iterable {
    ...
    private class SequenceIterator implements Iterator {
        ...
        public Object next() {
            ...
            return lastReturned.myItem;
        }

        // Removes the most recent item returned by next
        // Preconditon: next has been called at least once
        public void remove(){
        	lastReturned.myNext.myPrev = lastReturned.myPrev;
        	lastReturned.myPrev.myNext = lastReturned.myNext;
        	mySize--;
            // TODO Your code here 
        	
        }
        DListNode curr;
    	DListNode lastReturned;
    	boolean firstTimeCalled;
        // TODO Your code here
    }
