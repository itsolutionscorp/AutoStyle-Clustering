...
public class Sequence implements Iterable {
    ...
    public void delete(int deletePos) {
    	DListNode n = myHead;
    	for (int i = 0; i < deletePos; i++) n = n.myNext;
        if (deletePos == 0) myHead = n.myNext;
    	n.myNext.myPrev = n.myPrev;
    	n.myPrev.myNext = n.myNext;
    	if (mySize == 1) myHead = null;
    	mySize--;
    }
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < 10000000; i++) seq2.add(i);
        ...
        for (int i = 0; i < 10000000; i++) c.add(i);
