...
//    }
    ...
    public void delete(int deletePos) {
    	int c = 0;
    	DListNode newNode = myHead;
    	System.out.println(newNode.myPrev.myItem);
    	if (mySize == 1){
    		newNode.myNext = null;
    		newNode.myPrev = null;
    		mySize--;
    	...
    	for (; c != deletePos; newNode = newNode.myNext){
    		c++;
    	}
    	newNode.myPrev.myNext = newNode.myNext;
    	newNode.myNext.myPrev = newNode.myPrev;
    	if (deletePos == 0)
    		myHead = newNode.myNext;
    	mySize--;
    }
