    ...
    public void delete(int deletePos) {
        // TODO Your code here
    	 if (isEmpty()) {
             ...
             for(int i = 0; i < deletePos+1; i++){
            	 newNodes = newNodes.myNext;
             }
             // Link the new node into the list.
             newNode.myNext = newNode.myNext.myNext;
             newNodes.myPrev = newNode;
         }
         mySize--;
    }
