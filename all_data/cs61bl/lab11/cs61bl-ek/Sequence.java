...
//    }
    ...
    public void delete(int deletePos) {
    	...
    	DListNode pointing = myHead;
    	for (int i = 0; i < prev; i++) {
    		pointing = pointing.myNext;
    	}
    	pointing = new DListNode(pointing.myItem, pointing.myPrev, pointing.myNext.myNext);
    	pointing = pointing.myNext;
    	pointing = new DListNode(pointing.myItem, pointing.myPrev.myPrev, pointing.myNext);
    }
