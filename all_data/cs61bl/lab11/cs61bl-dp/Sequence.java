...
//    }
    ...
    public void delete(int deletePos) {
    	...
    	for (int i = 0; i <= deletePos; i++) {
    		if ((deletePos % mySize) == 0) {
        		myHead = myHead.myNext;
        		myHead.myPrev = curr.myPrev;
        		myHead.myPrev.myNext = myHead;
        		mySize --;
        		break;
        	}
    		if (i == deletePos) {
    			DListNode temp = curr.myPrev;
    			curr.myPrev.myNext = curr.myNext;
    			curr.myNext.myPrev = temp;
    			mySize --;
    			break;
    		}
    		curr = curr.myNext;
    ...
    private class SequenceIterator implements Iterator {
        ...
        public Object next() {
        	returnedfirstelement = true;
        	Object obj = curr.myItem;
        	pre = curr;
        	curr = curr.myNext;
            return obj;
        }
        ...
        public void remove(){
            curr.myPrev = pre.myPrev;
            pre.myPrev.myNext = curr;
            mySize --;
        }
        
        // TODO Your code here
    	DListNode curr, pre;
    	boolean returnedfirstelement;
    }
