...
/*
    ...
    */
    ...
    public void delete(int deletePos) {
    	mySize--;
        DListNode index = myHead;
        int counter = 0;
        if (deletePos == 0 && size() == 1) {
        	myHead = null;
        } else if (deletePos == 0) {
        	index.myPrev.myNext = index.myNext;
        	myHead = index.myNext;
        }
        ...
        index.myPrev.myNext = index.myNext;
        index.myNext.myPrev = index.myPrev;
    }
