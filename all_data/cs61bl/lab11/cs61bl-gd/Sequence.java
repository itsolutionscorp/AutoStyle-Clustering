...
public class Sequence implements Iterable {
   ...
   // }
    ...
    public void delete(int deletePos) {
    	...
    	DListNode ref= myHead;
    	for(index=0;index<deletePos;index++){
    		ref=ref.myNext;
    	}
    	DListNode copy=ref.myNext;
    	copy.myPrev=ref.myPrev;
    	ref.myPrev.myNext=copy;
    	ref.myNext=null;
    	ref.myPrev=null;
    	mySize--;}
    }
    ...
    private class SequenceIterator implements Iterator {
        ...
        public void remove(){
        	...
        	if(counter>1){
        		...
        		DListNode copy = current.myPrev;
        		current.myPrev=current.myPrev.myPrev;
        		current.myPrev.myNext=current;
        		copy.myNext=null;
        		copy.myPrev=null;
        		mySize--;
        	}
