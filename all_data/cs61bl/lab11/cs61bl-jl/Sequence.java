...
//    }
    ...
    public void delete(int deletePos) {
    	if(deletePos == 0) {
    		...
    		DListNode tempPre = temp.myPrev;
    		DListNode tempNext = temp.myNext;
    		tempPre.myNext = tempNext;
    		tempNext.myPrev = tempPre;
    	}
        mySize--;
    }
