...
public class Sequence implements Iterable {
    ...
    public void delete(int deletePos) {
    	...
    	if( deletePos < 0 || deletePos >= mySize)
    		throw new IllegalArgumentException("Invalid position for delete");
    	
    	// Deleting last/first element
    	...
    	tmp.myPrev.myNext = tmp.myNext;
    	tmp.myNext.myPrev = tmp.myPrev;
    ...
    private class SequenceIterator implements Iterator {
        ...
        public void remove(){
        	if(current.myPrev == myHead) {
        		myHead = myHead.myNext;
        	}
        	current.myPrev.myPrev.myNext = current;
