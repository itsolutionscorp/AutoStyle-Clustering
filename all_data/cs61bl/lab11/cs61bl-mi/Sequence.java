...
//    }
    ...
    public void delete(int deletePos) {
    	...
    	currNode.myNext.myPrev = currNode.myPrev;
    	currNode.myPrev.myNext = currNode.myNext;
    }
    ...
    private class SequenceIterator implements Iterator {
        ...
        public Object next() {
            // TODO Your code here 
        	DListNode toReturn = nextToReturn;
        	nextToReturn = toReturn.myNext;
        	counter++;
        	lastRemoved = toReturn;
            return toReturn.myItem;
        }
        ...
        private int counter;
        private DListNode lastRemoved;
        private DListNode nextToReturn;
    }
