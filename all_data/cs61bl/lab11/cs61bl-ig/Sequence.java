...
public class Sequence implements Iterable {
    ...
    public void delete(int deletePos) {
        ...
        DListNode prev = current.myPrev;
        DListNode next = current.myNext;
        prev.myNext = next;
        next.myPrev = prev;
        if(deletePos == 0) myHead = next;
        mySize--;
    }
    ...
    private class SequenceIterator implements Iterator {
        ...
        public boolean hasNext() {
        	if(current == myHead && usedFirst) return false;
        	return true;
        }
        ...
        public Object next() {
        	if(current == myHead) usedFirst = true;
            current = current.myNext;
