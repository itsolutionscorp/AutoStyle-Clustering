...
public class Sequence implements Iterable {
    ...
    */
    ...
    public void delete(int deletePos) {
        // TODO Your code here
		Iterator deleter = new SequenceIterator();
    ...
    private class SequenceIterator implements Iterator {
		...
		private DListNode prevNode = null;
		private DListNode curNode = myHead;
        ...
        public void remove(){
            // TODO Your code here 
        	if (initiated) {
        		prevNode.myItem = curNode.myItem;
        		prevNode.myNext = curNode.myNext;
        		mySize--;
        		cursor--;
        	}
        }
