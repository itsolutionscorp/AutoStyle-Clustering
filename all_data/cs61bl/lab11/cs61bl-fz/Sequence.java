...
//    }
    ...
    public void delete(int deletePos) {
        // TODO Your code here
    	DListNode removeThis = myHead;
    	if (deletePos == 0) {
    		myHead = myHead.myNext;
    	}
    	for(int i = 0; i < deletePos; i++) {
    		removeThis = removeThis.myNext;
    	}
    	removeThis.myPrev.myNext = removeThis.myNext;
    	removeThis.myNext.myPrev = removeThis.myPrev;
    	removeThis.myNext = null;
    	removeThis.myPrev = null;
    	removeThis.myItem = null;
    	mySize--;
    }
    ...
    private class SequenceIterator implements Iterator {
        ...
        public boolean hasNext() {
            // TODO Your code here
        	boolean result = (returnedFirstItem == false && pos.myNext != null);
            return result;
        }
        ...
        public void remove(){
            // TODO Your code here 
        	DListNode removeThis = pos.myPrev;
        	removeThis.myPrev.myNext = removeThis.myNext;
        	removeThis.myNext.myPrev = removeThis.myPrev;
        	removeThis.myPrev = null;
        	removeThis.myNext = null;
