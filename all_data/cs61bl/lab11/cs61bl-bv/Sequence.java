...
public class Sequence implements Iterable {
    ...
    public void delete(int deletePos) {
    	...
    	if (deletePos < 0 || deletePos >= mySize) {
    		...
    		curr.myNext.myPrev = curr.myPrev;
    		mySize--;
    	}
    }
    ...
    private class SequenceIterator implements Iterator {
        ...
        public void remove() {
            // TODO Your code here 
        	if (curr_node == 0) {
        		System.out.println("Next hasn't been called at least once yet.");
        	} else {
        		curr.myPrev.myPrev.myNext = curr;
        		curr.myPrev = curr.myPrev.myPrev;
        	}
        }
