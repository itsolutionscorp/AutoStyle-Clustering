...
//    }
    ...
    public void delete(int deletePos) {
    	DListNode temp = this.myHead;
    	if(deletePos == 0 && this.size() == 1){
    		this.myHead.myItem = null;
    		this.mySize -= 1;
    		return;
    	}else if(deletePos == 0){
    		temp.myNext.myPrev = this.myHead.myPrev;
    		this.myHead.myPrev.myNext = temp.myNext;
...
//         code for the Iterator methods.
    ...
    private class SequenceIterator implements Iterator {
        ...
        public void remove(){
        	if(temp.myPrev == myHead){
        		temp.myPrev.myPrev.myNext = temp;
