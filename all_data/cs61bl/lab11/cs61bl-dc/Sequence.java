...
//		return result + "]";
		...
		while (i.hasNext())
			result += ((DListNode)i.next()).myItem.toString() + " ";
	...
	private class SequenceIterator implements Iterator
	{
		...
		{
			return node != myHead || !returnedFirstItem;
		}
		...
		public void remove()
		{
			if (returnedFirstItem)
			{
				node.myPrev = node.myPrev.myPrev;
				node.myPrev.myPrev.myNext = node;
				mySize--;
			}
		}
	}
