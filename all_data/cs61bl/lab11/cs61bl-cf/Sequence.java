...
//    }
    ...
    public void delete(int deletePos) {
        // TODO Your code here
    	DListNode toRemove = myHead;
    	
    	for (int i = 0; i < deletePos; i++) {
    		toRemove = toRemove.myNext;
    	}
    	...
    	toRemove.myPrev.myNext = toRemove.myNext;
    	toRemove.myNext.myPrev = toRemove.myPrev;
    	mySize --;
    }
    // check this later
...
//          System.out.println("in while");
    ...
    private class SequenceIterator implements Iterator {
        ...
        public void remove(){
            // TODO Your code here 
        	DListNode lastNode = currentNode.myPrev;
        	lastNode.myPrev.myNext = lastNode.myNext;
        	lastNode.myNext.myPrev = lastNode.myPrev;
        	mySize --;
        }
