...
//    }
    ...
    public void delete(int deletePos) {
    	...
    	if (myHead == pointer)
    		myHead = pointer.myNext;
    	pointer.myPrev.myNext = pointer.myNext;
    	pointer.myNext.myPrev = pointer.myPrev;
    	mySize--;
    }
    ...
    private class SequenceIterator implements Iterator {
        ...
        public void remove(){
            // TODO Your code here
        	returned.myPrev.myNext = returned.myNext;
        	returned.myNext.myPrev = returned.myPrev;
