...
public class Sequence implements Iterable {
    ...
    public void addToSequence(Object toAdd) {
        if (isEmpty()) {
            ...
            //myHead.myPrev.myPrev.myNext = myHead.myPrev;
        }
        mySize++;
    }
    ...
    public void delete(int deletePos) {
        int counter = 0;
        DListNode currentPos = this.myHead;
        while (counter < deletePos){
        	currentPos = currentPos.myNext;
        	counter++;
        }
        if (counter == 0){
        	myHead = currentPos.myNext;
        }
        currentPos.myPrev.myNext = currentPos.myNext;
        currentPos.myNext.myPrev = currentPos.myPrev;
        currentPos.myPrev = null;
        currentPos.myNext = null;
        mySize--;
    }
    ...
    private class SequenceIterator implements Iterator {
        ...
        public boolean hasNext() {
            if (started && currentNode.myNext == myHead){
            	return false;
            }else if (mySize == 0){
            	return false;
            }
        ...
        public void remove(){
            DListNode temp = currentNode.myPrev;
        	temp.myPrev.myNext = currentNode;
            currentNode.myPrev = temp.myPrev;
            temp.myNext = null;
            temp.myPrev = null;
        }
