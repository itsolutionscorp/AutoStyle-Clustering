...
public class Sequence implements Iterable {
	...
	/*
	 * public String toString() { if (isEmpty()) { return "[  ]"; } String
	 * result = "[  " + myHead.myItem.toString() + "  "; for (DListNode current
	 * = myHead.myNext; current != myHead; current = current.myNext) { result =
	 * result + current.myItem.toString() + "    "; } return result + "]"; }
	 */
