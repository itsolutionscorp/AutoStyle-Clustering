public class Date {
    ...
    public void isOK() {
        ...
        if (myMonth < 1 ||myMonth > 12 ) {
        	throw new IllegalStateException("Value of month must be between 1 and 12.");
        }
        if (myDateInMonth < 1 || myDateInMonth > 31 ) {
        	throw new IllegalStateException("Day of month must be between 1 and 31.");
        }
        if ((myMonth == 4 || myMonth == 6 || myMonth == 9 || myMonth == 11) && (myDateInMonth > 30)) {
        	throw new IllegalStateException( "This month has 30 days.");        	
        }
        if (myMonth == 2 && leapDay == true && myDateInMonth > 29) {
        	throw new IllegalStateException("This month has 29 days.");
        }
        if (myMonth == 2 && leapDay == false && myDateInMonth > 28) {
        	throw new IllegalStateException("This month has 28 days.");
        }
    }
}
