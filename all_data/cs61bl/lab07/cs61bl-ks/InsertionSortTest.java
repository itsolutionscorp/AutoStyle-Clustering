...
public class InsertionSortTest {
    ...
    public void isOK2() {
        ...
        InsertionSort.isOK(arr,0); // should be okay
   ...
   @Test
    public void insert2() {
// the earlier test doesn't include the last number... i< arr.length-1 doesnt include last number when i++ increments
	   
        int[] arr = {1, 3, 5, 3,5,7,10,9};
    ...
    public void insertionSort2() {
        ...
        int[] arr = { 1,3,6,1,3,2,5,123,12,14};
        int[] result = InsertionSort.insertionSort(arr);
        int[] check = {1,1,2,3,3,5,6,12,14,123};
        assertEquals(Arrays.toString(result), Arrays.toString(check));
