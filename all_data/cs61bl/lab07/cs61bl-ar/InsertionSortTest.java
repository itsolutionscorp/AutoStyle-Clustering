...
public class InsertionSortTest {
    ...
    public void insert2() {
        ...
        // YOUR CODE HERE
    	int[] arr = {1};
    	InsertionSort.insert(arr, 0);//Should work for single-element array
    	InsertionSort.isOK(arr, 1);
    	
    	int[] arr2 = {1, 1, 1};
    	InsertionSort.insert(arr2, 2);//Should work for same-element array.
    	InsertionSort.isOK(arr2, 3);
    	
    	int[] arr3 = {1, 2, 3};
    	exception.expect(Exception.class);
    	InsertionSort.insert(arr3, 4);//maximum index exceeded!
    	
    	exception.expect(Exception.class);
    	InsertionSort.insert(arr3, -1);//Invalid k
    ...
    public void insertionSort2() {
        ...
        // YOUR CODE HERE
    	int[] arr = {1, 2, 1, 3, 2, 1, 3, 3};
    	int[] result = InsertionSort.insertionSort(arr);
    	int[] check = {1, 1, 1, 2, 2, 3, 3, 3};  //check for repeated element
