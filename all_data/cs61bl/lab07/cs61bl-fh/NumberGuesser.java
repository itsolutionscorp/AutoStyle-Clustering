...
public class NumberGuesser {
    ...
    public static void main (String [ ] args) throws Exception {
        ...
        high = 20;                          // #2
        guess = (low+high)/2;               // #3
        System.out.println ("Is your number " + guess + "? (Type y or n.)");  //The first time it asks if number is 10, it will interpret
        answer = keyboard.readLine ( );                                       // anthing that is no "y" as "n", but this does not affect
        while (!answer.equals("y")) {                                         //but this doesn't affect the functionality
