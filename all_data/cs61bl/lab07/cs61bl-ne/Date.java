public class Date {
	...
	public void isOK() {
		...
		} else if (myMonth > 12 || myMonth < 0) {
			
			throw new IllegalStateException("Month must be between 0 and 12");
		} else if (myDateInMonth < 0 || myDateInMonth > monthLengths[myMonth-1]) {
			
			throw new IllegalStateException("Days must be between 0 and " + monthLengths[myMonth]);
		}
	}
}
