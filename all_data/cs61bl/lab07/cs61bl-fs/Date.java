public class Date {
    ...
    public void isOK() {
        ...
        if (myYear < 1900 || myYear > 2100){
        	throw new IllegalStateException("Year out of bounds");
        }
        if(myMonth < 1 || myMonth > 12){
        	throw new IllegalStateException("Month out of bounds");
        }
        if(myMonth == 2){
        	if (leapDay == true){
        		if(myDateInMonth < 1 || myDateInMonth > 29){
        			throw new IllegalStateException("Day out of bounds");
        		}
        	}else if(myDateInMonth < 1 || myDateInMonth > 28){
        		throw new IllegalStateException("Day out of bounds");
        	}
