public class Date {
    ...
    public void isOK() {
        ...
        if (myYear < 1900 || myYear > 2100 || myMonth < 1 || myMonth > 12) {
        	throw new IllegalStateException("Inputted year and/or month is/are not legal.");
        }
        if (myMonth != 2 && myMonth != 4 && myMonth != 6 && myMonth != 9 && myMonth != 11) {
        	if (myDateInMonth < 1 || myDateInMonth > 31) {
        		throw new IllegalStateException("Inputted date is not legal.");
        	}
        }
        if (myMonth == 2 && leapDay == true) {
