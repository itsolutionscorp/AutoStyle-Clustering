...
public class InsertionSortTest {
    ...
    public void isOK2() {
        ...
        // This isOK call should return nothing because the array is 
        // non-decreasing up through the element at index 3.
        InsertionSort.isOK(arr, 3);
        
        // This isOK call should throw an exception because the element
        // at index 4 makes the array up through that index out of order.
        exception.expect(IllegalStateException.class);
        InsertionSort.isOK(arr, 4);
        
        // This isOK call should throw an exception because the element
        // argument lower than 0 is not a valid one.
        exception.expect(IllegalStateException.class);
        InsertionSort.isOK(arr, -2);
        
        // This isOK call should throw an exception because the element
        // argument greater than the maximum index of 4 is not a valid one.
        exception.expect(IllegalStateException.class);
