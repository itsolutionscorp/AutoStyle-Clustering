	...
	public void isOK() {
		...
		if (myMonth == 1 || myMonth == 3 || myMonth == 5 || myMonth == 7
			...
			if (myDateInMonth < 1 || myDateInMonth > 31) {
				throw new IllegalStateException("there is at most 31 days");
			}
		} else if (myMonth == 4 || myMonth == 6 || myMonth == 9
				|| myMonth == 11) {
			if (myDateInMonth < 1 || myDateInMonth > 30) {
				throw new IllegalStateException("there is at most 30 days");
			}
		} else { // myMonth must be 2
			if (myDateInMonth < 1
					|| myDateInMonth > 28 + (leapDay == true ? 1 : 0)) {
				throw new IllegalStateException("This is February");
			}
		}
		// YOUR CODE HERE
	}
