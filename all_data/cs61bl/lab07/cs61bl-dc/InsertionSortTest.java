...
public class InsertionSortTest
{
	...
	public void insert2()
	{
		int[] list = {1, 2, 4, 3, 1, 5, 7};
		int[] check = {1, 1, 2, 3, 4, 5, 7};
		for (int i = 2; i < 5; i++)
			InsertionSort.insert(list, i);
		assertEquals(Arrays.toString(list), Arrays.toString(check));
	}
	...
	{
		int[] list = {3, 1, 2};
		int[] result = InsertionSort.insertionSort(list);
		int[] check = {1, 2, 3};
