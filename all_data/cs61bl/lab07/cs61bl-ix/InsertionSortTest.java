...
public class InsertionSortTest {
   ...
   @Test
    public void insert2() {
    	int[] arr1 = {1, 2, 3, 4, 5, 0, 3};
    	
        // YOUR CODE HERE
    	InsertionSort.insert(arr1, 5);
    	
    	assertEquals(arr1[0], 0);
    	InsertionSort.insert(arr1, 6);
    	for (int i = 0;i<arr1.length;i++){
    		System.out.println(arr1[i]);
    	}
    	
    	assertEquals(arr1[3], 3);
    	assertEquals(arr1[4], 3);
    ...
    public void insertionSort2() {
    	int[] arr = {0,1,2,1,5,4,2,2};
        int[] result = InsertionSort.insertionSort(arr);
        int[] check = {0,1,1,2,2,2,4,5};
