...
public class InsertionSortTest {
    ...
    public void isOK2() {
        ...
        // YOUR CODE HERE
    	int[] arr = {1, 1, 2, 4, 2};
    	// This isOK call should return nothing
    	InsertionSort.isOK(arr, 1); 
    	// This isOK call should return an exception
    	exception.expect(IllegalStateException.class);
    ...
    public void insert1() {
        ...
        assertEquals(Arrays.toString(check), Arrays.toString(arr));
    }
    ...
    public void insertionSort2() {
        ...
        // YOUR CODE HERE
    	int[] arr = {7, 9, 6, 5, 4, 8, 9, 10, 11};
        int[] result = InsertionSort.insertionSort(arr);
        int[] check = {4, 5, 6, 7, 8, 9, 9, 10, 11};
