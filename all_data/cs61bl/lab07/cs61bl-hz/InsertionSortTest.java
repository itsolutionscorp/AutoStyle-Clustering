...
public class InsertionSortTest {
    ...
    public void isOK2() {
        ...
        // YOUR CODE HERE
    	int[] arr = {1, 2, 2, 3, 1};
    	InsertionSort.isOK(arr, 3); // should work because in order up to index 3
    	
    	exception.expect(IllegalStateException.class);
    	InsertionSort.isOK(arr, 4); // should break at index 4 b/c 1 < 3
    ...
    public void insertionSort2() {
        ...
        // YOUR CODE HERE
    	int[] arr = {5, 4, 2, 2, 2, 100, 69, 42, 7};
    	int[] result = InsertionSort.insertionSort(arr);
    	int[] check = {2, 2, 2, 4, 5, 7, 42, 69, 100};
