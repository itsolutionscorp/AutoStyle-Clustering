...
public class Date {
    ...
    public void isOK() {
        ...
        if(myYear < 1900 || myYear > 2100 || myMonth < 0 || myMonth > 12){
        	throw new IllegalStateException();
        }
        if( ((myMonth == 1 || myMonth == 3 || myMonth == 5 || myMonth == 7 || myMonth == 8 || myMonth == 10 || myMonth == 12) 
        	&& (myDateInMonth < 0 || myDateInMonth > 31)) || 
        	((myMonth == 4 || myMonth == 6 || myMonth == 9 || myMonth == 11) 
        	&& (myDateInMonth < 0 || myDateInMonth > 30)) ||
        	(myMonth == 2 && leapDay && (myDateInMonth < 0 || myDateInMonth > 29 )) ||
        	(myMonth == 2 && !leapDay && (myDateInMonth < 0 || myDateInMonth > 28 ))
        	){
        	System.out.println("day issue");
        	throw new IllegalStateException();
        }
