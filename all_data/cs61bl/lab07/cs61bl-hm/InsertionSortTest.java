...
public class InsertionSortTest {
    ...
    public void isOK2() {
        ...
        //Should return nothing since this is completely sorted. 
        InsertionSort.isOK(arr, 6);
        
        //Tests edge case
        arr = new int[]{1, 2, 3, 4, 5, 6, 0};
        exception.expect(IllegalStateException.class);
        InsertionSort.isOK(arr, 6);
        
        //Tests other things in the middle as well. 
        arr = new int[]{1, 2, 3, 8, 6, 6, 0, 7};
        exception.expect(IllegalStateException.class);
        InsertionSort.isOK(arr, 6);
    }
    ...
    public void insertionSort2() {
        ...
        arr = new int[] {10, 9, 3, 7, 6, 5, 4, 3, 3, 2, 1};
        result = InsertionSort.insertionSort(arr);
        check = new int[] {1, 2, 3, 3, 3, 4, 5, 6, 7, 9, 10};
        assertEquals(Arrays.toString(result), Arrays.toString(check));
    }
