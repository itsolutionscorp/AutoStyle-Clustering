...
public class ResizableIntSequenceTest {
	...
	public void testAdd(){
		...
		//assertTrue (s.myValues[3] == 5);
		//assertTrue (s.myValues[4] == 0);
	}
	...
	public void testInsert(){
		//test the case add at the last number
		...
		assertTrue (s.myValues[0] == 1);
		assertTrue (s.myValues[1] == 100);
		assertTrue (s.myCount ==4);
		
		s  = new ResizableIntSequence(3);
		s.add(1);
		s.add(2);
		s.add(3);
		s.insert(100, 1);
		...
		assertTrue (s.myValues[0] == 1);
		assertTrue (s.myValues[6] == 100);
		assertTrue (s.myCount ==7);
