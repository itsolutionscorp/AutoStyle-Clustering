...
public class TracedPoint extends Point {
    ...
    public void move(int x, int y) {
    	double old_point_x = this.getX();
    	double old_point_y = this.getY();
    	super.move(x, y);
    	System.out.println( "point moved from (" + (int) old_point_x + "," + (int) old_point_y + 
    			") to (" + (int) this.getX() + "," + (int) this.getY() + ")" );
    }
