...
//	}
	...
	public static void countingSort(int[] arr) {
	 ...
	 public static void MSDRadixSortFromDigitInBounds(int[] arr, int digit,
		 ...
		 int mostDigits = mostDigitsIn(arr);
		 if (digit == 0) {
			 return;
		 }
		 for (; mostDigits/digit > 0; digit *= 10) {
...
//			}
			...
			for (int i = end - 1; i >= 0; i--) {
		        sorted[counts[ (arr[i] / digit) % 10 ] - 1] = arr[i];
		        counts[(arr[i] / digit) % 10 ]--;
		    }
