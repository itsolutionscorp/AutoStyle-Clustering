...
public class BinaryTree<T> implements Iterable<T> {
    ...
    private TreeNode initHelper(ArrayList<T> preorder, ArrayList<T> inorder) {
    	if (preorder.isEmpty() && inorder.isEmpty()) {
    		...
    		ArrayList<T> left1 = new ArrayList<T>(preorder.subList(1, index+1));
    		ArrayList<T> left2 = new ArrayList<T>(inorder.subList(0, index));
    		ArrayList<T> right1 = new ArrayList<T>(preorder.subList(index+1, preorder.size()));
    		ArrayList<T> right2 = new ArrayList<T>(inorder.subList(index+1, inorder.size()));
    		TreeNode left = initHelper(left1, left2);
    		TreeNode right = initHelper(right1, right2);
    ...
    public static void main(String[] args) {
        ...
        a2.add("F");
        a2.add("C");
        BinaryTree<String> u = new BinaryTree<String>(a1, a2);
        print(u, "please");
    }
