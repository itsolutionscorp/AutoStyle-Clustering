...
public class BinaryTree<T> implements Iterable<T> {
   ...
   public BinaryTree(ArrayList<T> a, ArrayList<T> b) {
	   myRoot = null;
	   for (T q: a) {
		   myRoot = insert(myRoot, q, b);  
	   }
   }

   
 private TreeNode insert(TreeNode t, T key, ArrayList<T> b) {
       if (t == null) {
           return new TreeNode(key);
       } else if (b.indexOf(t.myItem) < b.indexOf(key)) {
           t.myRight = insert(t.myRight, key,  b);
           return t;
       } else {
           t.myLeft = insert(t.myLeft, key, b );
           return t;
       }
   }
    ...
    public static void main(String[] args) {
        ...
        b.add("F");
        b.add("C");
        BinaryTree<String> p = new BinaryTree(a,b);
        print(p, "myTree");
    }
