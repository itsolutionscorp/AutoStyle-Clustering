...
public class BinaryTree<T> implements Iterable<T> {
    ...
    public BinaryTree(ArrayList<T> preorder, ArrayList<T> inorder){
    	...
    	ArrayList<T> newpreleft = new ArrayList<T>();
    	ArrayList<T> newinleft = new ArrayList<T>();
    	ArrayList<T> newpreright = new ArrayList<T>();
    	ArrayList<T> newinright = new ArrayList<T>();
    	for(int i = 0; i<inorder.indexOf(preorder.get(0)); i++){
    		newpreleft.add(preorder.get(i+1));
    		newinleft.add(inorder.get(i));
    	}
    	for(int i = inorder.indexOf(preorder.get(0))+1; i<inorder.size(); i++){
    		newpreright.add(preorder.get(i));
    		newinright.add(inorder.get(i));
    	}
    	myRoot.myLeft = new BinaryTree<T>(newpreleft, newinleft).myRoot;
    	myRoot.myRight = new BinaryTree<T>(newpreright, newinright).myRoot;
    	}
    }
...
//        print(r, "sample tree 2");
        ...
        d.add("F");
        d.add("C");
        BinaryTree<String> a = new BinaryTree<String>(c, d);
        print(a, "test");
    }
