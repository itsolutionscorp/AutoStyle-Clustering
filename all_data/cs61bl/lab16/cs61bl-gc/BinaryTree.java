...
public class BinaryTree<T> implements Iterable<T> {
    ...
    public BinaryTree(ArrayList<T> preorder, ArrayList<T> inorder) {
    	...
    	BinaryTreeHelper(myRoot, preorder, inorder);
    }
    
    private void BinaryTreeHelper(TreeNode t, List<T> preorder, List<T> inorder) {
    	...
    	// left side
    	List<T> inLeft = inorder.subList(0, i);
    	List<T> inRight = inorder.subList(i + 1, inorder.size());
    	if(inLeft.size()>0)
    		t.myLeft =  new TreeNode(null);
    	if(inRight.size()>0)
    		t.myRight = new TreeNode(null);
    	List<T> preLeft = preorder.subList(1, 1 + inLeft.size());
    	List<T> preRight = preorder.subList(1 + inLeft.size(), preorder.size());

    	BinaryTreeHelper(t.myLeft,preLeft,inLeft);
    	// right side
    	BinaryTreeHelper(t.myRight,preRight,inRight);
    ...
    public static void main(String[] args) {
        ...
        in.add("F");
        in.add("C");
        BinaryTree<String> b = new BinaryTree<String>(pre,in);
        b.printInorder();
        b.printPreorder();
    }
