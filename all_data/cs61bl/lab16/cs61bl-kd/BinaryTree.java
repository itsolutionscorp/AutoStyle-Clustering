...
public class BinaryTree<T> implements Iterable<T> {
    ...
    public TreeNode help(List<T> pre, List<T> in) {
    	if (in.isEmpty()) {
    		return null;
    	}
    	else {
    		int k = 0;
    		while (k < pre.size()) {
    			if (in.contains(pre.get(k))) {
    				break;
    			}
    			k++;
    		}
    		T entry = pre.get(k);
    		TreeNode left = help(pre , in.subList(0, in.indexOf(entry)));
    		TreeNode right = help(pre , in.subList(in.indexOf(entry)+1, in.size()));
    		return new TreeNode(entry, left, right);
    	}
    }
    ...
    public static void main(String[] args) {
        ...
        in1.add("F");
        in1.add("C");
        BinaryTree<String> testTree = new BinaryTree<String>(pre1, in1);
        print(testTree, "letters");
    }
