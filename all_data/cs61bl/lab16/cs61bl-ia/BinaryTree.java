...
public class BinaryTree<T> implements Iterable<T> {
    ...
    private TreeNode add (TreeNode t, int index, ArrayList preorder, ArrayList inorder){
    	if (t == null){
    		return new TreeNode ((T) preorder.get(index));
    	}
    	if (inorder.indexOf(preorder.get(index)) < inorder.indexOf(t.myItem)){
    		t.myLeft = add (t.myLeft, index, preorder, inorder);
    	} else {
    		t.myRight = add(t.myRight, index, preorder, inorder);
    	}
		return t;
    }
