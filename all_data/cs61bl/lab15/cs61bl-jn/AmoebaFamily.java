...
public class AmoebaFamily implements Iterable<AmoebaFamily.Amoeba> {
	...
	public void prettyHelper(Amoeba child, String tabs){
		System.out.println(tabs+child.myName);
		tabs+="    ";
	...
	public class AmoebaIterator implements Iterator<Amoeba> {
		...
		private ArrayDeque<Amoeba> fringe = new ArrayDeque<Amoeba>();
	...
	public static class Amoeba {
		...
		public String longestName(){
			...
			for (Amoeba a : myChildren) {
				if(maxSeen.length() < a.longestName().length()){
					maxSeen=a.longestName();
				}
			}
			return maxSeen;
