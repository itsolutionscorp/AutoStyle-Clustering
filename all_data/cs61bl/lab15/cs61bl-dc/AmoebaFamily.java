...
public class AmoebaFamily implements Iterable<AmoebaFamily.Amoeba>
{
	...
	{
		return new AmoebaQueueIterator();
	}
	
	public Iterator<Amoeba> depthIterator()
	{
	...
	public class AmoebaQueueIterator implements Iterator
	{
		private LinkedList<Amoeba> queue;
		
		public AmoebaQueueIterator()
		{
	...
	public static class Amoeba
	{
		...
		private void makeNameLowercase()
		{
		...
		private String longestName()
		{
			...
			for (Amoeba a : myChildren)
			{
				String longName = a.longestName();
				if (longestName.length() < longName.length())
