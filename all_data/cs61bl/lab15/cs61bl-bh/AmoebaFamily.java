...
public class AmoebaFamily implements Iterable<AmoebaFamily.Amoeba>{
	...
	public static void main(String[] args) {
		...
		family.print();
		Iterator<Amoeba> aIter = family.iterator();
		while (aIter.hasNext()) {
			System.out.println(aIter.next().myName);
		}
	}
	...
	public static class Amoeba {
        ...
        public void print(int n) {
        	System.out.println(printHelper(n) + myName);
        	for (Amoeba a: myChildren) {
        		a.print(n+1);
        	}
        }
        ...
        public String longestName() {
        	...
        	for (Amoeba a : myChildren) {
        		...
        		if (check.length() > longestSoFar.length()) {
        			longestSoFar = check;
        		}
        	}
        	return longestSoFar;
