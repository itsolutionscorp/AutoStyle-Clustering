...
public class AmoebaFamily implements Iterable<AmoebaFamily.Amoeba>{
	...
	public void makeNamesLowercase() {
		...
		if(myRoot != null) myRoot.makeNamesLowercase();
	...
	public void replaceName(String currentName, String newName) {
		// Your goal is to make this as similar as possible to addChild
		if (myRoot != null) myRoot.replaceName(currentName, newName);
	}
	...
	public static void main(String[] args) {
		...
		Iterator<Amoeba> p = family.iterator(); 
		while(p.hasNext()) System.out.println(p.next().myName);
	}
	...
	public class AmoebaIterator implements Iterator<Amoeba> {
		...
		// You will supply the details of this class in a future lab.a
//		private Queue<Amoeba> fringe = new LinkedList<Amoeba>();
//
//		public AmoebaIterator() {
//			if (myRoot != null) fringe.add(myRoot);
//		}
//
...
//		        for(Amoeba a: node.myChildren) fringe.add(a);
//		    }
//		    return node;
//		}
		...
		public Amoeba next() {
		    ...
		    if (node.myChildren != null) {
		        for(int i = node.myChildren.size() - 1; i >= 0; i--){
		        	Amoeba a = node.myChildren.get(i);
		        	fringe.push(a);
		        }
		    }
		    return node;
...
//		}
        ...
        public void print(){
        	System.out.println(myName);
        	for (Amoeba a: myChildren){
        		for (int i = 0; i < a.depth -1 ; i++) System.out.print("    ");
        		a.print();
        	}
        }
