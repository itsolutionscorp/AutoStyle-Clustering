...
public class AmoebaFamily implements Iterable<AmoebaFamily.Amoeba>{
	...
	public class AmoebaIterator implements Iterator<Amoeba> {
		...
		/*private LinkedList fringe = new LinkedList();
		...
		public Amoeba next() {
			...
			Amoeba a = (Amoeba) fringe.removeLast();
		...
		private LinkedList fringe1 = new LinkedList();
		private LinkedList fringe2 = new LinkedList();
		private int which_fringe = 1;
		...
		public boolean hasNext() {
			return !fringe1.isEmpty() || !fringe2.isEmpty();
		}
		...
		public Amoeba next() {
			...
			if (which_fringe == 1) {
				if (!fringe1.isEmpty()) {
					Amoeba a = (Amoeba) fringe1.removeFirst();
					...
					which_fringe = 2;
					Amoeba a = (Amoeba) fringe2.removeFirst();
					for (Amoeba child : a.myChildren) {
						fringe1.add(child);
					}
					return a;
