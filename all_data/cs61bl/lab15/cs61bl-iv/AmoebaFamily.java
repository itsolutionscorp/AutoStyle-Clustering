...
//	} // end of AmoebaIterator nested class
	...
	public static class Amoeba {
        ...
        public void print() {
        	...
        	for (Amoeba a : myChildren) {
        		result += a.printHelper(1);
        	}
        	System.out.println(result);
        }
        
        public String printHelper(int generation) {
        	...
        	result += this.myName;
        	for (Amoeba a : myChildren) {
        		result += a.printHelper(generation+1);
        	}
        	return result;
    	...
    	public String longestName() {
    		...
    		for (Amoeba a : myChildren) {
    			if (a.longestName().length() > longName.length()) {
