...
public class AmoebaFamily implements Iterable<AmoebaFamily.Amoeba>{
	...
	public void replaceName(String currentName, String newName) {
		...
		if (myRoot != null) {
			myRoot.helperReplaceName(currentName, newName);
		}
	}
	...
	public String longestName() {
		...
		// longestNameLength
		if (myRoot != null) {
			return myRoot.helperLongestName();
		}
		return "";
	}
...
//			}
//			Amoeba a = (Amoeba) ball.pop();
//			for (int i = a.myChildren.size() -1; i >= 0; i--){
//				ball.push(a.myChildren.get(i));
//			}
//			return a;
//		}
//
...
//	} // end of AmoebaIterator nested class
	...
	public class AmoebaIterator implements Iterator<Amoeba> {
		...
		public Amoeba next() {
			...
			Amoeba a = (Amoeba) ball.remove();
			for (int i = 0; i < a.myChildren.size(); i++){
				ball.add(a.myChildren.get(i));
			}
			return a;
		}
	...
	public static class Amoeba {
        ...
        public void helperReplaceName(String currentName, String newName) {
        	if (myName.equals(currentName)) {
                myName = newName;
                return;
            } else {
            	for (Amoeba a : myChildren) {
                 a.helperReplaceName(currentName, newName);
            	}
            }
        }
        
        public void helperPrintFlat(){
    		for(Amoeba a: myChildren){
		...
		public String helperLongestName() {
//			int l = this.longestNameLength();
//			String s = "";
//			if (myName.length() == 7){
//				return myName;	
//			}
//			for (Amoeba a : myChildren){
//				myName = a.helperLongestName();
//			}
//			return myName;
			String s = myName;
			for (Amoeba a : myChildren){
				if (s.length() < a.helperLongestName().length())
					s = a.helperLongestName();
			}
			return s;
		}

		public int helperSize(int c) {
