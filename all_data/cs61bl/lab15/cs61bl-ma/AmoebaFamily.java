	...
	*/
	...
	public static class Amoeba {
        ...
        public String longestName() {
        	...
        	for (Amoeba a: myChildren) {
        		String longestChildName = a.longestName(); 
        		if (myName.length() < longestChildName.length()) {
        			longestName = longestChildName; 
        		}
        	}
        	return longestName;
        }
      ...
      //In Amoeba
        private int height() {
            if (myChildren.isEmpty()) {
                ...
                int maxChildren = myChildren.get(0).height(); 
                for (Amoeba a : myChildren) {
                    maxChildren = Math.max(a.height(), maxChildren);
                }
