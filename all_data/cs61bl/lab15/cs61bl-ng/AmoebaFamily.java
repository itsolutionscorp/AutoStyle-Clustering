	...
	public class AmoebaIterator implements Iterator<Amoeba> {
		...
		public Amoeba next() {
			...
			if (node.myChildren != null) {
				for (int n = node.myChildren.size() - 1; n >= 0; n--) {
					fringe.push(node.myChildren.get(n));
				}
			}
			return node;
		}
...
//			if (node.myChildren != null) {
//				Iterator i = node.myChildren.iterator();
//				while(i.hasNext()){
//					fringe.add(i.next());
//				}
//			}
...
//
	...
	public static class Amoeba {
		...
		// makes its own name lower case and make it's child lower case
		public void makeNamesLowercase() {
		...
		// Replaces the name of an amoeba named currentName with the name
		// newName.
		// Precondition: the amoeba family contains exactly one amoeba named
		// currentName.
		public void replaceName(String currentName, String newName) {
