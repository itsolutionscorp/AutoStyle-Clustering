...
//		private Stack<Amoeba> s = new Stack();
		private LinkedList<Amoeba> l = new LinkedList<Amoeba>();
...
//		    return node;
	...
	public static class Amoeba {
        ...
        public String longestName() {
        	...
        	for (Amoeba a : myChildren) {
                if (a.myName.length() > longest.length()) {
                	longest = a.myName;
                }
                String s = a.longestName();
        ...
        public void prettyPrint(int i) {
        	...
        	msg += new String(myName);
        	System.out.println(msg);
        	if (myChildren.size() == 0) {
        		return;
        	} else {
        		 for (Amoeba child: myChildren) {
 	            	child.prettyPrint(i + 4);
 	            }
        	}
        }
