...
public class AmoebaFamily implements Iterable<AmoebaFamily.Amoeba>{
	...
	public static class Amoeba {
        ...
        public int checkNames(String currentName){
        	int amoebaNames = 0;
        	if (myName.equals(currentName)) {
                amoebaNames++;
            } else {
                for (Amoeba a : myChildren) {
                    return a.checkNames(currentName);
                }
            }
        	return amoebaNames;
        }
        ...
        public void print(int generation){
        	myName = count(generation) + myName;
        	System.out.println(myName);
        	for (Amoeba a : myChildren){
        		a.print(generation + 1);
        	}
        	
        }
        
        public String count(int generation){
        	String str= "";
