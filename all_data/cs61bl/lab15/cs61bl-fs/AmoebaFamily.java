...
public class AmoebaFamily implements Iterable<AmoebaFamily.Amoeba>{
	...
	public class AmoebaIterator implements Iterator<Amoeba> {
		...
		public Queue<Amoeba> fringe = new LinkedList();
		...
		public Amoeba next() {
			if (!hasNext()) {
				throw new NoSuchElementException("amoeba fam outta elems");
			}
	...
	public static class Amoeba {
        ...
        public String longestName() {
        	...
        	for (Amoeba a : myChildren) {
        		if (longestSeen.length() < a.longestName().length()) {
        			longestSeen = a.longestName();
        		}
        	}
        	return longestSeen;
        }
        ...
        public void printHelper(int indents) {
