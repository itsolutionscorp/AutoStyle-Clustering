...
public class AmoebaFamily implements Iterable<AmoebaFamily.Amoeba>{
	...
	public void printFlat() {
		// Your goal is to make this as similar as possible to addChild
		if (myRoot != null) {
			System.out.print(myRoot.myName + " ");
			myRoot.printFlat();
		}
	}
...
//		private Stack<Amoeba> fringe;
		private LinkedList<Amoeba> fringe;
...
//		}
		...
		public Amoeba next() {
			if (hasNext()) {
				Amoeba root = fringe.poll();
				for (int i = 0; i <root.myChildren.size(); i++) {
					fringe.add(root.myChildren.get(i));
				}
				return root;
			}
			return null;
...
//			if (hasNext()) {
//				Amoeba root = fringe.pop();
//				for (int i = root.myChildren.size() -1; i >= 0; i--) {
//					fringe.push(root.myChildren.get(i));
//				}
//				return root;
//			}
//			return null;
//		}
	...
	public static class Amoeba {
        ...
        public static void printHelper(Amoeba root, int indent) {
        	for (Amoeba a: root.myChildren) {
        		...
        		printHelper(a, indent + 1);
        	}
        }
        
    	public String longestName() {
    		int temp = longestNameLength();
    		longestNameHelper(temp);
    		return longestName;
    	}
    	
    	
    	
    	public void longestNameHelper(int maxLength) {
    		for (Amoeba a : myChildren) {
    			if (a.myName.length() == maxLength) {
    				longestName = a.myName;
    			}
    			a.longestNameHelper(maxLength);
    		}
    	}
