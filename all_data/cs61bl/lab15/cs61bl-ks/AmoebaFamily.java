...
public class AmoebaFamily implements Iterable<AmoebaFamily.Amoeba>{
	...
	/* public class AmoebaIterator implements Iterator<Amoeba> {
		...
		private Stack<Amoeba> myFringe = new Stack<Amoeba>();
		Set<Amoeba> seen = new HashSet();
		public AmoebaIterator() {
			if (myRoot != null){
				myFringe.push(myRoot);
			}
		}

		public boolean hasNext() {
			return !myFringe.empty();
		}
	...
	public static class Amoeba {
        ...
        public void printHelper(int indent2){
        	String spaces = "";
        ...
        public String longestName(int len) {
        	if (myName.length() == len) {
        		return myName;
        	}
        	
        	for (Amoeba a : myChildren) {
        		return a.longestName(len);
        	}
        	return "";
        }
