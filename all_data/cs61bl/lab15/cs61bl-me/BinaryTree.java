...
public class BinaryTree {
    ...
    private void isOK(TreeNode t) throws IllegalStateException {
    	if (alreadySeen.contains(t)) {
    		throw new IllegalStateException("contains used value");
    	} else {
    		alreadySeen.add(t);
    		if (t.myRight != null) {
    			isOK(t.myRight);
    ...
    private TreeNode exprTreeHelper(String expr) {
        if (expr.charAt(0) != '(') {
        	if (Character.isDigit(expr.charAt(0))) {
        		return new TreeNode(Character.getNumericValue(expr.charAt(0)));
        	}
            ...
            for (int k = 1; k < expr.length() - 1; k++) {
            	...
            	if (nesting < 0) {
            		throw new IllegalArgumentException("Bad # of parentheses.");
            	}
    ...
    private static class TreeNode {
        ...
        private void optimize() {
        	...
        	System.out.println(myItem.getClass());
        	if (!(myItem instanceof String)) {
        		return;
        	}
        	myLeft.optimize();
        	myRight.optimize();
        	if (!(myLeft.myItem instanceof String) && !(myRight.myItem instanceof String)) {
        		Object leftvar = myLeft.myItem;
        		Object rightvar = myRight.myItem;
        		if ((leftvar instanceof Integer) && (rightvar instanceof Integer)) {
        			String myChar = (String) myItem;
        			if (myChar.equals("+")) {
        				myItem = (int) leftvar + (int) rightvar;
        			} if (myChar.equals("*")) {
        				myItem = (int) leftvar * (int) rightvar;
        			}
        			myLeft = null;
