...
//				for (int x = a.myChildren.size() - 1; x>= 0; x--) {
//					fringe.push(a.myChildren.get(x));
//				}
//			}
//		    return a;
//		}
	...
	public static class Amoeba {
        ...
        public void print() {
        	System.out.println(myName);
        	for (Amoeba a : myChildren) {
        		for (int i = 0; i < howManyIndents(a); i++) {
        			System.out.print("    ");
        		}
        		a.print();
        	}
        ...
        public int howManyIndents(Amoeba a) {
        	int count = 0;
        ...
        public String longestName() {
        	...
        	for (Amoeba a : myChildren) {
        		if (a.longestName().length() > longestSeen.length()) {
