...
public class AmoebaFamily implements Iterable<AmoebaFamily.Amoeba>{
	...
	public static void main(String[] args) {
		...
		Iterator<Amoeba> run = family.iterator();
		while (run.hasNext()){
			System.out.println(run.next().myName);
		}
		//family.print();
		//System.out.println(family.height());
		//family.makeNamesLowercase();
		//System.out.println(family.myRoot.myName);
		//System.out.println(family.myRoot.myChildren.get(0).myName);
	...
	public static class Amoeba {
		...
		public int size() {      
			int currentsize = 1;
			for (Amoeba a : myChildren) {
				currentsize = currentsize+a.size();
			}
			return currentsize;
		}
