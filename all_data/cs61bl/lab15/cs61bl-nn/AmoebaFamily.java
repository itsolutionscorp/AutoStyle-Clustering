...
//			Stack<Amoeba> helpStack = new Stack<Amoeba>();
//			for (Amoeba child : current.myChildren){
//				helpStack.push(child);
//			}
//			while (helpStack.size() != 0){
//				fringe.push(helpStack.pop());
//			}
//			return current;
//		}
//		
...
//	} // end of AmoebaIterator nested class
	...
	public class AmoebaIterator implements Iterator<Amoeba> {
		...
		public Amoeba next() {
			Amoeba current = fringe.removeFirst();
			for (Amoeba child : current.myChildren){
				fringe.add(child);
			}
			return current;
