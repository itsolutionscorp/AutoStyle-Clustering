...
public class AmoebaFamily implements Iterable<AmoebaFamily.Amoeba>{
	...
	public class AmoebaIterator implements Iterator<Amoeba> {
		...
		public Amoeba next() {
			if (!hasNext()) {
				throw new NoSuchElementException("Amoeba family ran out of members");
			}
			Amoeba toReturn = fringe.remove();
			if (toReturn.myChildren.size() != 0) {
				for (Amoeba i: toReturn.myChildren) {
					fringe.add(i);
				}
			}
			return toReturn;
	...
	public static class Amoeba {
        ...
        public void printPretty(String space) {
        	System.out.println(space + myName);
        	for (Amoeba a : myChildren) {
                a.printPretty(space + "    ");
        	}
        }
        ...
        public String longestName() {
            ...
            for (Amoeba a : myChildren) {
            	String childLongest = a.longestName();
            	if (longestName.length() < childLongest.length()) {
