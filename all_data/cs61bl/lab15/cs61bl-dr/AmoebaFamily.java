...
public class AmoebaFamily implements Iterable<AmoebaFamily.Amoeba>{
	...
	public String busiest(){
		if (myRoot != null){
			return myRoot.busiest().toString();
		}
		return "";
	}
	...
	public class AmoebaIterator implements Iterator<Amoeba> {
		...
		public Amoeba next() {
			if (!hasNext()){
				throw new NoSuchElementException("Amoeba family ran out of Amoebas");
			}			
	...
	public static class Amoeba {
        ...
        public Amoeba busiest(){
        	Amoeba busiest = this;
        	for(Amoeba a: myChildren){
        		if (a.busiest().myChildren.size() > busiest.myChildren.size()) 
        			busiest = a;
        	}
        	return busiest;
        }
      // Bug was that bestSoFar keeps adding 1 every time it sets
        private int height() {
