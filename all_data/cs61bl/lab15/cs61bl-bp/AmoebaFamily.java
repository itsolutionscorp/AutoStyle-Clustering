...
public class AmoebaFamily implements Iterable<AmoebaFamily.Amoeba> {
	...
	public void print() {
		prettyPrintHelper(myRoot, 0);
	}

	// helper method
	private static void prettyPrintHelper(Amoeba ay, int indent) {
		for (int i = 0; i < indent; i++) {
			System.out.print('\t');
		}
		System.out.println(ay.myName);
		for (Amoeba a : ay.myChildren) {
			prettyPrintHelper(a, indent + 1);
		}
	}
