...
//			}
	...
	public static class Amoeba {
		...
		public void makeNamesLowerCase() {
			...
			myName = myName.toLowerCase(); //use the default char method
        ...
        public String longestName() {
            String maxLength = myName;
            for (Amoeba a : myChildren) {
                if (maxLength.length() < a.longestName().length())
                	maxLength = a.longestName();
            }
            return maxLength;
        }
