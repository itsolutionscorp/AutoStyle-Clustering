...
public class AmoebaFamily implements Iterable<AmoebaFamily.Amoeba>{
    ...
    public static void main(String[] args) {
        ...
        family.print();
     	...
     	Iterator<Amoeba> a = family.iterator();
     	while (a.hasNext()) {
     		Amoeba next = a.next();
     		System.out.println(next.myName);
     	}
    }
    ...
    public class AmoebaIterator implements Iterator<Amoeba> {
        ...
        public Amoeba next() {
            if (!hasNext()) {
            	throw new NoSuchElementException("no more amoebae");
            } 
            Amoeba rtnAmoeba = queue.pop();
            for (int i=0; i<rtnAmoeba.myChildren.size(); i++) {
            	queue.add(rtnAmoeba.myChildren.get(i));
            }
            return rtnAmoeba;
    ...
    public static class Amoeba {
        ...
        private void printhelper(int indent) {
        ...
        public String longestName() {
            ...
            for (Amoeba a: myChildren) {
                if (longestName.length() < a.longestName().length()) {
        ...
        public Amoeba busiest() {
            Amoeba busy = this;
            int busyChildren = myChildren.size();
            for (Amoeba a: myChildren) {
                if (busyChildren<a.busiest().myChildren.size()) {
                    busy = a.busiest();
                }
            }
            return busy;
