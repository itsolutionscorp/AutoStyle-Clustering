...
public class AmoebaFamily implements Iterable<AmoebaFamily.Amoeba>{
	...
	public class AmoebaIterator implements Iterator<Amoeba> {
		...
		private Queue archive = new LinkedList();
		...
		public Amoeba next() {
			Amoeba node = (Amoeba) archive.remove();
		...
		public void remove() {
			// Not used for now -- removal from a tree can dbe difficult.
	...
	public static class Amoeba {
        ...
        public String longestName(){
        	...
        	for (Amoeba a : myChildren){
        		if(a.longestName().length()>result.length()){
        			result = a.longestName();
        		}
        	}
        	return result;
        }
        public static void printHelper(Amoeba a, String space) {
        	System.out.println(space+a.myName);
        	for(Amoeba child: a.myChildren){
        		printHelper(child, space+"    ");
        	}
        }
