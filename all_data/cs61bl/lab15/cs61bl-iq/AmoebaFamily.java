...
public class AmoebaFamily implements Iterable<AmoebaFamily.Amoeba>{
	...
	public static class Amoeba {
        ...
        public void print(int numOfIndentations) {
        	System.out.println(printHelper(numOfIndentations) + myName);
    		for (Amoeba a : myChildren) {
    			a.print(numOfIndentations + 1);
    		}
    	}
        
        public String printHelper(int numOfIndentations) {
        	String indentations = "";
        	int counter = numOfIndentations * 4;
        	while (counter > 0) {
        		indentations += " ";
        		counter--;
        	}
        ...
        public int size() {
        	int amoebaCounter = 1;
        	for (Amoeba a : myChildren) {
        		amoebaCounter += a.size();
        	}
        	return amoebaCounter;
        }
