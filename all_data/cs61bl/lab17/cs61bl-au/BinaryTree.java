...
public class BinaryTree<T extends Comparable<T>> implements Iterable<T> {
    ...
    public T kthLargest (int k){
    	return myRoot.kthLargestHelper(k);
    }
    ...
    public static void main(String[] args) {
        ...
        r.add("g");
        print(r, "sample tree 2");
        BinaryTree<Integer> f = new BinaryTree<>();
        f.myRoot = f.new TreeNode(10);
        f.add(19);
        f.add(5);
        f.add(11);
        print(f, "test");
...
//        a.printPreorder();
    ...
    protected class TreeNode {
        ...
        private void printPreorder() {
            System.out.print("(" + myItem + " s: " + sizeOfNode + " )");
            if (myLeft != null) {
        ...
        private T kthLargestHelper(int k){
        	if (sizeOfNode == 3) {
        		System.out.println("-----1-----");
        		if (k == 2) return myRight.myItem;
        		else if (k == 1) return myItem;
        		else return myLeft.myItem;
        	}
        	if (sizeOfNode == 2) {
        		...
        		if (k == 1) {
        			...
        			if (myLeft != null) {
                        ...
                        System.out.println(myLeft.myItem);
        				return myLeft.myItem;
        			}
        			else {
        			...
        			if (myLeft != null) return myItem;
        			else return myRight.myItem;
        		}
        	}
        	if (sizeOfNode == 1) return myItem;
        	if (k == myRight.sizeOfNode) return myItem;
        	if (k < myRight.sizeOfNode) return myRight.kthLargestHelper(k);
        	else return myLeft.kthLargestHelper(k - myRight.sizeOfNode - 1);
        }
    }
}