...
public class MyTreeMap<K extends Comparable<K>, V> {
	...
	public V put(K key, V value) {
		size++;
		KVPair rtn = myTree.put(new KVPair(key, value));
		if (rtn != null) {
			return rtn.value;
		}
		return null;
	...
	public V remove(K key) {
		KVPair rtn = myTree.remove(new KVPair(key, null));
		if (rtn != null) {
			return rtn.value;
		}
		return null;
	 ...
	 */
	public V get(K key) {
		KVPair rtn = myTree.get(new KVPair(key, null));
		if (rtn != null) {
			return rtn.value;
		}
		return null;
	...
	private class KVPair implements Comparable<KVPair> {
		...
		public int compareTo(KVPair kv) {
