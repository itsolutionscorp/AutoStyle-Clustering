...
//        preorder.add("b");
//        preorder.add("c");
//        List<String> inorder = null;
//        inorder.add("c");
//        inorder.add("a");
//        inorder.add("b");
//        BinaryTree<String> madetree = new BinaryTree(preorder,inorder);
//        print(madetree, "the madetree");
//    }
    ...
    protected class TreeNode {
        ...
        public TreeNode makeTree(TreeNode t, List<T> preorder,List<T> inorder) {
        	...
        	if (preorder.get(indexPreorder) == inorder.get(posInorder-1)) {
        		...
        		indexPreorder++;
        		return makeTree(t.myLeft, preorder, inorder);
        	}
