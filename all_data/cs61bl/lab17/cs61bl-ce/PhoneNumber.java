public class PhoneNumber implements Comparable<PhoneNumber>{
	...
	public int compareTo(PhoneNumber otherNumber) {
		int myNumber = Integer.parseInt(this.number);
		int otherNumberVal = Integer.parseInt(otherNumber.number);
		if (myNumber > otherNumberVal) {
			return 1;
		} else if (myNumber == otherNumberVal) {
			return 0;
		}
		return -1;
	}
