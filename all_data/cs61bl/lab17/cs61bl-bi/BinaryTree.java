...
public class BinaryTree<T> implements Iterable<T> {
    ...
    protected class TreeNode {
        ...
        public TreeNode(T item, TreeNode left, TreeNode right) {
            ...
            myLeft = left;
            myRight = right;
            reSize(item, left, right);
        }

        public void reSize(T item, TreeNode left, TreeNode right) {
        ...
        private void printInorder() {
            ...
            System.out.print(myItem + " " + "size" + size + " ");
            if (myRight != null) {
        ...
        public String toString() {
        	return "Node(" + myItem + ", " + size + ", " + (myLeft == null ? "null": myLeft.toString()) + ", " + (myRight == null ? "null": myRight.toString()) + ")";
        }
