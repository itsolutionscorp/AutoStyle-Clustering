...
public class BinaryTree<T> implements Iterable<T> {
    ...
    public static BinarySearchTree<String> fillSampleTree3() {
    	...
    	t.myRoot = t.new TreeNode("J", t.new TreeNode("D", t.new TreeNode("B", null, null), t.new TreeNode("E", null, null)), t.new TreeNode("L", t.new TreeNode("K", null, null), t.new TreeNode("U", null, null)));
    	return t;
    }
...
//        System.out.println(q.kthLargest(7));
...
//        print(yggdrasil, "The Tree of Life");
		...
		tm.put("Paladin","Uther");
		tm.put("Hunter","Rexxar");
		tm.put("Mage","Jaina");
		tm.put("Shaman","Thrall");
		tm.put("Priest","Anduin");
		tm.put("Warrior","Garrosh");
		tm.put("Rogue","Valeera");
		tm.put("Warlock","Gul\'dan");
		tm.put("Druid","Malfurion");
		print(tm.groot, "Hearthstone Tree");
		System.out.println(tm.get("Priest"));
		System.out.println(tm.put("Paladin", "Justice Demands Retribution!"));
		print(tm.groot, "Hearthstone Tree");
		tm.remove("Warlock");
		print(tm.groot, "Hearthstone Tree");
    }
