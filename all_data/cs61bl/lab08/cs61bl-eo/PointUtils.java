...
public class PointUtils {
	...
	public static Point highestPoint(List<Point> points) {
		...
		Iterator <Point> call = points.iterator();
		if (points == null) {
			return null;
		} else {
		Point highest = null;
	...
	public static Point centroid(List<Point> points) {
		...
		if (pointIterator.hasNext() == false) {
			return null;
		} else {
		double addedX = 0;
		double addedY = 0;
		...
		double centerX = addedX / points.size();
		double centerY = addedY/ points.size();
