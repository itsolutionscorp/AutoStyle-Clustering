...
public class PointUtils {
	...
	public static Point highestPoint(List<Point> points) {
		...
		Point largestY = pointIterator.next();
		while(pointIterator.hasNext()){
			Point nextPoint = pointIterator.next();
			if(largestY.y < nextPoint.y){
				largestY = nextPoint;
			}
		}
	...
	public static Point centroid(List<Point> points) {
		...
		int count = 1;
		int averageX = firstPoint.x;
		int averageY = firstPoint.y;
		while (pointIterator.hasNext()) {
			Point nextPoint = pointIterator.next();
			averageX = averageX + nextPoint.x;
			averageY = averageY + nextPoint.y;
			count++;
		}
