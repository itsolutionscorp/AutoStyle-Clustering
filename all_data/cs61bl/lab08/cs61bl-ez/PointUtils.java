...
public class PointUtils {
	...
	public static Point highestPoint(List<Point> points) {
		...
		Point myPoint = pointIterator.next();
		highest = myPoint;

		yVal = myPoint.getY();

		while (pointIterator.hasNext()) {
			myPoint = pointIterator.next();
			if (yVal < myPoint.getY()) {
				yVal = myPoint.getY();
				highest = myPoint;
			}
		}
	...
	public static Point centroid(List<Point> points) {
		...
		yVal = (int) myPoint.getY();
		xVal = (int) myPoint.getX();

		while (pointIterator.hasNext()) {
			count++;
			myPoint = pointIterator.next();
			yVal = (int) (myPoint.getY() + yVal);
			xVal = (int) (myPoint.getX() + xVal);
		}
		return new Point(xVal/count,yVal/count);
	}
