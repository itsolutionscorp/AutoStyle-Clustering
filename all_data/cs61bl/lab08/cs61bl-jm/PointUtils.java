...
public class PointUtils {
	...
	public static Point highestPoint(List<Point> points) {
		...
		Point highest2 = pointIterator.next();
		while (pointIterator.hasNext()) {
			Point sub = pointIterator.next();
			if (sub.getY() > highest2.getY()) {
				highest2 = sub;
			}
		}
	...
	public static Point centroid(List<Point> points) {
		...
		int centroidy = 0;
		while (pointIterator.hasNext()) {
			Point self = pointIterator.next();
			centroidx += self.getX();
			centroidy += self.getY();
			divisor++;
		}
		return new Point(centroidx/divisor, centroidy/divisor);
	}
