...
public class PointUtils {
	...
	public static Point highestPoint(List<Point> points) {
		...
		Point highestPoint = pointIterator.next();
		while (pointIterator.hasNext()) {
			Point thisPoint = pointIterator.next();
			if (thisPoint.getY() > highestPoint.getY()) {
	...
	public static Point centroid(List<Point> points) {
		...
		while (pointIterator.hasNext()) {
			Point thisPoint = pointIterator.next();
			xValueSum += thisPoint.getX();
			yValueSum += thisPoint.getY();
			pointCount++;
		}
		
		averageX = xValueSum / pointCount;
		averageY = yValueSum / pointCount;
