public class Debug {
	...
	public static void main(String[] args) {
		...
		check("abcde", "defg"); // should be false
		check("abdce", "abcd"); // should be false
		check( "", "abc"); // should be false
		check("a", ""); // should be true
		check("abcdef", ""); // should be false
		check("abc", "abc"); // should be false
		check("234", "23"); // should be true
		check("abc$", "abc"); // should be true
		check("abcde", "bcde"); // should be true
		check("abdce", "abce"); // should be true
		check("a b c", "ab c"); // should be true
		String a = new String("lmnopqrs");
		String b = new String("lmnoqrs");
		check(a, b); //should be true
		check("@!#f314☺", "@!#f314"); // should be true
		check("@!#☺f314", "@!#f314"); // should be true
		check("' d'", "' d"); //should be true
