public class Debug {
	...
	public static void main(String[] args) {
		...
		check("3e42ggggg", "3e42"); // should be false
		check("abc","abc2"); // should be false
		check("a", "b"); //should be false
		check("lance", "ance"); //should be true
		check("bear" , "ear"); //should be true
		check("pair" , "par"); //should be true
		check("peeks" , "keep"); //should be false
		check("lances" , "ance"); //should be false
	}
