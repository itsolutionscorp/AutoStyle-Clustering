public class Debug {
	...
	public static void main(String[] args) {
		...
		check("make", "maker"); // should be true
		check("maker", "make"); // should be true
		check(" ", "");//should be true
		check("2", "");//should be true
		check("sa 'ed ", "sa"); // be false
		check("Ya'mannn","Ya'man"); // should be false;
		check("player","playe"); //should be false;
		check("player","Playe");
		check("checker", "checke"); //should be true;
		check("(($$", "(($");//should be true;
		check("play ", "play");//should be true;
		//check(null,"nul");this creates nullPointException error :) 
