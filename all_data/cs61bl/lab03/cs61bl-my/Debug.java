public class Debug {
	...
	public static void main(String[] args) {
		...
		check("abc34", "abc"); // should be false
		check("adfb", "adbb");// should be false
		check("12bs", "sd8");// should be false
		check("hsdf", "hsdfff");// should be false
		check("1aa", "aa");// should be true
