public class Debug {
	...
	public static void main(String[] args) {
		...
		check("ab", ""); // should be false
		
		check("2abc", "abc"); // should be true
		check("2abc", "3abc"); // should be false
		check("2abc", "abd"); // should be false
		check("2abc", "abcde"); // should be false
		check("2abc", "ab"); // should be false
		
		check("ab2c", "abc"); // should be true
		check("ab2c", "ab3c"); // should be false
		check("ab2c", "abd");  //should be false
		//check("ab2c", "abcd"); // should be false
		
		check("abc2", "abc"); // should be true
		check("abc2", "abc3"); // should be false
		check("abc2", "abd"); // should be false
		//check("abc2", "abcd"); // should be false
