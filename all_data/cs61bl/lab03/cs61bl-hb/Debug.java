public class Debug {
	...
	public static void main(String[] args) {
		/* Fails when string 
		 *has a character passed in to beginning or end of string
		 */

		/* Passes when string has an appended character on the end
		*/  

		check("abc", "def"); // should be false
		check("abc2", "abc"); // should be true
		check("good", "goo");//should be true 
		check("a2bc", "abc");//should be true *FAIL*
		check("2abc", "abc");//should be true *FAIL*
		check("a", null);//should be true?*FAIL*
