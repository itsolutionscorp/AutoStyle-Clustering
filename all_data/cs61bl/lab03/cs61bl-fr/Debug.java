public class Debug {
	...
	public boolean contains1MoreThan(String s) {
		if (myString.length() == 0) {System.out.println("myString has length 0, returning false");
			return false;
		} else if (s.length() == 0) {
	...
	public static void main(String[] args) {
		...
		check("abbc", "abc"); // should be true
		check("babc", "abc"); // should be true
		check("", ""); // should be false
		check("a", ""); // should be true
		try
		{
			check(null, null); // should be false
		}
