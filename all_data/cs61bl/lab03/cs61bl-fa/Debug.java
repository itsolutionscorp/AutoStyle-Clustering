public class Debug {
	...
	public static void main(String[] args) {
		check("saabc", "abc"); // should be false
		check("abc2", "abc"); // should be true
		check("a", ""); //true
		check("javas", "java"); //true
		check("", ""); //false
		check("abc", "def"); //false
		check("javssa", "java"); //false
		check("", "d"); //false
		check("javsa", "java"); //false but should be true
		check("sjava", "java"); //false but should be true
