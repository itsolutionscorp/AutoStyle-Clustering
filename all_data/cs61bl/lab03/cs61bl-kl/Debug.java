public class Debug {
	...
	public static void main(String[] args) {
		check("abc", "def"); // should be false returns false
		check("abc2", "abc"); // should be true
		check("a2bc", "abc"); //should be true but returns false
		check("2abc", "abc"); //should be true but returns false
		check("a",""); //should be true and it does return false  
		check("a2bc3d", "abcd"); //should be false returns false
		check("",""); //should be false returns false
		check("12b", "b");
