public class Debug {
	...
	public static void main(String[] args) {
		...
		check("", "def");  //false
		check("", "");    //false
		check("abc", "deffae");	//false
		check("abcsse", "def");	//false
		check("abc", "defa");	//false
		check("1234", "123");	//true
		check("4123", "123"); //true
		check("1243", "123"); // should be true
		check("123", "1234"); 
		check("FIES", "fie"); 
		check("fieS", "fie");
	//	check("2345", 234);
		check("sssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssss", "sssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssss");
	}
