...
//			System.out.println("myString: " + myString.charAt(0));
...
//			System.out.println(s);
	...
	public static void main(String[] args) {
		...
		check("hello", ""); // should be false
		check("h", ""); // should be true
		check("", "hello"); // should be false
		check("abdc", "abc"); // should be true
		check("dabc", "abc"); // should be true
		check("deabc", "abc"); // should be false
		check("abdec", "abc"); // should be false
...
//		System.out.println(string1.equals(string2.substring(1)));
