public class Debug {
	...
	public static void main(String[] args) {
		...
		check("wabc", "abc"); //should be true be true but is not
		check("ab5cdef", "abcdef"); // should be true but is not
		check("abcdefr", "abcdef"); // should be true
		check("hellooo","hello");// should be false
		check("hi", "h"); // should be true
		check("bye", "byi"); // should be false
		check("k", "k"); // should be false
		check("123","");
