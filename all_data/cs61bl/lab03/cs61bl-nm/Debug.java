public class Debug {
	...
	public static void main(String[] args) {
		...
		//Added tests
		check("acbd", "abc"); //should be false; returned false
		check("dabc", "abc"); //should be true; returned false
		check("abdc", "abc"); //should be true; returned false
		check("abcde", "abc"); //should be false; returned false
		check("  c", "  "); //should be true; return true
		check("a!", "a"); //should be true; return true
	}
