public class Debug {
	...
	public static void main(String[] args) {
		...
		check("bhgs", "bhg"); // should be true
		check("x", ""); //should be true
		check("sbhg", "bhg"); //should be true
		check("bhsg", "bhg"); //should be true
		check("as", "s");
		
		
		check("", null); //should be false
		check("x", null); //should be true
		check(null, "x"); //should be false
	}
