public class Debug {
	...
	public static void main(String[] args) {
		...
		check("abdc", "abc");// should be true but returns false
		check("abc", "ac");// should be true but returns false
		check("ba", "a");// should be true but returns false
		check("ab", "a");// returns true
		check("abcde", "abc");// returns false
		check(null, "a");// crashes
