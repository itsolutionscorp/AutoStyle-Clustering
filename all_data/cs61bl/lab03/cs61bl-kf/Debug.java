public class Debug {
	...
	public static void main(String[] args) {
		...
		//more tests
		check("abcde", "de"); //should be false
		check("abc", "abc"); //should be false
		check("abcdke", "abce"); //should be false
		check("def", "ef");//should be true but says false
		check("efg", "ef");//should be true
		check("abcdef", "bcdef");//should be true but says true
		check("abc", "ac");//should be true but says false
	}
