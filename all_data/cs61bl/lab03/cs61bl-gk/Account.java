...
public class Account {
	...
	public boolean withdraw(int amount) {
		if (amount < 0) {
			...
			if (this.myparentAccount == null) {
				...
				int withdrawfromparent = amount - this.balance();
				if (this.myparentAccount.withdraw(withdrawfromparent) == true) {
	...
	public void merge (Account anotherAcct) {
		int otherAcctbalance = anotherAcct.balance();
	    anotherAcct.withdraw(anotherAcct.balance());
		this.deposit(otherAcctbalance);
	}
