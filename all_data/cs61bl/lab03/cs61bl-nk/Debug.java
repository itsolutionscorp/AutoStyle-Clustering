public class Debug {
	...
	public static void main(String[] args) {
		...
		check("a2bc", "abc"); // should be true, incorrect false
		check("2abc", "abc"); // should be true, incorrect false
		check("abc", "adc"); // should be false, correct
		check("ab2c", "abc"); // should be true, incorrect false
		check("abc", "abc"); // should be false, correct
		check("ab2c", "ab2d"); // should be false, correct
		check("efgh4", "fgh4"); // should be true, incorrect.
		// check(22, 2); // will not execute
	}
