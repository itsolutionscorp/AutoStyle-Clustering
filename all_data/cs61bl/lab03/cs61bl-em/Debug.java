public class Debug {
	...
	public static void main(String[] args) {
		...
		check("dabc", "abc"); // should be true, but comes out false!
		check("adbc", "abc"); // should be true, but comes out false!
		check("abdc", "abc"); //should be true, but comes out false!
		check("abcd", "abc"); // should be true
		check("defabc", "def"); //should be false
