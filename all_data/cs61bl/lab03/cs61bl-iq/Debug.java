public class Debug {
	...
	public static void main(String[] args) {
		check("abc", "def"); // should be false, gives us false
		check("aaa", "aaa"); //should be false, gives us false
		check("abc2", "abc"); // should be true, gives us true
		check("a2bc", "abc"); //should be true, gives us false
		check("2abc", "abc"); //should be true, gives us false
		check("2abc3", "abc"); //should be false, gives us false
	}
