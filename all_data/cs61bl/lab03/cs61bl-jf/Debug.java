public class Debug {
	...
	public static void main(String[] args) {
		...
		check("2a", "a"); // should be true
		check("2bc", "abc"); // should be false
		check("acbc", "abc"); // should be true
		check("abb", "abc"); //should be false
		//check ( 112, 1123 );  //this will crash the program
	}
