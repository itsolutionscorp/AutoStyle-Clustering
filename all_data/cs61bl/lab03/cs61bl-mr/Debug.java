public class Debug {
	...
	public static void main(String[] args) {
		...
		check("a2", "a");// should be true, returns true
		check("a2b", "ab");//should be true, returns false
		check("2a", "a");//should be true, returns false
		check("bb", "bb");//should be false, returns false
		check("zaa","a");//should be false, returns false
