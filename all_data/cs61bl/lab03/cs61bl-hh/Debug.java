public class Debug {
	...
	public static void main(String[] args) {
		...
		check("abc123", "abc"); // should be false
		check("abc123", "abc12"); // should be true
		check("", "1"); // false
		check("1", ""); // true
		check("!@#$", "!@#"); // true
		check("☺♥", "♥"); // false, should be true
		check("AABC", "aab"); // false, should be true
		check("aab", "aab"); // false
		check("aab ", "aab"); // true\
		check("abcd", "cba"); // false, should be true
		check("aabc", "abc");
	}
