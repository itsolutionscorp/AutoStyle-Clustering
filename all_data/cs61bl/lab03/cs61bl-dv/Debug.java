public class Debug {
	...
	public static void main(String[] args) {
		...
		check("nancy2chang", "nancychang"); // should be true;
		check("nancychang", "nancydrew"); // should be false;
		check("n1an3cy", "nancy"); // should be false;
		check("ab", ""); // should be false
		check("abcd", "acde"); // should be false
		check("accde", "acde"); // should be true
	}
