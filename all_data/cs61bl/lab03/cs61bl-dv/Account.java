...
public class Account {
	...
	public Account(int initialBalance, Account overdraftAccount) {
		this.myBalance = initialBalance;
		this.parentAccount = overdraftAccount;
	}
	...
	/**
	 * Merge account "anotherAcct" into this one by removing all 
	 * the money from anotherAcct and adding that amount to this one.
	 */
