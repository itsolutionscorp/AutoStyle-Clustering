public class Debug {
	...
	public static void main(String[] args) {
		...
		check ("astring", "string"); //should be true
		check ("abigstring", "string"); //should be false
		check("abd", "abc"); // should be true
		check("dba", "aba"); // should be true
		check("abc", "adc"); // should be true
		check("abcdef", "abcdefg"); // should be true
		check("abcdef", "abcdefgh"); // should be false
		check ("cadr", "car"); //should be true
		check ("caar", "car"); //should be true
		check("!dog", "dog"); // should be true
		check("dog!", "dog"); // should be true
		check("dog", "dog"); // should be true
		check("123", "456"); // should be false
	}
