public class Debug {
	...
	public static void main(String[] args) {
		...
		check("edf", "ddf"); // should be false
		check("edf", "eef"); // should be false
		check("abc2", "abc"); // should be true
		check("2abc", "abc"); // should be true
		check("aacb", "aab"); // should be true
		check("aabbcc","bbcc"); // should be false
		check("aabbcc","aacc"); // should be false
		check("aabbcc","bbcc"); // should be false
	}
