...
public class GitletTest {
	...
	/**
	 * Test that a file that has been committed at some point 
	 * can be restored by checking it out from the commit it was committed at.
	 */
	@Test
	public void testAnotherCheckout() {
		String wugFileName = TESTING_DIR + "wug.txt";
		String wugText = "This is a wug.";
		createFile(wugFileName, wugText);
		gitlet("init");
	...
	/**
	 * Test that a file that has been committed at some point can be restored by checking it 
	 * out from a commit that tracks that version of the file, even if the file wasn't staged prior to that commit.
	 */
	@Test
	public void testThirdCheckout() {
		...
		String wugText = "This is a wug.";
		createFile(wugFileName, wugText);
		String abcName = TESTING_DIR + "abc.txt";
		String abcText = "This is an abc.";
		createFile(abcName, abcText);
		gitlet("init");
		gitlet("add", wugFileName);
		gitlet("commit", "added wug");
		gitlet("add", abcName);
		gitlet("commit", "added abc");
		writeFile(wugFileName, "This is not a wug.");
		gitlet("checkout","1", wugFileName);
		assertEquals(wugText, getText(wugFileName));
	}
	...
	public void testReset() {
		...
		String commitMessage2 = "added wug";
		gitlet("commit", commitMessage2);
		String commitMessage3 = "abcde wug";
	...
	public void testMerge1() {
		...
		gitlet("checkout", "m2");
		gitlet("add", wugFileName);
		gitlet("commit", "added wug again from another branch");
		gitlet("checkout","1", wugFileName);
		gitlet("merge", "master");
		File f1 = new File(TESTING_DIR + "wug.txt.conflicted");
		assertTrue(f1.exists());
	}
	
	/**
	 * Test that merge will commit with files from the other branch if those files had been 
	 * modified in the other branch but not in the current branch since the split point.
	 */
	@Test
	public void testMerge2() {
		...
		String wugText1 = "This is a nothing.";
		...
		Gitlet.deleteFile(TESTING_DIR + "wug.txt");
		gitlet("merge", "m2");		
		File f1 = new File(TESTING_DIR + "wug.txt");
		assertTrue(f1.exists());
	}
	/**
	...
	public void testRebase1() {
		...
		gitlet("branch","m2");
		gitlet("add", wugFileName);
		String commitMessage3 = "love";
		gitlet("commit", commitMessage3);
		gitlet("add", wugFileName);
		String commitMessage4 = "i";
		gitlet("commit", commitMessage4);
		gitlet("add", wugFileName);
		String commitMessage5 = "hello";
		gitlet("commit", commitMessage5);
		gitlet("checkout","m2");
		gitlet("add", wugFileName);
		String commitMessage6 = "late";
		gitlet("commit", commitMessage6);
		gitlet("add", wugFileName);
		String commitMessage7 = "i";
		gitlet("commit", commitMessage7);
		gitlet("add", wugFileName);
		String commitMessage8 = "ello";
		gitlet("commit", commitMessage8);
		gitlet("rebase","master");
		String logContent = gitlet("log");
		assertArrayEquals(new String[] { commitMessage8, commitMessage7,commitMessage6, commitMessage5,commitMessage4, commitMessage3,commitMessage2, commitMessage1 },
				extractCommitMessages(logContent));
	}
	...
	public void testRebase2() {
		...
		createFile(wugFileName, wugText);
		String wugFileName1 = TESTING_DIR + "wug1.txt";
		String wugText1 = "This is a not wug.";
		createFile(wugFileName1, wugText1);
		gitlet("add", wugFileName);
		String commitMessage2 = "added wug";
		gitlet("commit", commitMessage2);
		...
		gitlet("checkout","master");
		gitlet("rebase","m2");
		assertEquals(wugText1, getText(wugFileName));
	}	
