...
public class GitletTest {
	...
	public void testCheckoutAlt() {
		...
		createFile(fileName, fileText);
		gitlet("add", fileName);
		String fileName1 = TESTING_DIR + "2.txt";
		createFile(fileName1, "I am two");
		gitlet("add", fileName1);
		gitlet("commit", "firstCommit");
		createFile(fileName, "This is two");
		gitlet("add", fileName);
		gitlet("commit", "secondCommit");
		createFile(fileName, "This is three");
		gitlet("add", fileName);
		gitlet("commit", "thirdCommit");
		createFile(fileName1, "I am three");
		assertEquals("I am three", getText(fileName1));
		gitlet("checkout", fileName1);
		assertEquals("I am two", getText(fileName1));		
	}
	@Test
