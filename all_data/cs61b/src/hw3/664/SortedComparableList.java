...
public class SortedComparableList {
    ...
    public void insert(Comparable c) {
        if (c != null){
          if (head.compareTo(c) > 0) {
            ...
            SortedComparableList temp = this.tail;
            while (temp != null && temp.head.compareTo(c) < 0){
              temp = temp.tail;
            }
            temp = new SortedComparableList(c, temp.tail);
    ...
    public Comparable get(int i) {
        SortedComparableList target = this;
        for (int j = 0; j < i; j += 1){
          if (target.tail != null){
            target = target.tail;
          }
