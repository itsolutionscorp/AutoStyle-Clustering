...
public class SortedComparableList {
    ...
    public void insert(Comparable c) {
      ...
      if (c != null) {
        if (c.compareTo(head) < 0) {
          ...
          while( old.tail != null && c.compareTo(old.tail.head) > 0) {
            old = old.tail;
          }
            old.tail = new SortedComparableList(c, old.tail);
        }
      }
    }
    ...
    public void squish() {
      ...
      if (tail != null) {
        ...
        SortedComparableList old = tail;
        while (old != null) {
          if (last.head.equals(old.head)) {
            last.tail = old.tail;
            old = last.tail;
          }
          else {
