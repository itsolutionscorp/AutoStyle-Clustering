...
public class SortedComparableList {
        ...
        if(c != null){
            ...
            if(c.compareTo(head) < 0){
                ...
                while(temp.tail != null){
                    if(c.compareTo(temp.tail.head) < 0){
    ...
    public Comparable get(int i) {
        SortedComparableList tempTail = tail;
        Comparable tempHead = head;
        if(i == 0){
            return head;
        }
        else{
            for(int w = 0; w < i; w++){
                tempHead = tempTail.head;
    ...
    public void twin() {
        ...
        temp.tail = new SortedComparableList(temp.head,null);
    }
