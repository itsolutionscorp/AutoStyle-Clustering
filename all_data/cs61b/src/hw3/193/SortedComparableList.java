...
public class SortedComparableList {
    ...
    public static void main(String[] args) {
        SortedComparableList xs = new SortedComparableList();
        xs.insert(1);
        xs.insert(0);
        xs.insert(0);
        xs.insert(3);
    ...
    public static SortedComparableList sublist(SortedComparableList L, int start, int len) {
        SortedComparableList suffix = subTail(L, start);
        SortedComparableList list = null;

        for (int i = len - 1; i >= 0; i--) {
            list = new SortedComparableList(suffix.get(i), list);
        }
