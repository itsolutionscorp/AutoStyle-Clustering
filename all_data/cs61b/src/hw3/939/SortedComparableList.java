...
public class SortedComparableList {
    ...
    public void insert(Comparable c) {
      ...
      Comparable oldHead = p.head;
      p.head = c;
      p.tail = new SortedComparableList(oldHead, p.tail);
    }
    ...
    public void extend(SortedComparableList that) {
      for (SortedComparableList p = that; p != null; p = p.tail)
        insert(p.head); 
    }
     ...
     **/
    public void squish() {
        SortedComparableList fixer = this;
        SortedComparableList mover = tail;
        while (mover != null) {
          while (fixer.head.equals(mover.head)) {
            mover = mover.tail;
            if (mover == null) {
              fixer.tail = mover;
              return;
