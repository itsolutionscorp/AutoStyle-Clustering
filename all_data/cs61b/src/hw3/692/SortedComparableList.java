...
public class SortedComparableList {
    ...
    public SortedComparableList(){
        this(0, null); //calls the 2 argument constructor
        // head = 0;
        // tail = null;
    }
    ...
    public static SortedComparableList sublist(SortedComparableList L, int start, int len) {
        ...
        // iterative
        // SortedComparableList tempSubTail = subTail(L, start);
        // SortedComparableList result = new SortedComparableList(tempSubTail.get(0), null);
        // tempSubTail = tempSubTail.tail;
        // len--;
        // while (tempSubTail != null && len > 0) {
        //   result.insert(tempSubTail.head);
        //   tempSubTail = tempSubTail.tail;
        //   len--;
        // }
        // return result;
