...
public class SortedComparableList {
    ...
    public void insert(Comparable c) {
        if (c.compareTo(head) < 0) {
          ...
          while (a.tail != null && c.compareTo(a.tail.head) > 0) {
            a = a.tail;
          }
          a.tail = new SortedComparableList(c, a.tail);
        }
    }
    ...
    public void twin() {
        SortedComparableList a = this;
        while (a != null) {
          a.tail = new SortedComparableList(a.head, a.tail);
          a = a.tail.tail;
        }
    }
