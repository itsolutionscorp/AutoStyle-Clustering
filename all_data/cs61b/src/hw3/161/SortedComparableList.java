...
public class SortedComparableList {
    ...
    public void insert(Comparable c) {
        // REPLACE THIS LINE WITH YOUR SOLUTION
    	// all Comparables have a compareTo method, which you should use when determining where to place an element.
    	// it returns a negative int, zero, or positive int if this object is <, =, or > than the object passed in as an argument
    	if (c != null) {
    		if (c.compareTo(head) < 0) { // c is the least
    ...
    public Comparable get(int i) {
        ...
        return pointer.head; // REPLACE THIS LINE WITH YOUR SOLUTION
    ...
    public void extend(SortedComparableList that) {
        // REPLACE THIS LINE WITH YOUR SOLUTION
//    	if (head == null && that != null) {
//    		head = that.head;
//    		tail = that.tail;
//    	}
//    	
//    	else {
    		SortedComparableList pointer2 = that;
    		
    		while(pointer2!= null) {
    			insert(pointer2.head);
