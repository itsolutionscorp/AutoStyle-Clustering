...
public class SortedComparableList {
    ...
    public void insert(Comparable c) {
        ...
        if(this.tail==null){
            if(c.compareTo(this.head)<0){
                SortedComparableList v= new SortedComparableList(this.head, this.tail);
                this.head=c;
                this.tail=v;
            }else{
                SortedComparableList v= new SortedComparableList(c, this.tail);
                this.tail=v;
            }
    ...
    public void extend(SortedComparableList that) {
        if (that.tail==null) {this.insert(that.head);}
        int i=0;
        SortedComparableList p=that;
        while (p.tail!=null){
        Comparable c = that.get(i);
        this.insert(c);
        p=p.tail;
        i++;
        }
    ...
    public static SortedComparableList sublist(SortedComparableList L, int start, int len) {
      ...
      SortedComparableList.expungeTail(n, start+len-1);
      return n;
    }
