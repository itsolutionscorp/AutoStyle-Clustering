...
public class SortedComparableList {
    ...
    public void insert(Comparable c) {
      ...
      if (c!=null){
        if (c.compareTo(head)<0){
          ...
          SortedComparableList cc=this;
          while(cc.tail!=null && c.compareTo(cc.tail.head)>0){
            cc=cc.tail;
          }
          cc.tail=new SortedComparableList(c,cc.tail);
        }
      }
    }
    ...
    public Comparable get(int i) {
      if (head==null||i==0) { // REPLACE THIS LINE WITH YOUR SOLUTION
        return head;      }
      else{
        SortedComparableList cc=this;
        while (cc.tail!=null && i!=0) {
          cc=cc.tail;
          i--;
        }
        return cc.head;
    ...
    public static SortedComparableList sublist(SortedComparableList L, int start, int len) {
        ...
        return new SortedComparableList(L.head,sublist(L.tail,0,len-1)); // REPLACE THIS LINE WITH YOUR SOLUTION
    }
    ...
    public void twin() {
      ...
      SortedComparableList cc=this;
      while(cc!=null){
        cc.tail=new SortedComparableList(cc.head,cc.tail);
        cc=cc.tail.tail;
      }
    }
