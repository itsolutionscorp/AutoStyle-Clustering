...
public class SortedComparableList {
    ...
    public void insert(Comparable c) {//help from hw soln
        if (c != null){
    ...
    public static SortedComparableList sublist(SortedComparableList L, int start, int len) {
        ...
        if(start == 0) return new SortedComparableList(L.head, sublist(L.tail, 0, len - 1));
     ...
     **/
     public void squish() {//@help from answers
        if (tail != null) {
