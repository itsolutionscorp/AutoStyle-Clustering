...
public class SortedComparableList {
    ...
    public void insert(Comparable c) {
        if(c != null){
          if(c.compareTo(this.head) < 0){
            tail = new SortedComparableList(this.head, this.tail);
            head = c;
          }
          else{
    ...
    public static SortedComparableList sublist(SortedComparableList L, int start, int len) {
        if(len == 0){
          ...
          return new SortedComparableList(temp.head, sublist(temp.tail, 0, len - 1));
        }
    ...
    public void twin() {
        SortedComparableList temp = this;
        while(temp != null){
          SortedComparableList doubled = new SortedComparableList(temp.head, temp.tail);
          temp.tail = doubled;
          temp = temp.tail.tail;
        }
    }
