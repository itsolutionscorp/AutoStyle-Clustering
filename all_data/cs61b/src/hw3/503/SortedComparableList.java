...
public class SortedComparableList {
    ...
    public static SortedComparableList subTail(SortedComparableList L, int start) {
        if (start == 0 || L == null) {
            return L; //didn't realize this could be a linked list...thought it had to return a regular list. Ah well...
        }
        else {
    ...
    public static SortedComparableList sublist(SortedComparableList L, int start, int len) {
        ...
        return new SortedComparableList(L.head, sublist(L.tail, 0, len - 1)); //wow ... this is a smart idea...
    }
    ...
    public boolean equals(Object x) {
        ...
        SortedComparableList L = (SortedComparableList) x; //this means x must have been declared as Object x = SortedComprableList(head, tail)
