...
public class SortedComparableList {
    ...
    public static SortedComparableList subTail(SortedComparableList L, int start) {
        ...
        SortedComparableList ret = new SortedComparableList(L.head, null);
        SortedComparableList mark = ret;
        
        L = L.tail;
        while (L != null) {
            mark.tail = new SortedComparableList(L.head, null);
            mark = mark.tail;
            L = L.tail;
        }
        return ret;
    ...
    public static SortedComparableList sublist(SortedComparableList L, int start, int len) {
        SortedComparableList ret = subTail(L, start);
        expungeTail(ret, len-1);
        return ret;
    }
