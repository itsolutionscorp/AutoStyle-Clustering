...
public class SortedComparableList {
    ...
    public Comparable get(int i) {
        if(i == 0) {
            ...
            return null; //This index is out of bounds
        }
        else {
            return tail.get(i - 1);
        }
     ...
     */
    public static SortedComparableList sublist(SortedComparableList L, int start, int len) { //I never knew how to get this to work with recursion so I had to resort to the solution :(
        if (len == 0) {
            //base case
            return null;
        }
    ...
    public void twin() {
        ...
        tail = new SortedComparableList(head, oldtail);
        if(oldtail != null) {
            oldtail.twin();
        }
    }
