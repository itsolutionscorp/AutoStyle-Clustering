...
public class SortedComparableList {
    ...
    public Comparable get(int i) {
      SortedComparableList copy = this;
        ...
        return copy.head; // REPLACE THIS LINE WITH YOUR SOLUTION
    }
    ...
    public static SortedComparableList subTail(SortedComparableList L, int start) {
        ...
        return copy; // REPLACE THIS LINE WITH YOUR SOLUTION
    }
    ...
    public static SortedComparableList sublist(SortedComparableList L, int start, int len) {
        SortedComparableList copy = subTail(L,start);
        int index = 1;
        SortedComparableList sync = new SortedComparableList(copy.head, copy.tail);
        SortedComparableList synccopy = sync;
        while (index < len) {
          synccopy = synccopy.tail;
          index = index + 1;
        }
        synccopy.tail = null;
        return sync;
    ...
    public void twin() {
      SortedComparableList copy = this;
      while (copy != null) {
        copy.tail = new SortedComparableList(copy.head, copy.tail);
        copy = copy.tail.tail;
      }
        // REPLACE THIS LINE WITH YOUR SOLUTION
    }
