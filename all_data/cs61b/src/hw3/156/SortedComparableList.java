...
public class SortedComparableList {
    ...
    public static SortedComparableList sublist(SortedComparableList L, int start, int len) {
        SortedComparableList theSubList = new SortedComparableList(L.get(start), null);
        int i = 0;
        SortedComparableList ptr = L;
        while (i <= start && ptr != null){
            ptr = ptr.tail;
            i++;
        } 
        while (i < start + len && ptr != null){
            theSubList.insert(ptr.head);
            ptr = ptr.tail;
            i++;
        }
        return theSubList;
