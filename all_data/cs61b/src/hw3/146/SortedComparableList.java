...
public class SortedComparableList {
    ...
    public void insert(Comparable c) {
      if (c == null) {
        ...
        while ((pt.tail != null) && (c.compareTo(head) > 0)) {
            pt = pt.tail;
          }
    ...
    public static SortedComparableList subTail(SortedComparableList L, int start) {
        SortedComparableList pt = L;
        while ((pt != null) && (start != 0)) {
            pt = pt.tail;
            start--;
        }
        return pt;
    ...
    public static SortedComparableList sublist(SortedComparableList L, int start, int len) {
        SortedComparableList pt = subTail(L, start);
        //SortedComparableList result = new SortedComparableList(pt.head,null);
        SortedComparableList pt2 = pt;
        while ((pt2.tail != null) && (len > 1)) {
          pt2 = pt2.tail;
          len--;
        }
        pt2.tail = null;
    ...
    public void squish() {
      if (this.tail != null) {
        SortedComparableList pt = this;
        while ((pt != null) && (pt.tail != null)) {
          if ((pt.head).compareTo(pt.tail.head) == 0) {
            pt.tail = pt.tail.tail;
          }
          else{
            pt = pt.tail;
          }
    ...
    public void twin() {
      SortedComparableList pt = this;
        while (pt != null) {
          pt.tail = new SortedComparableList(pt.head, pt.tail);
          pt = pt.tail.tail;
        }
    }
