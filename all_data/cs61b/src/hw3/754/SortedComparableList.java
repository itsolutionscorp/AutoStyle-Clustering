...
public class SortedComparableList {
    ...
    public static SortedComparableList subTail(SortedComparableList L, int start) {
        SortedComparableList returnTail;
        if (start == 0) {
        	returnTail = L;
        }
        else {
        	returnTail = subTail(L.tail, start - 1);
        }
        return returnTail;
    }
    ...
    public void squish() {
        if (tail != null && head == tail.head) {
        	...
        	SortedComparableList newTail = tail;
        	tail.squish();
        }
    }
     ...
     **/
    public void twin() {
    	SortedComparableList twinList = this;
        while (twinList != null) {
        	twinList.tail = new SortedComparableList(twinList.head, twinList.tail);
            twinList = twinList.tail.tail;
        }
    }
