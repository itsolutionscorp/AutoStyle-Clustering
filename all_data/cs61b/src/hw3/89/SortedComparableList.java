...
/*    public static void main(String[] args) {
      SortedComparableList c = new SortedComparableList(2, null);
      c.insert(1234);
      c.insert(23);
      c.insert(23);
      c.insert(23);
      ...
      System.out.println(subTail(c, 2));
      System.out.println(sublist(c, 2, 2));

      SortedComparableList d = new SortedComparableList(20, null);
      SortedComparableList e = new SortedComparableList(19, d);
      SortedComparableList f = new SortedComparableList(6, e);
      SortedComparableList g = new SortedComparableList(3, f);
      SortedComparableList h = new SortedComparableList(1, g);
    ...
    public void insert(Comparable c) {
        if (c != null) {
            if (c.compareTo(head) < 0 || c.compareTo(head) == 0) {
     ...
     **/
    public void squish() {
        SortedComparableList ptr1 = this;
        SortedComparableList ptr2 = ptr1;
        while (ptr1 != null) {
            while (ptr2 != null && ptr2.tail != null) {
                if (ptr2.tail.head == ptr1.head) {
                    ptr2.tail = ptr2.tail.tail;
                } else {
                    ptr2 = ptr2.tail;
                }
            }
