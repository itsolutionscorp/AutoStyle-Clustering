...
public class SortedComparableList {
    ...
    public void extend(SortedComparableList that) {
        SortedComparableList currList = that;
        while (currList != null) {
            insert(currList.head);
            currList = currList.tail;
        }
    }
     ...
     **/
    public void twin() {
        SortedComparableList oldList = this;
        while (oldList != null) {
            oldList.tail = new SortedComparableList(oldList.head, oldList.tail);
            oldList = oldList.tail.tail;
        }
    }
