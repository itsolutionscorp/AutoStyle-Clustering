...
public class SortedComparableList {
	...
	public static SortedComparableList sublist(SortedComparableList L,
		...
		SortedComparableList curr = subtail;
		if (L == null || len == 0) {
			return null;
		} else {
			while (curr != null && len > 1) {
				curr = curr.tail;
				len -= 1;
			}
			curr.tail = null;
	...
	public static void expungeTail(SortedComparableList L, int len) {
		/*
		 * L = SortedComparableList.sublist(L, 0, len + 1); L.toString();
		 */
	...
	public void squish() {
		/*
		 * SortedComparableList copy = this; int compare = 0; while (copy !=
		 * null) { compare = copy.head.compareTo(copy.tail.head); if (compare ==
		 * 0) { tail = tail.tail; } copy = copy.tail; }
		 */
	...
	public void twin() {
		/*
		 * SortedComparableList copy = this; while (copy != null) { tail = new
		 * SortedComparableList(copy.head, tail); copy = copy.tail; }
		 */
		SortedComparableList prev = this;
		while (prev != null) {
