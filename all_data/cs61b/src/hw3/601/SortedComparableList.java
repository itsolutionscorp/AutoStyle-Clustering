...
public class SortedComparableList 
{
    ...
    public void insert(Comparable c) 
    {
        ...
        while (c.compareTo(pointer.head) > 0 && pointer.tail != null)
        {
        ...
        {
          Comparable x = pointer.head;
          pointer.head = c;
          pointer.tail = new SortedComparableList(x, pointer.tail);
        }
    }
    ...
    {
        /* SortedComparableList pointer = L;
        SortedComparableList pointer2 = new SortedComparableList();
        while (pointer != null)
        {
            pointer2.insert(pointer.head);
            pointer = pointer.tail;
        }
        pointer2 = subTail(pointer2, start);
        SortedComparableList pointer3 = pointer2;
        for (int x = 0; x<len; x++)
        {
            pointer3 = pointer3.tail;
        }
        pointer3.tail=null;
        return pointer2; */
        if (len == 0) {
    ...
    {/*
        SortedComparableList pointer = this;
        SortedComparableList pointer2 = pointer.tail;
        while (pointer2 != null)
        {
            if (pointer.head==pointer2.head)
            {
