...
public class SortedComparableList {
    ...
    public void insert(Comparable c) {
        // recursively insert c into the list
        // base case
        if (c == null) {
            return;
        }
        
        // if c should be the first element of the list
    ...
    public Comparable get(int i) {
        // recursively return the ith element of the list
        // base case (first element or empty list)
        if (i == 0 || head == null) {
            return head;
        }
    ...
    public void extend(SortedComparableList that) {
        // recursively add every element of that into the list
        // base case
        if (that == null) {
            return;
        }
    ...
    public static SortedComparableList subTail(SortedComparableList L, int start) {
        // recursively return the subtail
        // base case
        if (L == null || start == 0) {
            return L;
        }
    ...
    public static SortedComparableList sublist(SortedComparableList L, int start, int len) {
        // recursively return the sublist
        // base case
        if (L == null || len == 0) {
            return null;
        }
        ...
        // we are at start, recursively make a new list
     ...
     **/
    public void squish() {
        // recursively squish the list
        // base case
        if (tail == null) {
            return;
        }

        // delete next element if it is the same as the current one
        if (head == tail.head) {
            tail = tail.tail;
        }

        // recursively squish the rest of the list
        if (tail != null) {
            tail.squish();
        }
    }
     ...
     **/
    public void twin() {
        // recursively twin each element in the list
        // base case
        if (tail == null) {
