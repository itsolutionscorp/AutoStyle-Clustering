...
public class SortedComparableList {
    ...
    public void insert(Comparable c) {
      if (c != null){
        if (c.compareTo(this.head) < 0){
          tail = new SortedComparableList(head, this);
          head = c; 
        }
        else{
    ...
    public Comparable get(int i) {
      return ComparableHelper(this, i);
    }

    private Comparable ComparableHelper(SortedComparableList lst, int i){
      if (i == 0){
        return lst.head;
      }
      else{
        return ComparableHelper(lst.tail, i-1);
      }
    }
    ...
    public static SortedComparableList sublist(SortedComparableList L, int start, int len) {
        ...
        SortedComparableList subPointer = sub;
        while (len > 1 && sub != null){
          subPointer = subPointer.tail;
          len -= 1;
        }
        subPointer.tail = null;
        return sub;
    }
