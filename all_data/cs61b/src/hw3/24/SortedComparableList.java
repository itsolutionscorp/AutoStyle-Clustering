...
public class SortedComparableList {
    ...
    public void insert(Comparable c) {
      if (c != null) {
        if (c.compareTo(head) < 0) {
          ...
          SortedComparableList hohoho = this;
          while (hohoho.tail != null && c.compareTo(hohoho.tail.head) > 0) {
            hohoho = hohoho.tail;
          }
          hohoho.tail = new SortedComparableList(c, hohoho.tail);
    ...
    public Comparable get(int i) {
        ...
        SortedComparableList bleh = this;
        while (i > 0 && bleh.tail != null) {
            bleh = bleh.tail;
            i += 1;
        }
        return bleh.head;
    ...
    public void extend(SortedComparableList that) {
        SortedComparableList bleh = that;
        while (bleh != null) {
          insert(bleh.head);
          bleh = bleh.tail;
        }
    ...
    public static SortedComparableList sublist(SortedComparableList L, int start, int len) {
        SortedComparableList brehbreh = L;
