...
public class SortedComparableList {
    ...
    public void insert(Comparable c) {
        if (c != null) {
            if (c.compareTo(head) < 0) {
                ...
                SortedComparableList save = this;
                while (save.tail != null && c.compareTo(save.tail.head) > 0) {
                    save = save.tail;
                }
                save.tail = new SortedComparableList(c, save.tail);
            }
        }
    }
    ...
    public void extend(SortedComparableList that) {
        SortedComparableList save = that;
        while (save != null) {
            insert(save.head);
            save = save.tail;
        }
