...
public class SortedComparableList {
    ...
    public void insert(Comparable c) {
        ...
        if (c.compareTo(head) < 0) {
        	...
        	SortedComparableList pos = this;
            while (c.compareTo(pos.head) > 0 && pos.tail != null) {
            	pos = pos.tail;
            }
            pos.tail = new SortedComparableList(c, pos.tail);
        }
    }
    ...
    public void squish() {
    	 if (tail != null) {
             ...
             SortedComparableList pos = tail;
             while (pos != null) {
                 if (prev.head.equals(pos.head)) {
                     prev.tail = pos.tail;
                     pos = prev.tail;
                 }
                 else {
    ...
    public void twin() {
    	SortedComparableList pos = this;
        while (pos != null) {
            pos.tail = new SortedComparableList(pos.head, pos.tail);
            pos = pos.tail.tail;
        }
    }
