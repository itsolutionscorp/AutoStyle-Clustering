    ...
    public void insert(Comparable c) {
        if (c != null){
            if (c.compareTo(head) < 0){
                ...
                SortedComparableList rn = this;
                while (rn.tail != null && c.compareTo(rn.tail.head)>0) {
                    rn = rn.tail;
                }
                rn.tail = new SortedComparableList(c, rn.tail);
            }
        }
    }
