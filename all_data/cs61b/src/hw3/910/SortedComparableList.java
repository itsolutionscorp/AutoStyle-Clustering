...
public class SortedComparableList {
    ...
    public void insert(Comparable c) {
        // REPLACE THIS LINE WITH YOUR SOLUTION
        SortedComparableList p = new SortedComparableList();
        p.head = head;
        p.tail = tail;
        while (((p.head).compareTo(c) < 0 ) && (p.tail != null)){
            p = p.tail;
        }
        if (p.tail == null){
            ...
            p = new SortedComparableList(c, p);
            tail = p;
    ...
    public Comparable get(int i) {
        ...
        instance = p.head;
        return (int) instance; // REPLACE THIS LINE WITH YOUR SOLUTION
    }
    ...
    public static SortedComparableList subTail(SortedComparableList L, int start) {
        ...
        else return subTail(L.tail, (start-1)); // REPLACE THIS LINE WITH YOUR SOLUTION
    }
    ...
    public static SortedComparableList sublist(SortedComparableList L, int start, int len) {
        ...
        else return sublist(L, (start+1), len); // REPLACE THIS LINE WITH YOUR SOLUTION
    }
