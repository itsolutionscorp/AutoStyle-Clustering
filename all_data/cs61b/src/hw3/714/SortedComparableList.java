...
public class SortedComparableList {
    ...
    //what if c is null!!
    //I orginally checked it head is smaller than c first and then inserted it using recursion. Would this work I wonder 
    ...
    //maybe that.tail.tail will not exist
    //I originally just modified that's tail so it works
    ...
    //this works much better recursively, I originally did it itereatively 
    ...
    public void squish() {
        ...
        while (curr != null) {
          //need to skip one here
          //setting prev.tail to curr.tail will skip the currents head and then curr skipps two tail 
     ...
     *  duplicate.
     **/
    //I dont think I need to make a new int, this will make the tails tail equal to the current tail and the new head head will be replaces
    public void twin() {
        SortedComparableList temp = this;
        while (temp != null) {
