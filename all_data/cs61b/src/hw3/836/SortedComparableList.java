...
public class SortedComparableList {
    ...
    public void insert(Comparable c) {
		if(c != null){
			if(c.compareTo(head) < 0){
                ...
                SortedComparableList panda = this;
                while(panda.tail != null && c.compareTo(panda.tail.head) > 0) {
                    panda = panda.tail;
                }
                panda.tail = new SortedComparableList(c, panda.tail);
			}
		}
    }
    ...
    public static SortedComparableList subTail(SortedComparableList L, int start) {
		...
		return subTail(L.tail, start - 1); // REPLACE THIS LINE WITH YOUR SOLUTION
    }
    ...
    public void squish() {
        // REPLACE THIS LINE WITH YOUR SOLUTION
		SortedComparableList a = this;
		SortedComparableList b = tail;
		while(b != null){
