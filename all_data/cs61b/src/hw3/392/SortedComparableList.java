...
public class SortedComparableList {
    ...
    public static SortedComparableList sublist(SortedComparableList L, int start, int len) {
        if (len == 0) {
            ...
            return new SortedComparableList(L.head, sublist(L.tail, 0, len--));
        }
    }
    ...
    public void twin() {
        SortedComparableList pointer = this;
        while (this != null) {
            pointer.tail = new SortedComparableList(pointer.head, tail);
