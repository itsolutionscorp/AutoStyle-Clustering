...
public class SortedComparableList {
    ...
    public void insert(Comparable c) {
      if (c != null) {
        if (c.compareTo(head)<0){
          ...
          while (curr.tail != null && c.compareTo(curr.tail.head) > 0) curr = curr.tail;
    ...
    public void extend(SortedComparableList that) {
        if (tail == null) {
          tail = that;
            ...
            while(curr.tail != null) curr = curr.tail;
            curr.tail = that;
        }
    }
    ...
    public static SortedComparableList subTail(SortedComparableList L, int start) {
        ...
        for(int i = 0; i < start; i++) curr = curr.tail;
        return curr;
    }
    ...
    public static SortedComparableList sublist(SortedComparableList L, int start, int len) {
        ...
        SortedComparableList curr = L;
        SortedComparableList result;
        for(int i = 0; i < start; i++) curr = curr.tail;
        result = new SortedComparableList(curr.head, null);
        for(int i = 0; i < len-1; i++) {
          if (curr.tail != null) {
            curr = curr.tail;
            result.insert(curr.head);
          }
        }
        return result;
    }
    ...
    public static void expungeTail(SortedComparableList L, int len) {
      if(L != null) {
        SortedComparableList curr = L;
        for(int i = 0; i < len; i++) curr = curr.tail;
        curr.tail = null;
      } 
    }
    ...
    public void squish() {
        if (this != null) {
        Comparable origin = head;
        SortedComparableList curr = this;
        if (curr.tail.head == origin) curr.tail = curr.tail.tail;
        if (this.tail != null) this.tail.squish();  
        }
    }
    ...
    public void twin() {
      if (this != null) {
        SortedComparableList pick = tail;
        this.tail = null;
        SortedComparableList twin = new SortedComparableList(head, pick);
        this.tail = twin;
        if (this.tail.tail != null) this.tail.tail.twin();
      }
    }
