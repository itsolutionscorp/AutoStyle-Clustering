...
public class SortedComparableList {
    ...
    public void insert(Comparable c) {
        ...
        if (c != null) {
            if (c.compareTo(head) < 0) {
                ...
                while (p.tail != null && p.tail.head.compareTo(c) > 0) {
                    p = p.tail;
                }
    ...
    public static SortedComparableList sublist(SortedComparableList L, int start, int len) {
        ...
        SortedComparableList ref = new SortedComparableList(pointer.head, pointer.tail);
        SortedComparableList p = ref;
        while (len > 1) {
        	p = p.tail;
        }
        p.tail = null;
