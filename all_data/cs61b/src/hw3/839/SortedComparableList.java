...
public class SortedComparableList {
	...
	SortedComparableList subList = new SortedComparableList(pointer.head, null);
	int i = 1;
	pointer = pointer.tail;
	SortedComparableList subPointer = subList;
	while (pointer != null && i < len) {
	    subPointer.tail = new SortedComparableList(pointer.head, null);
	    pointer = pointer.tail;
	    subPointer = subPointer.tail;
	    i++;
	}
	return subList;
    }
	...
	while (pointer.tail != null) {
	    if (pointer.tail.head == pointer.head) {
