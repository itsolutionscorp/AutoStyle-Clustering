...
public class SortedComparableList {
    ...
    public void insert(Comparable c) {
      ...
      while(copy.tail!=null && copy.tail.head.compareTo(c)<0){  /// (1,2,4) c=3
        copy = copy.tail;
      }
    ...
    public static SortedComparableList sublist(SortedComparableList L, int start, int len) {
        ...
        //   return L;
        // }
        // SortedComparableList beginning = subTail(L, start);
        // SortedComparableList copy = beginning;
        // if (beginning==null) {
        //   return beginning;
        // }
        // while(len>0 && copy.tail!=null){
        //   copy = copy.tail;
        //   len-=1;
        // }
        // copy.tail = null;
    ...
    public void squish() {
        ...
        while (copy.tail!=null){
          if (copy.head.compareTo(copy.tail.head)==0) {
