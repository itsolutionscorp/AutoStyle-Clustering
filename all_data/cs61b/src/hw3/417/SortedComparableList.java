...
public class SortedComparableList {
    ...
    public void insert(Comparable c) {
        if (c != null)
        {
            ...
            else
            {
                ...
                while (lst.tail != null && c.compareTo(lst.tail.head) > 0)
                {
                    lst = lst.tail;
                }
                lst.tail = new SortedComparableList(c, lst.tail);
            }
        }
    }
    ...
    public void squish() {
        if (tail != null)
        {
            SortedComparableList lst1 = this;
            SortedComparableList lst2 = tail;
            while (lst1 != null)
            {
                if (lst1.head.equals(lst2.head))
                {
                    lst1.tail = lst2.tail;
                    lst2 = lst1.tail;
                }
    ...
    public void twin() {
        ...
        while (lst != null)
        {
            lst.tail = new SortedComparableList(lst.head, lst.tail);
            lst = lst.tail.tail;
        }
    }
