...
public class SortedComparableList {
    ...
    private static SortedComparableList traverseIndex(SortedComparableList L, int index){
    ...
    public static SortedComparableList subTail(SortedComparableList L, int start) {
        SortedComparableList curr = L;
        curr = traverseIndex(curr, start);
        SortedComparableList r = new SortedComparableList(curr.head, null);
        SortedComparableList trav = r;
        curr = curr.tail;
        while(curr != null){
            trav.tail = new SortedComparableList(curr.head, null);
            trav = trav.tail;
            curr = curr.tail;
        }
        return r;
