...
public class SortedComparableList{
    ...
    public void insert(Comparable c) {
      SortedComparableList insertList = new SortedComparableList();
    ...
    public static SortedComparableList subTail(SortedComparableList L, int start) {
        SortedComparableList imageTail = L;
        while (start > 0) {
          imageTail = imageTail.tail;
          start -= 1;
        }
        return imageTail;
    }
    ...
    public void squish() {
        if (tail != null) {
            ...
            SortedComparableList new_list = tail;
            while (new_list != null) {
                if (temp.head.equals(new_list.head)) {
                    temp.tail = new_list.tail;
                    new_list = temp.tail;
                }
                else {
                    temp = temp.tail;
