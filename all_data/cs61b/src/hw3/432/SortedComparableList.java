...
public class SortedComparableList {
    ...
    public void insert(Comparable c) {
        // REPLACE THIS LINE WITH YOUR SOLUTION
      SortedComparableList curr = this, prev = null;
      //System.out.println(curr.head);
      while ((curr != null) && (curr.head != null) && (curr.head.compareTo(c) < 0)){
      ...
      if (prev == null){
        ...
        prev.tail = new SortedComparableList(c, curr);
      }
    }
    ...
    public static SortedComparableList subTail(SortedComparableList L, int start) {
      ...
      return curr; // REPLACE THIS LINE WITH YOUR SOLUTION
    }
    ...
    public static SortedComparableList sublist(SortedComparableList L, int start, int len) {
      SortedComparableList ans = new SortedComparableList();
    ...
    public static void expungeTail(SortedComparableList L, int len) {
        // REPLACE THIS LINE WITH YOUR SOLUTION
      SortedComparableList last = L;
      for (int i = 0; i < len; i++) last = last.tail;
      last.tail = null;
    }
    ...
    public void squish() {
      ...
      while (curr != null){
        //System.out.println(curr.head);
        while ((curr.tail != null) && (curr.tail.head == curr.head)){
          //System.out.println(curr.head + " " + curr.tail.head);
          curr.tail = curr.tail.tail;
          //curr = curr.tail;
        }
        if (curr != null) curr = curr.tail;
      }
    }
