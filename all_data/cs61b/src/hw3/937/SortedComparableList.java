...
public class SortedComparableList
{
	...
	public void insert(Comparable c)
	{
		...
		while (current.tail != null && current.tail.head.compareTo(c) < 0)
		{
	...
	{
		// REPLACE THIS LINE WITH YOUR SOLUTION
		SortedComparableList current = that;
		while (current != null)
		{
			insert(current.head);
			current = current.tail;
	 ...
	 *
	 * You can assume the list is in sorted order when this method is called.
	 *
	 * For example, if the input list is [ 0 0 0 0 1 1 3 3 3 4 ], the output
	 * list is [ 0 1 3 4 ].
	 **/
	public void squish()
	{
		...
		{
			if (current.head.compareTo(current.tail.head) == 0)
			{
	 ...
	 * You can assume the list is in sorted order when this method is called.
	 *
	 * For example, if the input list is [ 2 3 4 7 ], the output list is [ 2 2 3
	 * 3 4 4 7 7 ].
	 *
	...
	public void twin()
	{
		// REPLACE THIS LINE WITH YOUR SOLUTION
		SortedComparableList current = this;
		SortedComparableList currentTail = this.tail;
		while (current != null)
		{
			currentTail = current.tail;
			current.tail = new SortedComparableList(current.head, currentTail);
