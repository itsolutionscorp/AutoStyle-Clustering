...
public class SortedComparableList {
    ...
    public void insert(Comparable c) {
        ...
        while ((pointer.tail != null) && (value >= 0)){
            value = pointer.head.compareTo(c);
            if (value >= 0){
                pointer = pointer.tail;
            }
        }
        if (value < 0){
            SortedComparableList ab = new SortedComparableList(c, pointer);
            pointer = ab;
        }
        else{
    ...
    public static SortedComparableList sublist(SortedComparableList L, int start, int len) {
        ...
        SortedComparableList M = subTail(L, start);
        SortedComparableList N = new SortedComparableList(M.head, null);
        SortedComparableList O = N;
        while ((M != null) && (len > 1)){
            M = M.tail;
            if (M != null){
                N.tail = new SortedComparableList(M.head, null);
                N = N.tail;
            }
            len--;
        }
    ...
    public void squish() {
        ...
        while((L != null) && (L.tail != null)){
            if(L.head.compareTo(L.tail.head) == 0){
                L.tail = L.tail.tail;
            }
            L = L.tail;
        }
