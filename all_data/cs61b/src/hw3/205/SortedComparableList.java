...
public class SortedComparableList {
    ...
    public static SortedComparableList subTail(SortedComparableList L, int start) {
        ...
        if (cur == null || start == 0) {
            ...
            return subTail(cur.tail, start - 1);
        }
    }
    ...
    public static SortedComparableList sublist(SortedComparableList L, int start, int len) {
        ...
        if (len == 0) {
            return null;
        } else if (start > 0) { // create new list only when start == 0
            return sublist(cur.tail, start - 1, len); 
        } 
        return new SortedComparableList(cur.head, sublist(cur.tail, 0, len - 1)); 
    }
    ...
    public void squish() {
        ...
        if (cur.tail != null) {
            ...
            while (pointer != null) {
                if (cur.head.equals(cur.tail.head)) {
