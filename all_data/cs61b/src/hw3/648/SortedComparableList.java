...
//referenced answer document for some methods to double check answer
...
public class SortedComparableList 
{
    ...
    public void insert(Comparable c) 
    {
        if (c != null)
        {
            ...
            {
                SortedComparableList next = this;
                while (next.tail != null && c.compareTo(next.tail.head) > 0)
                {
                    next = next.tail;
                }
                next.tail = new SortedComparableList(c, next.tail);
            }
        }
    }
    ...
    public static SortedComparableList sublist(SortedComparableList L, int start, int len) 
    {
        ...
        // else
        // {
        //     SortedComparableList s = new SortedComparableList(temp.head, null);
        //     SortedComparableList next = s;
        //     len--;
        //     while (temp.tail != null && len > 0)
        //     {
        //         next.tail = new SortedComparableList(temp.tail.head, null);
        //         temp = temp.tail;
        //         next = s.tail;
        //         len--;
        //     }
    ...
    public void squish() 
    {
        if (tail != null)
        {
            ...
            while (next != null)
            {
                if (first.head.compareTo(next.head) == 0)
                {
