...
public class SortedComparableList {
    ...
    public void insert(Comparable c) {
      ...
      // SortedComparableList y = this;
      // while (x.head < c){
      //   x = x.tail;
      //   y = y.tail;
      // }
      // SortedComparableList lst = new SortedComparableList(c, x);
      // head = new SortedComparableList(y.head, lst);
      if (c != null) {
            // null check
            if (c.compareTo(head) < 0) {
                ...
                SortedComparableList x = this;
                while (x.tail != null && c.compareTo(x.tail.head) > 0) {
                    x = x.tail;
                }
                x.tail = new SortedComparableList(c, x.tail);
            }
        }
    }
    ...
    public static SortedComparableList subTail(SortedComparableList L, int start) {
      // SortedComparableList tempL = L;
      // SortedComparableList countL = L;
      // int count = 0;
      // while (countL.tail != null){
      //   count += 1;
      //   countL = countL.tail;
      // }
      // int i = 0;
      ...
      //   i++;
      // }
      // return tempL; // REPLACE THIS LINE WITH YOUR SOLUTION
      if (L == null || start == 0) {
            return L;
        }
        else {
    ...
    public static void expungeTail(SortedComparableList L, int len) {
      ...
      // SortedComparableList tempL = L;
      // SortedComparableList countL = L;
      // SortedComparableList newL = new SortedComparableList();
      // int count = 0;
      // int placeHolder = 0;
      // while(countL.tail != null){
      //   count += 1;
