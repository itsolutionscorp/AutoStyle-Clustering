...
def insert_every(lst, elem):
    # insert_every takes in a list of possibilities and an element, it returns a list of possibilities 
    if lst == []:
        return []
    else: 
        return [[elem] + lst[0]] + insert_every(lst[1:], elem)
...
def subsets(lst, n):
    ...
    if lst == [] and n == 0:
        ...
        return [[]]
    elif lst == [] : # 2 recursive calls, use 1st element, or don't 
        return []
    else: 
        first, rest = lst[0], lst[1:]
        without_first = subsets(rest, n) 
        return without_first + insert_every(subsets(rest, n-1), first)
