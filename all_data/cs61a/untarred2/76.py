...
def subsets(lst, n):
    ...
    return [[lst[0]] + sublst for sublst in subsets(lst[1:], n - 1)] + [sublst for sublst in subsets(lst[1:], n)]
...
def make_deductions(possible_subsets, letters):
    ...
    present = []
    not_present = []
    subsets_letters = [j for i in possible_subsets for j in i]
    present = [letter for letter in letters if subsets_letters.count(letter) == len(possible_subsets)]
    not_present = [letter for letter in letters if subsets_letters.count(letter) == 0]
