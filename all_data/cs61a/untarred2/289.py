...
def make_word_from_string(s):
    ...
    #         return s
    #     elif string_input == 'list':
    #         lst = []
    #         for index in range(len(s)):
    #             lst = lst + list(s[index])
    #         return lst
    # return word
...
def make_word_from_list(lst):
    ...
    #         made_string = ''
    #         for index in range(len(lst)):
    #             made_string = made_string + lst[index] 
    #         return made_string
    #     elif string_input == 'list':
    #         return lst
    # return word
...
def subsets(lst, n):
    ...
    if lst == []:
        ...
        return insert_every(first, subsets(rest, n-1)) + subsets(rest, n)
...
def filter_subsets(word, score, possible_subsets):
    ...
    [['a', 'b', 'e', 'l', 's'], ['b', 'l', 'e', 's', 't']]
    """
    lst_filtered_subsets = []
    for pos_sub in possible_subsets:
        if compatible(word, score, pos_sub):
            lst_filtered_subsets = lst_filtered_subsets + [pos_sub]
    return lst_filtered_subsets
...
def make_deductions(possible_subsets, letters):
    ...
    for elem in letters:
        elem_in_all, elem_in_none = True, True
