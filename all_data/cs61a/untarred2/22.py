...
def subsets(lst, n):
    ...
    if n==0 :
        ...
        # print(first,rest)
        # return subsets(rest,n)

        #n-1=1
    #solve the thing :
    #differnt way :
    #subset(rest,n) ---> doesn't work
    #subset(rest,n-1)---> doesn't work but we can pu 1 in each to have [[1,2],[1,3]]

#subset[]
        
    # regarder dernier cours sur les recursions !! 
    #important pour cette fonction. On peut aussi utiliser les meme idees que pour deep linked list.
    #prendre first et reste et rappeler la liste en recursion en tirant 1 a chaque fois. Et en supprimant 
    #un des elements de la liste.
...
def filter_subsets(word, score, possible_subsets):
    ...
    for each in possible_subsets:
        if compatible(word, score, each)==True:
            new_lst.append(each)
    return new_lst
