# CS 61A Spring 2014
# Name: Daniel Kim
# Login: cs61a-ad@hive12.cs.berkeley.edu
...
def num_common_letters(goal_word, guess):
    ...
    #Remove duplicate letters in guess
    stripped_guess_list = []
...
def subsets(lst, n):
    ...
    if n == 0:
        ...
        return []
    def add_this_elem(elem, lst):
        for i in range(len(lst)):
            lst[i] = [elem] + lst[i]
        return lst
    return add_this_elem(lst[0], subsets(lst[1:], n - 1)) +subsets(lst[1:], n)
