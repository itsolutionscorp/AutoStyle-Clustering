...
def num_common_letters(goal_word, guess):
    ...
    0
    """
    # def delete_repeated(lst):
    #     if len(lst) == 0:
    #         return lst
    #     elif lst[0] in lst[1:]:
    #         del lst[0]
    #         return delete_repeated(lst[1:])
    #     else:
    #         return delete_repeated(lst[1:])

    # k = 0
    # for elem in delete_repeated(get_list(guess)):
    #     if elem in get_list(goal_word) and elem :
    #         k += 1
    # return k
    n = 0
...
def filter_subsets(word, score, possible_subsets):
    ...
    for i in possible_subsets:
        if compatible(get_list(word), score, i):
            subset_list += [i]
    return subset_list
