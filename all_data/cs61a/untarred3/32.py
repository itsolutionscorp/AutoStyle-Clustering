...
def get_list(word):
    ...
    """
def get_list ():
    if make_word_from_string() == get_string():
        return get_list ()
...
def num_common_letters(goal_word, guess):
    ...
    0
    """
def num_common_letter():
    if get_string(n) == '':
        return num_common_letter
    else:
        return 0
def num_common_letter_a():
