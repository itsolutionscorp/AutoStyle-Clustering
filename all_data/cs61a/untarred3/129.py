...
def make_word_master(goal_word):
    ...
    """
    "*** YOUR CODE HERE ***"
    def make_word_master_helper(guess):
        guess_list = get_list(guess)
        goal_list = get_list(goal_word)
        if guess_list == goal_list:
            return win_message
    ...
    return make_word_master_helper
...
def subsets(lst, n):
    ...
    """
    "*** YOUR CODE HERE ***"
    #if you have a sublist inside, it must be inside another larger list
