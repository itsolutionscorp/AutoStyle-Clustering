...
def subsets(lst, n):
    ...
    if len(lst)==n:
        return [lst]
    lst_of_poss = subsets(lst[1:],n-1)
    return [[lst[0]]+lst_of_poss[i] for i in range(len(lst_of_poss))]+ subsets(lst[1:],n)
