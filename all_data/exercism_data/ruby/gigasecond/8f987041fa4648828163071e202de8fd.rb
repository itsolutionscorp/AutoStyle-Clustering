...
# Time will be very specific, and will always ouput the YYYY/MM/DD & hour/minutes/seconds
# Date only output year/month/day
# You can not interact a date instance with a time instance. They both have to be one or the other
