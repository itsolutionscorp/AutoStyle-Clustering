class House
  ORDERED_CHARACTER_ACTIONS_LIST = [
    {subject: 'malt', verb: 'lay'}, {subject: 'rat', verb: 'ate'},
  ...
  def verse(num)
    ...
    if(num > 1)
      rhyme_phrases = ORDERED_CHARACTER_ACTIONS_LIST.take(num - 1).reverse.map{|data| phrase(data)}.join(' ')
