class DNA
  ...
  DNA_RNA_NUCLEOTIDES = DNA_NUCLEOTIDES | RNA_NUCLEOTIDES
  ...
  def count(nucleotide)
    raise ArgumentError.new "#{nucleotide} is not a valid nucleotide" unless nucleotide? nucleotide 
  ...
  def nucleotide?(nucleotide)
    DNA_RNA_NUCLEOTIDES.include? nucleotide
  end
end
