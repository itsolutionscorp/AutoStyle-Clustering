class Bob
  def hey(phrase)
    ...
    the_phrase.was(:shouted).respond_with { "Woah, chill out!" }
    the_phrase.was(:asked).respond_with   { "Sure." }
    the_phrase.was(:empty).respond_with   { "Fine. Be that way!" }
    the_phrase.was(:other).respond_with   { "Whatever." }
