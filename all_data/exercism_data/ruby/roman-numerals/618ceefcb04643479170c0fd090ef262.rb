class RomanNumerable < Struct.new(:number)
  ROMAN_CONFIGURATION = [
    {:previous => nil, :base => "I", :mid => "V", :next_class => "Decenian"},
    {:previous => "I", :base => "X", :mid => "L", :next_class => "Centenian"},
    {:previous => "X", :base => "C", :mid => "D", :next_class => "Millenian"},
    {:previous => "C", :base => "M", :mid => nil, :next_class => nil},
  ]
