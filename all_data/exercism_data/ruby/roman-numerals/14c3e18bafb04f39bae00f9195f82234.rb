class Fixnum
  ...
  def partly_romanize(value, arabic, roman)
    ...
    if subtract
      new_arabic, roman = add_subtraction(roman, arabic, high, low)
    else
      new_arabic, roman = no_subtraction(value, arabic, roman)
    end
  ...
  def add_subtraction(roman, arabic, high, low)
  ...
  def no_subtraction(value, arabic, roman)
