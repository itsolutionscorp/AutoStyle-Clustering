# Dirk Herrmann's solution version 2 for exercism exercise "Matrix"
...
#   [[1,2][3,4][5,6]].
#
# * The member "columns" computes and returns a list of the colums of the
#   matrix, which is the transposed content of "rows".  For example, columns
#   would return [[1,3,5][2,4,6]] for the example matrix from the description
#   of "rows".
#
