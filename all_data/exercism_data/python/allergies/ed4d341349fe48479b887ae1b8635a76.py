...
class Allergies:
    ...
    is_allergic_to(allergen) will tests whether a specific allergen is in the list of allergens
    '''
    ...
    def __init__(self, score=0):
        ...
        def map_score_to_allergens(self):
            '''
            The chosen score scheme increases as 2**N. The score, when converted to
            a binary string, creates an easy lookup table for allergens.
            '''
        ...
        self.list = [entry[1] for entry in allergen_score_list if entry[0] == '1']
