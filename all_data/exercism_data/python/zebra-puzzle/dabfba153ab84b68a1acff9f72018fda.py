        ...
        for col in permutations(HouseColor):
            ...
            for ani in permutations(Animals):
                ...
                for dri in permutations(Drinks):
                    ...
                    if list(col).index(HouseColor.Green) - list(col).index(HouseColor.Ivory) != 1:
                        continue
                    ...
                    for cig in permutations(Cigars):
                        ...
                        #We found it !!!
                        nwater = nat[list(dri).index(Drinks.Water)].name
                        nzebra = nat[list(ani).index(Animals.Zebra)].name
