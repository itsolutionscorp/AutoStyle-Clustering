class Beer(object):
    ...
    _ZERO_BOTTLES     = "No more bottles of beer on the wall, no more bottles of beer.\nGo to the store and buy some more, 99 bottles of beer on the wall.\n" 
    _ONE_BOTTLE       = "1 bottle of beer on the wall, 1 bottle of beer.\nTake it down and pass it around, no more bottles of beer on the wall.\n"
    _TWO_BOTTLES      = "2 bottles of beer on the wall, 2 bottles of beer.\nTake one down and pass it around, 1 bottle of beer on the wall.\n"
    _MULTIPLE_BOTTLES = "%(current_amount)s bottles of beer on the wall, %(current_amount)s bottles of beer.\n" + "Take one down and pass it around, %(left_amount)s bottles of beer on the wall.\n" 
