...
def meetup_day(year, month, day, times):
    ...
    tenth_day_of_month = datetime.date(year, month, 10)
    ten_offset = normalized_day - tenth_day_of_month.weekday()
    if ten_offset < 0:
        ten_offset += 7
    ...
    if times == "teenth":    
        return  tenth_day_of_month+datetime.timedelta(days=ten_offset)
