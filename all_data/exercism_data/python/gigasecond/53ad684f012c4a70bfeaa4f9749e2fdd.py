...
#Old code that I dont want to delete because it took forever to write
...
def add_gigasecond(date_to_convert):
    if type(date_to_convert) != type(date(1423, 3, 12)):
        return "You must input a valid date of type 'date'"
    gigasecond=timedelta(days=11574)
    return date_to_convert + gigasecond
