def convert_word_to_letters(word):
    ...
    """
    ordered_letters = sorted(list(word.lower()))
...
class Anagram(object):
    ...
    def __init__(self, word):
        self._word = word
        self._ordered_letters = convert_word_to_letters(word)
    ...
    def is_an_anagram(self, word):
        ...
        return word != self._word and self._ordered_letters == convert_word_to_letters(word)
