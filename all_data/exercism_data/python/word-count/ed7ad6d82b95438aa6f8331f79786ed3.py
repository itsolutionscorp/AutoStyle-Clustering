...
def word_count(excerpt):
    ...
    # The dict() isn't strictly necessary, but if someone checks it
    # with isinstance, having an instance of Counter() might throw someone off
    return dict(_counter(excerpt))
