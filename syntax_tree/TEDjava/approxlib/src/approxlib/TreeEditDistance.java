...
//		long startTime = System.nanoTime();
			String home_dir = args[0];
		 	...
		 	try {
	             lt1 = LblTree.fromString((new BufferedReader(new FileReader(home_dir+"/ast/" + listOfFiles[listOfFiles.length - 1].getName() ))).readLine());
		 	} catch (Exception e) {
		 	...
		 	{
		 	 fs2 = home_dir+"/ast/"+listOfFiles[i].getName() ;
		 		try {
